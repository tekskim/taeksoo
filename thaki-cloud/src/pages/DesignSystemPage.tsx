    ...
    <Section id="datepicker" title="DatePicker" description="Calendar-based date selection with single and range modes">
      <VStack gap={8}>
        ...
        <VStack gap={3}>
          ...
          <div className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)] p-3 bg-[var(--color-surface-muted)] rounded-[var(--radius-md)]">
        ...
        <VStack gap={3}>
          ...
          <div className="flex gap-4 items-start">
            <VStack gap={1}>
              <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Default</span>
              <DatePicker value={singleDate} onChange={setSingleDate} />
            </VStack>
            <VStack gap={1}>
              <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Disabled</span>
      ...
      {variant === 'grouped' && (
        <div className="flex gap-4 mt-2 justify-start">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)]">Current</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-2 h-2 rounded-sm" style={{ backgroundColor: primaryChartColors[1] }} />
            <span className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)]">Previous</span>
          </div>
        </div>
      )}
    </div>
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 justify-center max-h-[60px] overflow-y-auto legend-scroll">
        {legendData.map((item, i) => (
          <div key={i} className="flex items-center gap-1.5">
            ...
            <span className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)]">{item.label}</span>
          </div>
        ))}
      </div>
    </div>
  ...
  const basicColumns = [
    ...
    { 
      ...
      render: (value: string, row: InstanceData) => (
        <div className="flex flex-col gap-0.5">
          ...
          <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">ID : {row.id}</span>
        </div>
      )
    },
    { 
    ...
    { 
      ...
      render: (value: string, row: InstanceData) => (
        <div className="flex flex-col gap-0.5">
          <span className="font-medium text-[var(--color-action-primary)] cursor-pointer hover:underline hover:underline-offset-2">{value}</span>
          <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">ID : {row.imageId}</span>
        </div>
      )
    },
    { 
      ...
      render: (value: string, row: InstanceData) => (
        <div className="flex flex-col gap-0.5">
          <span className="font-medium text-[var(--color-action-primary)] cursor-pointer hover:underline hover:underline-offset-2">{value}</span>
          <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">ID : {row.flavorId}</span>
        </div>
      )
    },
    { 
        ...
        row.attachedTo && row.attachedToId ? (
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col gap-0.5 min-w-0">
              ...
              <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)] truncate">
                ID : {row.attachedToId}
              </span>
            </div>
          </div>
  ...
  const copyColumns = [
    ...
    { 
      ...
      render: (_: string, row: KeyPairData) => (
        <div className="flex items-center gap-2">
          <span className="font-mono text-[length:var(--font-size-12)] text-[var(--color-text-default)]">{row.fingerprint}</span>
          <button
            onClick={(e) => {
              e.stopPropagation();
    ...
    <div className="fixed inset-0 bg-[var(--color-surface-subtle)]">
      ...
      <nav className="fixed left-0 top-0 w-[200px] h-screen bg-[var(--color-surface-default)] border-r border-[var(--color-border-default)] overflow-y-auto z-50 sidebar-scroll">
        <div className="p-4">
          ...
          <Link
            to="/"
            className="flex items-center gap-2 w-full px-3 py-2 mb-4 rounded-[var(--radius-button)] bg-[var(--color-action-secondary)] hover:bg-[var(--color-action-secondary-hover)] text-[var(--color-text-default)] text-[length:var(--font-size-12)] font-medium transition-colors border border-[var(--color-border-default)]"
          >
          ...
          <VStack gap={4}>
            {/* Foundation Section */}
            <VStack gap={1}>
              <span className="px-3 py-1 text-[length:var(--font-size-12)] font-semibold text-[var(--color-text-subtle)] uppercase tracking-wider">
                Foundation
              </span>
              {foundationItems.map(({ id, label, icon: Icon }) => (
                <button
                  ...
                  className={`
                    ...
                    text-[length:var(--font-size-12)] text-left transition-colors
                    ${activeSection === id
              ...
              <VStack gap={6}>
                ...
                <VStack gap={3}>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {/* Info */}
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Info</span>
                      <div className="flex gap-2">
                    ...
                    {/* Success */}
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Success</span>
                      <div className="flex gap-2">
                    ...
                    {/* Warning */}
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Warning</span>
                      <div className="flex gap-2">
                    ...
                    {/* Danger */}
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Danger</span>
                      <div className="flex gap-2">
            ...
            <Section id="borders" title="Borders" description="Border tokens for colors, widths, and styles">
              <VStack gap={8}>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      ...
                      <div key={name} className="flex flex-col gap-2">
                        ...
                        />
                        <div>
                          <code className="text-[length:var(--font-size-12)] font-mono text-[var(--color-text-default)]">
                            border-{name}
                          </code>
                          <p className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)]">{desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    {[
                      ...
                      <div key={name} className="flex flex-col gap-2 items-center">
                        ...
                        />
                        <code className="text-[length:var(--font-size-12)] font-mono text-[var(--color-text-subtle)]">
                          {value}
                        </code>
                      </div>
                    ))}
                ...
                <VStack gap={4}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 rounded-[var(--radius-lg)] border border-[var(--color-border-default)] bg-[var(--color-surface-default)]">
                      ...
                      <code className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)]">border border-[var(--color-border-default)]</code>
                    </div>
                    <div className="p-4 rounded-[var(--radius-lg)] border-2 border-[var(--color-border-strong)] bg-[var(--color-surface-default)]">
                      ...
                      <code className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)]">border-2 border-[var(--color-border-strong)]</code>
                    </div>
                    <div className="p-4 rounded-[var(--radius-lg)] border-l-4 border-[var(--color-action-primary)] bg-[var(--color-surface-default)]">
                      ...
                      <code className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)]">border-l-4 border-[var(--color-action-primary)]</code>
                    </div>
                    <div className="p-4 rounded-[var(--radius-lg)] border border-dashed border-[var(--color-border-default)] bg-[var(--color-surface-default)]">
                      ...
                      <code className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)]">border border-dashed</code>
                    </div>
                  </div>
                </VStack>
                ...
                <VStack gap={3}>
                  ...
                  <pre className="text-[length:var(--font-size-12)] p-4 bg-[var(--color-surface-muted)] rounded-[var(--radius-md)] overflow-x-auto text-[var(--color-text-muted)]">
{`/* Border Colors */
...
outline: 2px solid var(--color-border-focus);`}
                ...
                {[
                  ...
                  <div key={name} className="flex gap-4 items-center p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                    ...
                    <div className="flex flex-col gap-1 min-w-0">
                      ...
                      <div className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)] font-mono break-all">
                        {value}
                      </div>
                    </div>
                  </div>
            ...
            <Section id="button" title="Button" description="Interactive button component with multiple variants, sizes, and states">
              <VStack gap={8}>
                ...
                <VStack gap={3}>
                  ...
                  <div className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)] mt-1">
              ...
              <VStack gap={8}>
                ...
                <VStack gap={3}>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 items-start">
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Placeholder</span>
                      <Input placeholder="Input placeholder" className="w-full" />
                    </VStack>
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Value</span>
                      <Input defaultValue="Input value" className="w-full" />
                    </VStack>
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Read-only</span>
                    ...
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Error</span>
                ...
                <VStack gap={3}>
                  ...
                  <div className="flex gap-4 items-start">
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">SM (28px)</span>
                      <Input size="sm" placeholder="Input placeholder" className="w-[200px]" />
                    </VStack>
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">MD (32px)</span>
                ...
                <VStack gap={3}>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">With Min/Max</span>
                ...
                <VStack gap={3}>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)]">0% ~ 70%: Normal</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-4 h-4 rounded bg-[var(--color-state-warning-default)]" />
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)]">70% ~ 100%: Warning</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-4 h-4 rounded bg-[var(--color-state-error-default)]" />
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)]">&gt;100%: Danger</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-4 h-4 rounded bg-[var(--color-border-default)]" />
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-muted)]">Unlimited: Neutral</span>
                    </div>
                  </div>
                </VStack>
              </VStack>
              ...
              <VStack gap={8}>
                ...
                <VStack gap={3}>
                  ...
                  <div className="flex gap-8 items-start">
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Without Label</span>
                      <Toggle defaultChecked />
                    </VStack>
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">With Label</span>
                ...
                <VStack gap={3}>
                  ...
                  <div className="flex gap-8 items-start">
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Off</span>
                      <Toggle label="Setting" checked={false} onChange={() => {}} />
                    </VStack>
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">On</span>
                      <Toggle label="Setting" checked onChange={() => {}} />
                    </VStack>
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Disabled Off</span>
                      <Toggle label="Setting" disabled />
                    </VStack>
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Disabled On</span>
            ...
            <Section id="checkbox" title="Checkbox" description="Selection control for single or multiple options">
              <VStack gap={8}>
                ...
                <VStack gap={3}>
                  ...
                  <div className="flex gap-8 items-start">
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Icon Only</span>
                ...
                <VStack gap={3}>
                  ...
                  <div className="flex gap-8 items-start">
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Unselected</span>
                      <Checkbox label="Label" checked={false} onChange={() => {}} />
                    </VStack>
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Selected</span>
                      <Checkbox label="Label" checked onChange={() => {}} />
                    </VStack>
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Indeterminate</span>
                    ...
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Disabled + Checked</span>
              ...
              <VStack gap={8}>
                ...
                <VStack gap={3}>
                  ...
                  <div className="flex gap-8 items-start">
                    ...
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Disabled + Selected</span>
            ...
            <Section id="tabs" title="Tabs" description="Tabs for navigation between views with underline and boxed variants">
              <VStack gap={8}>
                ...
                <VStack gap={3}>
                  ...
                  <VStack gap={4}>
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Underline (default)</span>
                    ...
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Boxed</span>
                ...
                <VStack gap={3}>
                  ...
                  <VStack gap={4}>
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Small (12px)</span>
                      <Tabs defaultValue="tab1" size="sm">
                        <TabList>
                          <Tab value="tab1">menu 1</Tab>
                          <Tab value="tab2">menu 2</Tab>
                    ...
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Medium (14px)</span>
              ...
              <VStack gap={8}>
                ...
                <VStack gap={3}>
                  ...
                  <div className="flex gap-6">
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Solid</span>
                      <div className="flex gap-2">
                    ...
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Subtle</span>
                      <div className="flex gap-2">
            ...
            <Section id="breadcrumb" title="Breadcrumb" description="Navigation path indicator with clickable links">
              <VStack gap={8}>
                ...
                <VStack gap={3}>
                  <Label>States</Label>
                  <div className="grid grid-cols-3 gap-4 text-[length:var(--font-size-12)]">
              ...
              <VStack gap={8}>
                ...
                <VStack gap={3}>
                  ...
                  <VStack gap={4}>
                    {/* Success */}
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Success (Green)</span>
                    ...
                    {/* Danger */}
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Danger (Red)</span>
                      <div className="flex flex-wrap gap-2 items-center">
                    ...
                    {/* Info */}
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Info (Blue)</span>
                      <div className="flex flex-wrap gap-2 items-center">
                    ...
                    {/* Warning */}
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Warning (Orange)</span>
                      <div className="flex flex-wrap gap-2 items-center">
                    ...
                    {/* Muted */}
                    <VStack gap={2}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Muted (Gray)</span>
                      <div className="flex flex-wrap gap-2 items-center">
                ...
                <VStack gap={3}>
                  ...
                  <div className="grid grid-cols-5 gap-2 text-[length:var(--font-size-12)]">
                    <div className="flex items-center gap-2">
              ...
              <VStack gap={8}>
                ...
                <VStack gap={3}>
                  ...
                  <div className="flex gap-6 items-center">
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Minimize</span>
                      <WindowControl type="minimize" />
                    </VStack>
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Maximize</span>
                      <WindowControl type="maximize" />
                    </VStack>
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Close</span>
                ...
                <VStack gap={3}>
                  ...
                  <div className="flex gap-6 items-center">
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">All Controls</span>
                      <WindowControls />
                    </VStack>
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Minimize + Close</span>
                      <WindowControls showMaximize={false} />
                    </VStack>
                    <VStack gap={1}>
                      <span className="text-[length:var(--font-size-12)] text-[var(--color-text-subtle)]">Close Only</span>
                  ...
                  <div className="border border-[var(--color-border-default)] rounded-[var(--radius-lg)] overflow-hidden bg-[var(--color-surface-muted)]">
                    ...
                    <div className="flex border-t border-[var(--color-border-default)] bg-[var(--color-surface-default)]">
                      <div className="w-[52px] py-2 text-center border-r border-[var(--color-border-default)]">
                        <span className="text-[length:var(--font-size-12)] font-mono text-[var(--color-action-primary)]">200px</span>
                      </div>
                      <div className="flex-1 py-2 text-center">
                        <span className="text-[length:var(--font-size-12)] font-mono text-[var(--color-text-muted)]">Content Area (1720px max)</span>
                      </div>
                    </div>
                  </div>
                </VStack>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="border border-[var(--color-border-default)] rounded-[var(--radius-lg)] overflow-hidden">
                      ...
                      <div className="p-2 bg-[var(--color-surface-default)] border-t border-[var(--color-border-default)] text-center">
                        <span className="text-[length:var(--font-size-12)] text-[var(--color-text-default)]">Sidebar Expanded</span>
                      </div>
                    </div>
                    {/* Collapsed */}
                    <div className="border border-[var(--color-border-default)] rounded-[var(--radius-lg)] overflow-hidden">
                      ...
                      <div className="p-2 bg-[var(--color-surface-default)] border-t border-[var(--color-border-default)] text-center">
                        <span className="text-[length:var(--font-size-12)] text-[var(--color-text-default)]">Sidebar Collapsed</span>
                      </div>
                    </div>
                  </div>
                </VStack>
...
function Label({ children }: { children: React.ReactNode }) {
  return <span className="text-[length:var(--font-size-12)] font-medium text-[var(--color-text-subtle)] uppercase tracking-wider">{children}</span>;
}
  ...
  return (
    <VStack gap={3} className="p-4 rounded-[var(--radius-lg)]" style={{ backgroundColor: color }}>
      <VStack gap={1}>
        ...
        <span className="text-[length:var(--font-size-12)]" style={{ color: textColor, opacity: 0.8 }}>{description}</span>
      </VStack>
      <ul className="text-[length:var(--font-size-12)] space-y-1" style={{ color: textColor, opacity: 0.9 }}>
      ...
      <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-10 gap-2">
        {icons.map(({ Icon, name, missing }, i) => (
          ...
          >
            ...
            <span className={`text-[length:var(--font-size-12)] transition-colors truncate w-full text-center ${missing ? 'text-[var(--color-state-warning-text)]' : 'text-[var(--color-text-disabled)] group-hover:text-[var(--color-text-subtle)]'}`}>
              {name}
            </span>
          </div>
        ))}
