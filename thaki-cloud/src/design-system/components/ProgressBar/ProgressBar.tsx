        ...
        >
          ...
          {showTooltip && newValue > 0 && (
            <div className="absolute left-1/2 -translate-x-1/2 -top-2 -translate-y-full z-10">
              <div className="bg-[var(--tooltip-bg)] text-[var(--tooltip-text)] text-[length:var(--font-size-12)] leading-[var(--line-height-16)] px-2 py-1 rounded-[var(--radius-sm)] shadow-[var(--shadow-md)]">
              ...
              <div className="relative group">
                ...
                {errorMessage && (
                  <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-1 hidden group-hover:block z-10">
                    <div className="bg-[var(--tooltip-bg)] text-[var(--tooltip-text)] text-[length:var(--font-size-12)] leading-[var(--line-height-16)] px-2 py-1 rounded-[var(--radius-sm)] shadow-[var(--shadow-md)] whitespace-nowrap">
                      {errorMessage}
                    </div>
                  </div>
                )}
