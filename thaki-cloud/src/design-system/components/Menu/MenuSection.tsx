  ...
  return (
    <VStack gap={2} className="w-full">
      ...
      {collapsible ? (
        ...
        >
          <span className="text-[length:var(--font-size-12)] font-medium text-[var(--color-text-subtle)] group-hover:text-[var(--color-text-muted)] transition-colors duration-[var(--duration-fast)]">
            {title}
          </span>
          {isOpen ? (
        ...
        <span className="text-[length:var(--font-size-12)] font-medium text-[var(--color-text-subtle)] px-[var(--menu-section-padding-x)] py-[var(--menu-section-padding-y)]">
          {title}
        </span>
      )}
