...
declare const meta: {
    title: string;
    component: typeof InlineMessage;
    parameters: {
        layout: string;
        docs: {
            description: {
    ...
    decorators: ((Story: import('storybook/internal/csf').PartialStoryFn<import('@storybook/react').ReactRenderer, {
        variant?: import('./InlineMessage').InlineMessageVariant | undefined;
        children?: import('react').ReactNode;
        hideIcon?: boolean | undefined;
        icon?: import('react').ReactNode;
        type?: import('./InlineMessage').ThakiInlineMessageType | undefined;
...
export declare const FeatureAnnouncement: Story;
export declare const DeploymentStatus: Story;
