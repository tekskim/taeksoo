...
declare const meta: {
    title: string;
    component: import('react').ForwardRefExoticComponent<import('./FormField').FormFieldProps & import('react').RefAttributes<HTMLDivElement>> & {
        Label: import('react').ForwardRefExoticComponent<import('./FormField').FormFieldLabelProps & import('react').RefAttributes<HTMLLabelElement>>;
        Description: import('react').ForwardRefExoticComponent<import('./FormField').FormFieldDescriptionProps & import('react').RefAttributes<HTMLParagraphElement>>;
        Control: import('react').ForwardRefExoticComponent<import('./FormField').FormFieldControlProps & import('react').RefAttributes<HTMLDivElement>>;
        HelperText: import('react').ForwardRefExoticComponent<import('./FormField').FormFieldHelperTextProps & import('react').RefAttributes<HTMLParagraphElement>>;
        ErrorMessage: import('react').ForwardRefExoticComponent<import('./FormField').FormFieldErrorMessageProps & import('react').RefAttributes<HTMLParagraphElement>>;
    };
    parameters: {
        layout: string;
        docs: {
    ...
    decorators: ((Story: import('storybook/internal/csf').PartialStoryFn<import('@storybook/react').ReactRenderer, {
        ...
        spacing?: "default" | "loose" | undefined;
...
export declare const SimpleAPI: Story;
export declare const SimpleAPIRequired: Story;
export declare const SimpleAPIWithDescription: Story;
export declare const SimpleAPIWithError: Story;
export declare const SimpleAPIWithSelect: Story;
...
export declare const LabelSizes: Story;
export declare const CompleteForm: Story;
export declare const SpacingLooseCheckbox: Story;
export declare const SpacingLooseToggle: Story;
