...
export { IconActivity, IconAdd, IconAddRobot, IconAdjustmentsAlt, IconBrain, IconBranch, IconBuilding, IconCahatbot, IconCategory, } from './CustomIcons';
...
export { IconReset1, IconReset2, IconRouterArrows, IconRouters1, IconSchedule, IconSearch, IconSecurity, IconSecurityerror, IconServer, IconSetting, IconShare, } from './CustomIcons';
export { IconShow, IconSidebar, IconSnapshot, IconStop, IconStorage, IconTemplate, IconTopology, IconUpload, } from './CustomIcons';
...
export { IconRefreshDot as Reboot, IconRotateClockwise as Retry, IconProgress as Pending, IconProgress as Progress, IconCircleX as Terminate, } from '@tabler/icons-react';
...
export declare const Icons: {
    ...
    readonly Terminate: import('react').ForwardRefExoticComponent<IconProps & import('react').RefAttributes<SVGSVGElement>>;
};
