...
export declare function ListToolbar({ primaryActions, bulkActions, showDivider, filters, onFilterRemove, onFiltersClear, clearFiltersLabel, className, children, ...rest }: ListToolbarProps): import("react/jsx-runtime").JSX.Element;
