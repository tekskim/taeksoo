...
}`,...(pe=(ue=k.parameters)==null?void 0:ue.docs)==null?void 0:pe.source}}};var be,ye,ge;f.parameters={...f.parameters,docs:{...(be=f.parameters)==null?void 0:be.docs,source:{originalSource:`{
  render: () => <Table columns={basicColumns} data={sampleUsers} rowKey="id" rowHeight="56px" />
}`,...(ge=(ye=f.parameters)==null?void 0:ye.docs)==null?void 0:ge.source}}};var xe,he,ve;S.parameters={...S.parameters,docs:{...(xe=S.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  render: () => <Table columns={basicColumns} data={sampleUsers} rowKey="id" expandedContent={row => <div className="px-4 bg-[var(--color-surface-subtle)] text-body-md text-[var(--color-text-muted)] w-full">
...
}`,...(ve=(he=S.parameters)==null?void 0:he.docs)==null?void 0:ve.source}}};var Ce,we,ke;K.parameters={...K.parameters,docs:{...(Ce=K.parameters)==null?void 0:Ce.docs,source:{originalSource:'{\n  render: () => <Table columns={basicColumns} data={sampleUsers} rowKey="id" resizable columnResizeMode="onChange" onColumnResize={(key, width) => console.log(`${key}: ${width}px`)} />\n}',...(ke=(we=K.parameters)==null?void 0:we.docs)==null?void 0:ke.source}}};var fe,Se,Ke;z.parameters={...z.parameters,docs:{...(fe=z.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  render: () => <Table columns={basicColumns} data={sampleUsers} rowKey="id" resizable minColumnWidth={100} />
}`,...(Ke=(Se=z.parameters)==null?void 0:Se.docs)==null?void 0:Ke.source}}};const Ye=["Default","WithCustomRendering","Selectable","Sortable","WithActions","RowClickable","Empty","Scrollable","ColumnAlignment","Resizable","ResizableWithSelection","ComplexExample","HideSelectAll","CustomRowHeight","ExpandedContent","ResizeModeOnChange","MinColumnWidth"];export{h as ColumnAlignment,w as ComplexExample,f as CustomRowHeight,d as Default,g as Empty,S as ExpandedContent,k as HideSelectAll,z as MinColumnWidth,v as Resizable,C as ResizableWithSelection,K as ResizeModeOnChange,y as RowClickable,x as Scrollable,u as Selectable,p as Sortable,b as WithActions,m as WithCustomRendering,Ye as __namedExportsOrder,Xe as default};
