import{r as o,j as e}from"./iframe-Cu1YwpPb.js";import{r as te}from"./index-DBiODXrU.js";import{t as S}from"./bundle-mjs-BZSatpsL.js";import{B as a}from"./Button-BqnzwiOg.js";import{I as w}from"./Input-CB2gVeDG.js";import"./preload-helper-C1FmrZbK.js";function m({isOpen:s,onClose:n,title:t,description:r,children:i,size:c="md",showCloseButton:f=!1,closeOnBackdropClick:x=!0,closeOnEscape:d=!0,className:C}){const[u,h]=o.useState(s),[g,k]=o.useState(!1);o.useEffect(()=>{if(s)h(!0),requestAnimationFrame(()=>{requestAnimationFrame(()=>{k(!0)})});else{k(!1);const l=setTimeout(()=>{h(!1)},200);return()=>clearTimeout(l)}},[s]),o.useEffect(()=>{if(!s||!d)return;const l=ee=>{ee.key==="Escape"&&n()};return document.addEventListener("keydown",l),()=>document.removeEventListener("keydown",l)},[s,d,n]),o.useEffect(()=>(s?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[s]);const Q=o.useCallback(()=>{x&&n()},[x,n]);if(!u)return null;const X={sm:"w-[344px]",md:"w-[480px]",lg:"w-[640px]"},Z=S("fixed inset-0 z-[var(--z-modal)]","bg-black/60","flex items-center justify-center","transition-opacity duration-200 ease-out",g?"opacity-100":"opacity-0"),$=S("bg-[var(--color-surface-default)]","border border-[var(--color-border-default)]","rounded-[var(--radius-lg)]","shadow-[0px_0px_4px_0px_rgba(0,0,0,0.1)]","p-4","flex flex-col gap-4","transition-all duration-200 ease-out",g?"opacity-100 scale-100":"opacity-0 scale-95",X[c],C);return te.createPortal(e.jsx("div",{className:Z,onClick:Q,children:e.jsxs("div",{className:$,onClick:l=>l.stopPropagation(),children:[e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("h2",{className:"text-heading-h5 text-[var(--color-text-default)]",children:t}),r&&e.jsx("p",{className:"text-body-md text-[var(--color-text-subtle)]",children:r})]}),i]})}),document.body)}function p({isOpen:s,onClose:n,onConfirm:t,title:r,description:i,confirmText:c="Confirm",cancelText:f="Cancel",confirmVariant:x="primary",infoLabel:d,infoValue:C,isLoading:u=!1,size:h="sm",...g}){return e.jsxs(m,{isOpen:s,onClose:n,title:r,description:i,size:h,...g,children:[d&&C&&e.jsxs("div",{className:"bg-[var(--color-surface-subtle)] rounded-[var(--radius-md)] px-4 py-3 flex flex-col gap-1.5",children:[e.jsx("span",{className:"text-label-sm text-[var(--color-text-subtle)]",children:d}),e.jsx("span",{className:"text-body-md text-[var(--color-text-default)]",children:C})]}),e.jsxs("div",{className:"flex gap-2 w-full",children:[e.jsx(a,{variant:"outline",size:"md",onClick:n,disabled:u,className:"flex-1",children:f}),e.jsx(a,{variant:x,size:"md",onClick:t,disabled:u,className:"flex-1",children:u?"Processing...":c})]})]})}p.__docgenInfo={description:"",methods:[],displayName:"ConfirmModal",props:{confirmText:{required:!1,tsType:{name:"string"},description:"Confirm button text",defaultValue:{value:"'Confirm'",computed:!1}},cancelText:{required:!1,tsType:{name:"string"},description:"Cancel button text",defaultValue:{value:"'Cancel'",computed:!1}},confirmVariant:{required:!1,tsType:{name:"union",raw:"'primary' | 'danger' | 'warning'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'danger'"},{name:"literal",value:"'warning'"}]},description:"Confirm button variant",defaultValue:{value:"'primary'",computed:!1}},onConfirm:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback when confirmed"},infoLabel:{required:!1,tsType:{name:"string"},description:"Info box content"},infoValue:{required:!1,tsType:{name:"string"},description:"Info box value"},isLoading:{required:!1,tsType:{name:"boolean"},description:"Loading state",defaultValue:{value:"false",computed:!1}},size:{defaultValue:{value:"'sm'",computed:!1},required:!1}},composes:["Omit"]};const le={title:"Components/Modal",component:m,tags:["autodocs"],parameters:{docs:{description:{component:`
## Modal 컴포넌트
...
}`,...(L=(D=v.parameters)==null?void 0:D.docs)==null?void 0:L.source}}};var V,W,F;b.parameters={...b.parameters,docs:{...(V=b.parameters)==null?void 0:V.docs,source:{originalSource:`{
...
}`,...(J=(H=M.parameters)==null?void 0:H.docs)==null?void 0:J.source}}};const ce=["Default","Confirm","DeleteConfirm","WithForm","Loading","Warning","NoBackdropClose"];export{v as Confirm,O as Default,b as DeleteConfirm,I as Loading,M as NoBackdropClose,j as Warning,y as WithForm,ce as __namedExportsOrder,le as default};
