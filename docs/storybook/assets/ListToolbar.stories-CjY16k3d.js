...
/>
\`\`\`
        `}}},argTypes:{showDivider:{control:"boolean",description:"구분선 표시",table:{defaultValue:{summary:"true"}}}}},h={render:()=>e.jsx(t,{primaryActions:e.jsxs(t.Actions,{children:[e.jsx(l,{placeholder:"Search instances...",size:"sm"}),e.jsx(n,{variant:"secondary",size:"sm",leftIcon:e.jsx(re,{size:14}),children:"Download"})]})})},v={render:()=>e.jsx(t,{primaryActions:e.jsx(t.Actions,{children:e.jsx(l,{placeholder:"Search...",size:"sm"})}),bulkActions:e.jsx(t.Actions,{children:e.jsx(n,{variant:"danger",size:"sm",leftIcon:e.jsx(te,{size:14}),children:"Delete (3)"})})})},b={render:()=>e.jsx(t,{primaryActions:e.jsx(t.Actions,{children:e.jsx(l,{placeholder:"Search...",size:"sm"})}),filters:[{id:"1",field:"Status",value:"Running"},{id:"2",field:"Type",value:"m5.large"},{id:"3",field:"Region",value:"us-east-1"}],onFilterRemove:r=>console.log("Remove filter:",r),onFiltersClear:()=>console.log("Clear all filters")})},x={render:()=>e.jsx(t,{primaryActions:e.jsxs(t.Actions,{children:[e.jsx(l,{placeholder:"Search instances...",size:"sm"}),e.jsx(n,{variant:"secondary",size:"sm",leftIcon:e.jsx(re,{size:14}),children:"Export"}),e.jsx(n,{variant:"primary",size:"sm",leftIcon:e.jsx(xe,{size:14}),children:"Create"})]}),bulkActions:e.jsxs(t.Actions,{children:[e.jsx(n,{variant:"secondary",size:"sm",children:"Stop (2)"}),e.jsx(n,{variant:"danger",size:"sm",leftIcon:e.jsx(te,{size:14}),children:"Delete (2)"})]}),filters:[{id:"1",field:"Status",value:"Running"},{id:"2",field:"Type",value:"m5.large"}],onFilterRemove:r=>console.log("Remove:",r),onFiltersClear:()=>console.log("Clear all")})},g={render:()=>e.jsx(t,{showDivider:!1,primaryActions:e.jsx(t.Actions,{children:e.jsx(l,{placeholder:"Search...",size:"sm"})}),bulkActions:e.jsx(t.Actions,{children:e.jsx(n,{variant:"secondary",size:"sm",children:"Action"})})})},y={render:()=>e.jsx(t,{filters:[{id:"1",field:"Environment",value:"Production"},{id:"2",field:"Owner",value:"admin@example.com"},{id:"3",field:"Created",value:"Last 7 days"}],onFilterRemove:r=>console.log("Remove:",r),onFiltersClear:()=>console.log("Clear all"),clearFiltersLabel:"Reset All"})},T={render:()=>e.jsx(t,{children:e.jsxs("div",{className:"flex items-center justify-between w-full",children:[e.jsx(l,{placeholder:"Search...",size:"sm"}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-sm text-[var(--color-text-muted)]",children:"Showing 1-10 of 100"}),e.jsx(n,{variant:"primary",size:"sm",children:"Create New"})]})]})})};var B,k,q;h.parameters={...h.parameters,docs:{...(B=h.parameters)==null?void 0:B.docs,source:{originalSource:`{
