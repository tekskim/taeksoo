import{j as e,r as F}from"./iframe-D96dQDLz.js";import{t as n}from"./bundle-mjs-BZSatpsL.js";import{S as Q}from"./StatusIndicator-B5ywwv3c.js";import{I as X}from"./IconCheck-KE79Jf-a.js";import{I as Z}from"./IconCopy-3wqRAHHL.js";import{B as i}from"./Button-BBWIKsKq.js";import{I as R}from"./IconEdit-DoLVRIuq.js";import{I as V}from"./IconTrash-Dlq7Hary.js";import{c as $}from"./createReactComponent-Dvr8b43U.js";import{H as ee}from"./Stack-o3rwwWCc.js";import{C as x}from"./Chip-BlmXXBf9.js";import"./preload-helper-C1FmrZbK.js";import"./IconCircleX-BnPzfi4f.js";import"./IconAlertTriangle-DhegDY0-.js";import"./IconX-DlnDTnrf.js";/**
 * @license @tabler/icons-react v3.36.1 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const ae=[["path",{d:"M5 7a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2l0 -10",key:"svg-0"}]],te=$("outline","player-stop","PlayerStop",ae);function a({children:r,className:t,...l}){return e.jsx("div",{className:n("bg-[var(--color-surface-default)]","border border-[var(--color-border-default)]","rounded-lg","px-4 pt-3 pb-4","w-full",t),...l,children:r})}function L({children:r,className:t,...l}){return e.jsx("h1",{className:n("text-[16px] font-semibold leading-6","text-[var(--color-text-default)]","mb-3",t),...l,children:r})}function q({children:r,className:t,...l}){return e.jsx("div",{className:n("flex items-center gap-1","mb-3",t),...l,children:r})}function W({children:r,className:t,...l}){return e.jsx("div",{className:n("flex items-center gap-3","w-full",t),...l,children:r})}function J({label:r,value:t,copyable:l=!1,status:f,className:K,...O}){const[U,I]=F.useState(!1),v=typeof t=="string",Y=()=>{v&&(navigator.clipboard.writeText(t),I(!0),setTimeout(()=>I(!1),2e3))};return e.jsxs("div",{className:n("flex-1","bg-[var(--color-surface-subtle)]","rounded-lg","px-4 py-3","relative","min-w-0",K),...O,children:[f&&e.jsx("div",{className:"absolute top-1/2 right-3 -translate-y-1/2",children:e.jsx(Q,{status:f,layout:"icon-only",size:"lg"})}),e.jsxs("div",{className:n("flex flex-col gap-1.5 min-w-0",f&&"pr-6"),children:[e.jsx("span",{className:"text-[11px] font-medium leading-4 text-[var(--color-text-subtle)] whitespace-nowrap",children:r}),e.jsxs("div",{className:"flex items-center gap-1.5 min-w-0 min-h-[26px]",children:[v?e.jsx("span",{className:"text-[12px] leading-4 font-normal truncate text-[var(--color-text-default)]",title:t,children:t}):t,l&&v&&e.jsx("button",{onClick:Y,className:"shrink-0 p-0.5 rounded hover:bg-[var(--color-surface-default)] transition-colors","aria-label":"Copy to clipboard",children:U?e.jsx(X,{size:12,className:"text-[var(--color-state-success)]"}):e.jsx(Z,{size:12,className:"text-[var(--color-action-primary)]"})})]})]})]})}a.Title=L;a.Actions=q;a.InfoGrid=W;a.InfoCard=J;a.__docgenInfo={description:"",methods:[{name:"Title",docblock:null,modifiers:["static"],params:[{name:"{ children, className, ...props }: DetailHeaderTitleProps",optional:!1,type:{name:"DetailHeaderTitleProps",alias:"DetailHeaderTitleProps"}}],returns:null},{name:"Actions",docblock:null,modifiers:["static"],params:[{name:"{ children, className, ...props }: DetailHeaderActionsProps",optional:!1,type:{name:"DetailHeaderActionsProps",alias:"DetailHeaderActionsProps"}}],returns:null},{name:"InfoGrid",docblock:null,modifiers:["static"],params:[{name:"{ children, className, ...props }: DetailHeaderInfoGridProps",optional:!1,type:{name:"DetailHeaderInfoGridProps",alias:"DetailHeaderInfoGridProps"}}],returns:null},{name:"InfoCard",docblock:null,modifiers:["static"],params:[{name:`{
  label,
  value,
  copyable = false,
  status,
...
}`,...(b=(H=s.parameters)==null?void 0:H.docs)==null?void 0:b.source}}};var h,j,C;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => <DetailHeader>
...
}`,...(w=(G=u.parameters)==null?void 0:G.docs)==null?void 0:w.source}}};var A,E,B;p.parameters={...p.parameters,docs:{...(A=p.parameters)==null?void 0:A.docs,source:{originalSource:`{
...
}`,...(B=(E=p.parameters)==null?void 0:E.docs)==null?void 0:B.source}}};var M,k,_;m.parameters={...m.parameters,docs:{...(M=m.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => <DetailHeader>
...
}`,...(_=(k=m.parameters)==null?void 0:k.docs)==null?void 0:_.source}}};const He=["Default","WithCopyable","WithStatus","WithCustomValue","VMDetail","ServiceDetail","Minimal"];export{s as Default,m as Minimal,p as ServiceDetail,u as VMDetail,o as WithCopyable,c as WithCustomValue,d as WithStatus,He as __namedExportsOrder,De as default};
