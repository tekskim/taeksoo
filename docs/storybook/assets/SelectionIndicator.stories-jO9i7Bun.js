import{j as e}from"./iframe-DKmDJy9M.js";import{t as te}from"./bundle-mjs-BZSatpsL.js";import{C as re}from"./Chip-4dNWv0eR.js";import{I as se}from"./IconCircleX-Df5zhf_3.js";import{B as Q}from"./Button-BjRr-4Eh.js";import"./preload-helper-C1FmrZbK.js";import"./IconX-D1qmt8Yz.js";import"./createReactComponent-DB1W9lnY.js";function g({selectedItems:t=[],onRemove:v,emptyText:x="No item selected",rightContent:b,removable:U=!0,error:Y=!1,errorMessage:Z,className:$,...ee}){const h=t.length>0,p=Y&&!h;return e.jsxs("div",{className:te("flex flex-row items-center justify-between gap-4 w-full","px-3 py-2","rounded-[var(--table-row-radius)]","min-h-[42px]",p?"bg-[var(--inline-message-error-bg)]":"bg-[var(--color-surface-subtle)]",$),role:p?"status":void 0,...ee,children:[e.jsx("div",{className:"flex items-center gap-2 flex-wrap",children:h?t.map(u=>e.jsx(re,{value:u.label,variant:"selected",onRemove:U&&v?()=>v(u.id):void 0},u.id)):p?e.jsxs(e.Fragment,{children:[e.jsx(se,{size:16,className:"text-[var(--inline-message-error-icon)] shrink-0",strokeWidth:1.5}),e.jsx("span",{className:"text-[length:var(--inline-message-font-size)] leading-[var(--inline-message-line-height)] text-[var(--inline-message-text)]",children:Z||x})]}):e.jsx("span",{className:"text-[12px] text-[var(--color-text-muted)]",children:x})}),b&&e.jsx("div",{className:"flex items-center shrink-0",children:b})]})}g.__docgenInfo={description:"",methods:[],displayName:"SelectionIndicator",props:{selectedItems:{required:!1,tsType:{name:"Array",elements:[{name:"SelectionItem"}],raw:"SelectionItem[]"},description:"Selected items to display",defaultValue:{value:"[]",computed:!1}},onRemove:{required:!1,tsType:{name:"signature",type:"function",raw:"(id: string) => void",signature:{arguments:[{type:{name:"string"},name:"id"}],return:{name:"void"}}},description:"Callback when an item is removed"},emptyText:{required:!1,tsType:{name:"string"},description:"Text to show when no items are selected",defaultValue:{value:"'No item selected'",computed:!1}},rightContent:{required:!1,tsType:{name:"ReactNode"},description:"Additional content to render on the right side"},removable:{required:!1,tsType:{name:"boolean"},description:"Whether to allow removing items",defaultValue:{value:"true",computed:!1}},error:{required:!1,tsType:{name:"boolean"},description:"Whether to show error state",defaultValue:{value:"false",computed:!1}},errorMessage:{required:!1,tsType:{name:"string"},description:"Error message to display when in error state and no items selected"}},composes:["Omit"]};const pe={title:"Components/SelectionIndicator",component:g,tags:["autodocs"],decorators:[t=>e.jsx("div",{className:"max-w-xl",children:e.jsx(t,{})})],parameters:{docs:{description:{component:`
...
\`\`\`
...
}`,...(w=(y=s.parameters)==null?void 0:y.docs)==null?void 0:w.source}}};var C,N,j;a.parameters={...a.parameters,docs:{...(C=a.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    selectedItems: [{
      id: '1',
...
}`,...(_=(A=i.parameters)==null?void 0:A.docs)==null?void 0:_.source}}};var P,D,O;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    selectedItems: [],
    emptyText: 'Click on items to select them'
  }
}`,...(O=(D=c.parameters)==null?void 0:D.docs)==null?void 0:O.source}}};var X,G,H;d.parameters={...d.parameters,docs:{...(X=d.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: () => <div className="flex flex-col gap-2">
      ...
      id: '2',
      label: 'prod-web-02'
    }]} onRemove={id => console.log('Remove:', id)} rightContent={<span className="text-xs text-[var(--color-text-muted)]">
            2 selected
          </span>} />
    </div>
...
}`,...(L=(K=m.parameters)==null?void 0:K.docs)==null?void 0:L.source}}};const ue=["Default","WithSelectedItems","SingleSelection","NonRemovable","ErrorState","WithRightContent","ManyItems","CustomEmptyText","InFormContext","ErrorWithRightContent"];export{c as CustomEmptyText,r as Default,n as ErrorState,m as ErrorWithRightContent,d as InFormContext,i as ManyItems,o as NonRemovable,a as SingleSelection,l as WithRightContent,s as WithSelectedItems,ue as __namedExportsOrder,pe as default};
