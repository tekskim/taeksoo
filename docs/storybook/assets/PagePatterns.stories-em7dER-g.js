import{j as e,r as h}from"./iframe-DD6jyF7N.js";import{P as $,I as X}from"./PageShell-BjyTpi6l.js";import{P as I}from"./PageHeader-C2-LYyOk.js";import{E as q}from"./EmptyState-B55qHMUk.js";import{T as Q}from"./Table-lWqW2ThX.js";import{L as S}from"./ListToolbar-ngx2AyOu.js";import{P as Y}from"./Pagination-DqnG9NsI.js";import{B as s}from"./Button-DRmVrDtr.js";import{S as ee}from"./SearchInput-C18o4f21.js";import{S as v}from"./StatusIndicator-BPt7c4Qh.js";import{T as ae,a as te,b as p,c as C}from"./Tabs-BecGFVOD.js";import{D as i}from"./DetailHeader-Cn672FR4.js";import{S as a}from"./SectionCard-DG33TnW0.js";import{I as x}from"./InfoBox-CczFL6NU.js";import{V as l}from"./Stack-Bf9O5UL3.js";import{I as re,a as W}from"./IconTerminal2-C899IN79.js";import{C as se}from"./ContextMenu-DY2rmx-A.js";import{I as oe}from"./IconChevronDown-BtcBS3A-.js";import{I as ie}from"./IconEdit-CsZ2fob0.js";import{I as y}from"./IconPlus-Dx0Dvzir.js";import{I as J}from"./IconDatabase-Bz3QO6cP.js";import{I as ne}from"./IconPlayerStop-6GJe3WXJ.js";import{I as le}from"./IconTrash-D-ksSqWe.js";import{I as ce}from"./IconDownload-DkVwSnal.js";import{T as de}from"./TopBar-CCWoW0te.js";import{B as me}from"./Breadcrumb-DChJ5TMf.js";import{T as pe}from"./TabBar-DhuWRuR1.js";import{S as xe}from"./SNBMenuItem-DUSDCfOv.js";import{I as ue}from"./IconServer-C5SAPBcn.js";import{a as be,I as je}from"./IconShield-B0_Ow4wM.js";import{I as ge}from"./IconSettings-DbC3mb3w.js";import"./preload-helper-C1FmrZbK.js";import"./createReactComponent-BZMrecJg.js";import"./overlayscrollbars-react-Bz5brGty.js";import"./Skeleton-CEq8_wZA.js";import"./cn-BMXv33oC.js";import"./Checkbox-DW-wJx6C.js";import"./IconMinus-D2py_i2v.js";import"./IconCheck-DLNLhokL.js";import"./Radio-B3BeM2uW.js";import"./IconChevronUp-Dt5qBDbK.js";import"./Chip-CtR3-5ck.js";import"./IconX-t6wpnM2j.js";import"./IconChevronLeft-DIbUa7_K.js";import"./IconChevronRight-BMUG6TI6.js";import"./IconSearch-ChtMy6qq.js";import"./Tooltip-Cq1DH4En.js";import"./index-CW36Fogi.js";import"./IconTool-DsXw3ZZq.js";import"./IconAlertTriangle-1kVqwTuZ.js";import"./chunk-JZWAC4HX-DSW3bzGI.js";import"./IconInfoCircle-DJ-MszvL.js";import"./CopyButton-C---1gFD.js";import"./IconCopy-CuSXRD8p.js";import"./IconLayoutSidebar-CXxwqPCg.js";import"./IconSquares-CVlosLfa.js";const Da={title:"Patterns/Page Patterns",parameters:{layout:"fullscreen",docs:{description:{component:`
## TDS 페이지 패턴 가이드
...
3. \`SectionCard\` — 정보 그룹 (Header + DataRow)
        `}}}};function ye(){return e.jsx(f,{breadcrumbItems:[{label:"Proj-1",href:"#"},{label:"DNS Zones"}],children:e.jsxs(l,{gap:3,children:[e.jsx(I,{title:"DNS Zones",actions:e.jsx(s,{variant:"primary",size:"md",leftIcon:e.jsx(y,{size:12,stroke:1.5}),children:"Create Zone"})}),e.jsx(q,{icon:e.jsx(J,{size:48,stroke:1}),title:"No DNS zones found",description:"Create your first DNS zone to manage domain records.",action:e.jsx(s,{variant:"primary",size:"md",leftIcon:e.jsx(y,{size:12,stroke:1.5}),children:"Create Zone"})})]})})}const j={render:()=>e.jsx(ye,{}),parameters:{docs:{description:{story:"\n**Empty State 패턴** — 데이터가 없을 때의 페이지.\n\n구성요소:\n1. `PageHeader` — 제목 + Create 버튼\n2. `EmptyState` — 아이콘 + 제목 + 설명 + 액션 버튼\n\n`EmptyState`의 `variant`는 `card`(기본값)와 `inline` 중 선택 가능.\n        "}}}};function Ie(){return e.jsx(f,{breadcrumbItems:[{label:"Proj-1",href:"#"},{label:"Dashboard"}],children:e.jsxs(l,{gap:4,children:[e.jsx(I,{title:"Dashboard"}),e.jsxs("div",{className:"flex items-stretch gap-[12px] w-full",children:[e.jsx(x,{label:"Total Instances",value:24,tooltip:"Total number of compute instances.",className:"flex-1"}),e.jsx(x,{label:"Running",value:18,tooltip:"Currently running instances.",className:"flex-1"}),e.jsx(x,{label:"Stopped",value:4,tooltip:"Stopped instances.",className:"flex-1"}),e.jsx(x,{label:"Errors",value:2,tooltip:"Instances with errors.",className:"flex-1"})]}),e.jsxs(a,{children:[e.jsx(a.Header,{title:"Recent Activity",actions:e.jsx(s,{variant:"ghost",size:"sm",children:"View All"})}),e.jsxs(a.Content,{children:[e.jsx(a.DataRow,{label:"web-server-01",value:e.jsx(v,{status:"active",label:"Started",layout:"badge"})}),e.jsx(a.DataRow,{label:"db-server-02",value:e.jsx(v,{status:"error",label:"Failed",layout:"badge"})}),e.jsx(a.DataRow,{label:"worker-03",value:e.jsx(v,{status:"building",label:"Building",layout:"badge"})})]})]}),e.jsxs(a,{children:[e.jsx(a.Header,{title:"Resource Usage"}),e.jsxs(a.Content,{children:[e.jsx(a.DataRow,{label:"vCPUs Used",value:"48 / 128"}),e.jsx(a.DataRow,{label:"Memory Used",value:"96 GB / 256 GB"}),e.jsx(a.DataRow,{label:"Storage Used",value:"1.2 TB / 5 TB"}),e.jsx(a.DataRow,{label:"Floating IPs",value:"6 / 20"})]})]})]})})}const g={render:()=>e.jsx(Ie,{}),parameters:{docs:{description:{story:`
...
}`,...(R=(N=u.parameters)==null?void 0:N.docs)==null?void 0:R.source}}};var E,B,H;b.parameters={...b.parameters,docs:{...(E=b.parameters)==null?void 0:E.docs,source:{originalSource:`{
...
}`,...(H=(B=b.parameters)==null?void 0:B.docs)==null?void 0:H.source}}};var A,L,M;j.parameters={...j.parameters,docs:{...(A=j.parameters)==null?void 0:A.docs,source:{originalSource:`{
...
}`,...(F=(G=g.parameters)==null?void 0:G.docs)==null?void 0:F.source}}};const ka=["ListPage","DetailPage","EmptyStatePage","DashboardPage"];export{g as DashboardPage,b as DetailPage,j as EmptyStatePage,u as ListPage,ka as __namedExportsOrder,Da as default};
