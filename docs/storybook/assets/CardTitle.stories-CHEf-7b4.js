import{j as e}from"./iframe-DF19JO67.js";import{I as ne}from"./IconLock-Dot6hLat.js";import{I as oe}from"./IconCloud-hP9fPP6W.js";import{I as le}from"./IconStar-BlKIu_x_.js";import"./preload-helper-C1FmrZbK.js";import"./createReactComponent-D4u5JA0x.js";function ce({color:t="success"}){const s={success:"bg-[var(--color-success,#4ade80)]",warning:"bg-[var(--color-warning,#facc15)]",error:"bg-[var(--color-danger,#ef4444)]",info:"bg-[var(--color-action-primary,#3b82f6)]",muted:"bg-[var(--color-text-muted,#64748b)]"};return e.jsx("div",{className:`w-6 h-6 rounded-full ${s[t]} flex items-center justify-center shrink-0`,children:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:e.jsx("path",{d:"M13.3334 4L6.00008 11.3333L2.66675 8",stroke:"white",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})}function ue({badge:t}){const s={default:"bg-[var(--color-surface-subtle)] text-[var(--color-text-muted)]",success:"bg-green-50 text-green-600",info:"bg-blue-50 text-blue-500",warning:"bg-amber-50 text-amber-600",muted:"bg-gray-100 text-[var(--color-text-muted)]"};return e.jsxs("span",{className:`inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md text-label-sm leading-4 ${s[t.variant||"muted"]}`,children:[t.icon&&e.jsx("span",{className:"w-[9px] h-[9px]",children:t.icon}),t.label]})}function a({title:t,description:s,showStatus:X=!1,statusColor:Z="success",badges:f,side:v="none",gaugeValue:ee,gaugeLabel:te,sideIcon:x,className:ae="",onClick:b}){const se=f&&f.length>0;return e.jsxs("div",{className:`flex items-start gap-3 ${ae} ${b?"cursor-pointer":""}`,onClick:b,children:[X&&e.jsx(ce,{color:Z}),e.jsxs("div",{className:"flex-1 min-w-0 flex flex-col gap-3",children:[e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("h4",{className:"text-heading-h5 leading-6 text-[var(--color-text-default)] truncate",children:t}),s&&e.jsx("p",{className:"text-body-md leading-4 text-[var(--color-text-subtle)] line-clamp-2",children:s})]}),se&&e.jsx("div",{className:"flex flex-wrap gap-1",children:f.map((re,ie)=>e.jsx(ue,{badge:re},ie))})]}),v==="gauge"&&e.jsxs("div",{className:"flex flex-col items-end gap-1 shrink-0",children:[e.jsx("span",{className:"text-heading-h5 leading-6 text-[var(--color-text-default)]",children:ee}),e.jsx("span",{className:"text-body-md leading-4 text-[var(--color-text-subtle)]",children:te})]}),v==="icon"&&x&&e.jsx("div",{className:"flex items-center justify-end shrink-0",children:x})]})}a.__docgenInfo={description:`CardTitle - A flexible card header component
...
}`,...(Q=(K=g.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};const be=["Default","WithDescription","WithStatus","WithBadges","WithStatusAndBadges","WithGauge","WithIcon","AllStatusColors","BadgeVariants","ComplexExample","Clickable"];export{d as AllStatusColors,m as BadgeVariants,g as Clickable,p as ComplexExample,r as Default,o as WithBadges,i as WithDescription,c as WithGauge,u as WithIcon,n as WithStatus,l as WithStatusAndBadges,be as __namedExportsOrder,xe as default};
