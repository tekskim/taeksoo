import{r,j as e}from"./iframe-ko1KmZFS.js";import{r as _e}from"./index-ChYZSdsP.js";import{t as y}from"./cn-BMXv33oC.js";import{I as Ke}from"./IconChevronDown-BvjhRmI4.js";import{I as $e}from"./IconCheck-BA2DoG5q.js";import"./preload-helper-C1FmrZbK.js";import"./createReactComponent-B-brzlrB.js";const Ve=r.createContext(null),Pe=()=>{const t=r.useContext(Ve);if(!t)throw new Error("Dropdown components must be used within a Dropdown.Root");return t};function Ie({children:t,value:a,defaultValue:i="",onChange:s,disabled:C=!1}){const[h,S]=r.useState(!1),[R,N]=r.useState(i),[j,D]=r.useState(""),[O,w]=r.useState(new Map),u=a!==void 0,b=u?a:R,n=r.useCallback((v,d,f)=>{w(B=>{const V=new Map(B);return V.set(v,{label:d,disabled:f}),V})},[]),x=r.useCallback(v=>{w(d=>{const f=new Map(d);return f.delete(v),f})},[]),m=r.useCallback((v,d)=>{u||N(v),s==null||s(v),S(!1)},[u,s]),G=r.useCallback(v=>{D(v)},[]);return e.jsx(Ve.Provider,{value:{isOpen:h,selectedValue:b,focusedValue:j,onSelect:m,onFocus:G,registerOption:n,unregisterOption:x},children:e.jsx(Te.Provider,{value:{isOpen:h,setIsOpen:S,disabled:C,options:O},children:t})})}const Te=r.createContext(null),He=()=>{const t=r.useContext(Te);if(!t)throw new Error("Dropdown components must be used within a Dropdown.Root");return t},H=r.forwardRef(({placeholder:t="Select an option",children:a,size:i="md",error:s=!1,fullWidth:C=!1,width:h="md",className:S,...R},N)=>{const j=r.useId(),D=`dropdown-trigger-${j}`,O=`dropdown-listbox-${j}`,{selectedValue:w,focusedValue:u,onFocus:b}=Pe(),{isOpen:n,setIsOpen:x,disabled:m,options:G}=He(),v=r.useRef(null),d=N||v,f=r.useRef(null),[B,V]=r.useState({top:0,left:0,width:0}),$=G.get(w),J=$==null?void 0:$.label,g=r.useCallback(()=>{const l=d.current;if(!l)return;const c=l.getBoundingClientRect();V({top:c.bottom+4,left:c.left,width:c.width})},[d]),P=r.useCallback(()=>{m||(g(),x(!0))},[m,g,x]),A=r.useCallback(()=>{var l;x(!1),(l=d.current)==null||l.focus()},[x,d]),Q=r.useCallback(l=>{if(m)return;const c=Array.from(G.entries()).filter(([,p])=>!p.disabled),k=c.findIndex(([p])=>p===u);switch(l.key){case"Enter":case" ":l.preventDefault(),n||P();break;case"ArrowDown":if(l.preventDefault(),!n)P();else{const p=k+1;p<c.length&&b(c[p][0])}break;case"ArrowUp":if(l.preventDefault(),n){const p=k-1;p>=0&&b(c[p][0])}break;case"Escape":l.preventDefault(),A();break}},[m,G,u,n,P,A,b]);r.useEffect(()=>{if(!n)return;const l=c=>{var k,p;(k=d.current)!=null&&k.contains(c.target)||(p=f.current)!=null&&p.contains(c.target)||A()};return document.addEventListener("mousedown",l),()=>document.removeEventListener("mousedown",l)},[n,A,d]),r.useEffect(()=>{if(n)return window.addEventListener("resize",g),window.addEventListener("scroll",g,!0),()=>{window.removeEventListener("resize",g),window.removeEventListener("scroll",g,!0)}},[n,g]);const qe={sm:"w-[160px]",md:"w-[240px]",lg:"w-[360px]"},Le=()=>C?"w-full":typeof h=="number"?`w-[${h}px]`:qe[h],Me={sm:"h-[var(--input-height-sm)] px-[var(--primitive-spacing-2)] text-body-sm",md:"h-[var(--input-height-md)] px-[var(--select-padding-x)] text-body-md"},We=y("flex items-center justify-between gap-[var(--primitive-spacing-2)]",Le(),Me[i],"bg-[var(--select-bg)]","border border-solid rounded-[var(--select-radius)]","transition-colors duration-[var(--duration-fast)]","cursor-pointer",s?"border-[var(--input-border-error)]":n?"border-[var(--select-border-focus)]":"border-[var(--select-border)]",m&&"bg-[var(--select-bg-disabled)] border-[var(--color-border-default)] cursor-not-allowed",S),Fe=y("fixed z-[var(--z-popover)]","bg-[var(--select-menu-bg)]","border border-[var(--select-menu-border)]","rounded-[var(--select-menu-radius)]","shadow-[var(--select-menu-shadow)]","overflow-hidden","focus:outline-none","py-[var(--primitive-spacing-1)]");return e.jsxs(e.Fragment,{children:[e.jsxs("button",{ref:d,id:D,type:"button",role:"combobox","aria-expanded":n,"aria-haspopup":"listbox","aria-controls":O,disabled:m,onClick:()=>n?A():P(),onKeyDown:Q,className:We,...R,children:[e.jsx("span",{className:y("text-body-md truncate",J?"text-[var(--color-text-default)]":"text-[var(--color-text-muted)]",m&&"text-[var(--color-text-subtle)]"),children:J??t}),e.jsx(Ke,{size:16,stroke:1.5,className:y("shrink-0 transition-transform duration-[var(--duration-fast)]","text-[var(--color-text-default)]",n&&"rotate-180",m&&"text-[var(--color-text-subtle)]")})]}),n&&_e.createPortal(e.jsx("div",{ref:f,id:O,role:"listbox","aria-labelledby":D,tabIndex:-1,onKeyDown:Q,className:Fe,style:{top:B.top,left:B.left,width:B.width},children:a}),document.body)]})});H.displayName="Dropdown.Select";function Ee({value:t,label:a,disabled:i=!1,children:s,className:C,...h}){const{selectedValue:S,focusedValue:R,onSelect:N,onFocus:j,registerOption:D,unregisterOption:O}=Pe(),w=a??(typeof s=="string"?s:""),u=S===t,b=R===t;r.useEffect(()=>(D(t,w,i),()=>O(t)),[t,w,i,D,O]);const n=()=>{i||N(t,w)},x=()=>{i||j(t)};return e.jsxs("div",{role:"option","aria-selected":u,"aria-disabled":i,onClick:n,onMouseEnter:x,className:y("flex items-center justify-between","px-[var(--select-item-padding-x)] py-[var(--select-item-padding-y)]","text-body-md","cursor-pointer transition-colors duration-[var(--duration-fast)]",i?"text-[var(--color-text-subtle)] cursor-not-allowed":u?"bg-[var(--select-item-selected-bg)] text-[var(--select-item-selected-text)]":b?"bg-[var(--select-item-hover-bg)] text-[var(--color-text-default)]":"text-[var(--color-text-default)] hover:bg-[var(--select-item-hover-bg)]",C),...h,children:[e.jsx("span",{className:"truncate",children:s}),u&&e.jsx($e,{size:14,className:"shrink-0 text-[var(--select-item-selected-text)]"})]})}function Ue({className:t,...a}){return e.jsx("div",{role:"separator",className:y("h-px bg-[var(--color-border-subtle)] my-[var(--primitive-spacing-1)]",t),...a})}function ze({label:t,children:a,className:i,...s}){return e.jsxs("div",{role:"group","aria-label":t,className:i,...s,children:[t&&e.jsx("div",{className:"px-[var(--select-item-padding-x)] py-[var(--primitive-spacing-1)] text-label-sm text-[var(--color-text-subtle)]",children:t}),a]})}const o={Root:Ie,Select:H,Option:Ee,Divider:Ue,Group:ze};Ie.__docgenInfo={description:"",methods:[],displayName:"DropdownRoot",props:{children:{required:!0,tsType:{name:"ReactNode"},description:"Children (Dropdown.Select, Dropdown.ComboBox)"},value:{required:!1,tsType:{name:"string"},description:"Controlled value"},defaultValue:{required:!1,tsType:{name:"string"},description:"Default value",defaultValue:{value:"''",computed:!1}},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:"Change handler"},disabled:{required:!1,tsType:{name:"boolean"},description:"Disabled state",defaultValue:{value:"false",computed:!1}}}};H.__docgenInfo={description:"",methods:[],displayName:"Dropdown.Select",props:{placeholder:{required:!1,tsType:{name:"string"},description:"Placeholder text",defaultValue:{value:"'Select an option'",computed:!1}},children:{required:!0,tsType:{name:"ReactNode"},description:"Children (Dropdown.Option)"},size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"}]},description:"Size variant",defaultValue:{value:"'md'",computed:!1}},error:{required:!1,tsType:{name:"boolean"},description:"Error state",defaultValue:{value:"false",computed:!1}},fullWidth:{required:!1,tsType:{name:"boolean"},description:"Full width",defaultValue:{value:"false",computed:!1}},width:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg' | number",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"},{name:"number"}]},description:"Width",defaultValue:{value:"'md'",computed:!1}}},composes:["Omit"]};Ee.__docgenInfo={description:"",methods:[],displayName:"DropdownOption",props:{value:{required:!0,tsType:{name:"string"},description:"Option value"},label:{required:!1,tsType:{name:"string"},description:"Option label (defaults to children)"},disabled:{required:!1,tsType:{name:"boolean"},description:"Disabled state",defaultValue:{value:"false",computed:!1}},children:{required:!0,tsType:{name:"ReactNode"},description:"Children"}},composes:["HTMLAttributes"]};Ue.__docgenInfo={description:"",methods:[],displayName:"DropdownDivider"};ze.__docgenInfo={description:"",methods:[],displayName:"DropdownGroup",props:{label:{required:!1,tsType:{name:"string"},description:"Group label"},children:{required:!0,tsType:{name:"ReactNode"},description:"Children"}},composes:["HTMLAttributes"]};const to={title:"Components/Dropdown",component:o.Root,parameters:{layout:"centered"}},I={render:()=>e.jsx(o.Root,{children:e.jsxs(o.Select,{placeholder:"Select an option",width:"md",children:[e.jsx(o.Option,{value:"apple",children:"Apple"}),e.jsx(o.Option,{value:"banana",children:"Banana"}),e.jsx(o.Option,{value:"cherry",children:"Cherry"}),e.jsx(o.Option,{value:"grape",children:"Grape"})]})})},T={render:()=>e.jsx(o.Root,{defaultValue:"banana",children:e.jsxs(o.Select,{placeholder:"Select a fruit",width:"md",children:[e.jsx(o.Option,{value:"apple",children:"Apple"}),e.jsx(o.Option,{value:"banana",children:"Banana"}),e.jsx(o.Option,{value:"cherry",children:"Cherry"})]})})},E={render:()=>{const[t,a]=r.useState("cherry");return e.jsxs("div",{className:"flex flex-col gap-[var(--primitive-spacing-4)]",children:[e.jsx(o.Root,{value:t,onChange:a,children:e.jsxs(o.Select,{placeholder:"Select a fruit",width:"md",children:[e.jsx(o.Option,{value:"apple",children:"Apple"}),e.jsx(o.Option,{value:"banana",children:"Banana"}),e.jsx(o.Option,{value:"cherry",children:"Cherry"})]})}),e.jsxs("p",{className:"text-body-sm text-[var(--color-text-muted)]",children:["Selected: ",e.jsx("strong",{children:t})]})]})}},U={render:()=>e.jsx(o.Root,{children:e.jsxs(o.Select,{placeholder:"Select an option",width:"md",children:[e.jsx(o.Option,{value:"available",children:"Available"}),e.jsx(o.Option,{value:"disabled1",disabled:!0,children:"Disabled Option 1"}),e.jsx(o.Option,{value:"another",children:"Another Option"}),e.jsx(o.Option,{value:"disabled2",disabled:!0,children:"Disabled Option 2"})]})})},z={render:()=>e.jsx(o.Root,{disabled:!0,defaultValue:"apple",children:e.jsxs(o.Select,{placeholder:"Select a fruit",width:"md",children:[e.jsx(o.Option,{value:"apple",children:"Apple"}),e.jsx(o.Option,{value:"banana",children:"Banana"})]})})},q={render:()=>e.jsxs("div",{className:"flex flex-col gap-4 items-start",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-label-sm text-[var(--color-text-subtle)] mb-[var(--primitive-spacing-2)]",children:"Small"}),e.jsx(o.Root,{children:e.jsxs(o.Select,{placeholder:"Select",size:"sm",width:"sm",children:[e.jsx(o.Option,{value:"a",children:"Option A"}),e.jsx(o.Option,{value:"b",children:"Option B"})]})})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-label-sm text-[var(--color-text-subtle)] mb-[var(--primitive-spacing-2)]",children:"Medium (default)"}),e.jsx(o.Root,{children:e.jsxs(o.Select,{placeholder:"Select",size:"md",width:"md",children:[e.jsx(o.Option,{value:"a",children:"Option A"}),e.jsx(o.Option,{value:"b",children:"Option B"})]})})]})]})},L={render:()=>e.jsxs("div",{className:"flex flex-col gap-4 items-start",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-label-sm text-[var(--color-text-subtle)] mb-[var(--primitive-spacing-2)]",children:"Small (160px)"}),e.jsx(o.Root,{children:e.jsxs(o.Select,{placeholder:"Select",width:"sm",children:[e.jsx(o.Option,{value:"a",children:"Option A"}),e.jsx(o.Option,{value:"b",children:"Option B"})]})})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-label-sm text-[var(--color-text-subtle)] mb-[var(--primitive-spacing-2)]",children:"Medium (240px)"}),e.jsx(o.Root,{children:e.jsxs(o.Select,{placeholder:"Select",width:"md",children:[e.jsx(o.Option,{value:"a",children:"Option A"}),e.jsx(o.Option,{value:"b",children:"Option B"})]})})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-label-sm text-[var(--color-text-subtle)] mb-[var(--primitive-spacing-2)]",children:"Large (320px)"}),e.jsx(o.Root,{children:e.jsxs(o.Select,{placeholder:"Select",width:"lg",children:[e.jsx(o.Option,{value:"a",children:"Option A"}),e.jsx(o.Option,{value:"b",children:"Option B"})]})})]}),e.jsxs("div",{className:"w-full max-w-md",children:[e.jsx("h3",{className:"text-label-sm text-[var(--color-text-subtle)] mb-[var(--primitive-spacing-2)]",children:"Full Width"}),e.jsx(o.Root,{children:e.jsxs(o.Select,{placeholder:"Select",fullWidth:!0,children:[e.jsx(o.Option,{value:"a",children:"Option A"}),e.jsx(o.Option,{value:"b",children:"Option B"})]})})]})]})},M={render:()=>e.jsx(o.Root,{children:e.jsxs(o.Select,{placeholder:"Select a region",width:"lg",children:[e.jsxs(o.Group,{label:"Asia Pacific",children:[e.jsx(o.Option,{value:"ap-northeast-1",children:"Tokyo (ap-northeast-1)"}),e.jsx(o.Option,{value:"ap-northeast-2",children:"Seoul (ap-northeast-2)"}),e.jsx(o.Option,{value:"ap-southeast-1",children:"Singapore (ap-southeast-1)"})]}),e.jsx(o.Divider,{}),e.jsxs(o.Group,{label:"United States",children:[e.jsx(o.Option,{value:"us-east-1",children:"N. Virginia (us-east-1)"}),e.jsx(o.Option,{value:"us-west-2",children:"Oregon (us-west-2)"})]}),e.jsx(o.Divider,{}),e.jsxs(o.Group,{label:"Europe",children:[e.jsx(o.Option,{value:"eu-west-1",children:"Ireland (eu-west-1)"}),e.jsx(o.Option,{value:"eu-central-1",children:"Frankfurt (eu-central-1)"})]})]})})},W={render:()=>e.jsx(o.Root,{children:e.jsxs(o.Select,{placeholder:"Select action",width:"md",children:[e.jsx(o.Option,{value:"edit",children:"Edit"}),e.jsx(o.Option,{value:"duplicate",children:"Duplicate"}),e.jsx(o.Divider,{}),e.jsx(o.Option,{value:"archive",children:"Archive"}),e.jsx(o.Option,{value:"move",children:"Move"}),e.jsx(o.Divider,{}),e.jsx(o.Option,{value:"delete",children:"Delete"})]})})},F={render:()=>e.jsxs("div",{className:"flex flex-col gap-[var(--primitive-spacing-2)]",children:[e.jsx(o.Root,{children:e.jsxs(o.Select,{placeholder:"Select a value",width:"md",error:!0,children:[e.jsx(o.Option,{value:"a",children:"Option A"}),e.jsx(o.Option,{value:"b",children:"Option B"})]})}),e.jsx("p",{className:"text-body-sm text-[var(--color-state-danger)]",children:"This field is required"})]})},_={render:()=>e.jsx(o.Root,{children:e.jsx(o.Select,{placeholder:"Select a country",width:"lg",children:["United States","Canada","United Kingdom","Germany","France","Italy","Spain","Japan","South Korea","China","Australia","Brazil","India","Mexico","Russia"].map(t=>e.jsx(o.Option,{value:t.toLowerCase().replace(" ","-"),children:t},t))})})},K={name:"thaki-ui Style (Compound Pattern)",render:()=>{const[t,a]=r.useState("");return e.jsxs("div",{className:"flex flex-col gap-[var(--primitive-spacing-4)]",children:[e.jsx("h3",{className:"text-heading-h6 text-[var(--color-text-default)]",children:"thaki-ui Compound Component Pattern"}),e.jsx("p",{className:"text-body-sm text-[var(--color-text-muted)]",children:"This follows the thaki-ui Dropdown pattern with Dropdown.Root, Dropdown.Select, and Dropdown.Option components."}),e.jsx(o.Root,{value:t,onChange:a,children:e.jsxs(o.Select,{placeholder:"Select instance type",width:"lg",children:[e.jsxs(o.Group,{label:"General Purpose",children:[e.jsx(o.Option,{value:"m5.large",children:"m5.large (2 vCPU, 8 GB)"}),e.jsx(o.Option,{value:"m5.xlarge",children:"m5.xlarge (4 vCPU, 16 GB)"}),e.jsx(o.Option,{value:"m5.2xlarge",children:"m5.2xlarge (8 vCPU, 32 GB)"})]}),e.jsx(o.Divider,{}),e.jsxs(o.Group,{label:"Compute Optimized",children:[e.jsx(o.Option,{value:"c5.large",children:"c5.large (2 vCPU, 4 GB)"}),e.jsx(o.Option,{value:"c5.xlarge",children:"c5.xlarge (4 vCPU, 8 GB)"})]}),e.jsx(o.Divider,{}),e.jsxs(o.Group,{label:"Memory Optimized",children:[e.jsx(o.Option,{value:"r5.large",children:"r5.large (2 vCPU, 16 GB)"}),e.jsx(o.Option,{value:"r5.xlarge",children:"r5.xlarge (4 vCPU, 32 GB)"})]})]})}),t&&e.jsxs("p",{className:"text-body-sm text-[var(--color-text-muted)]",children:["Selected: ",e.jsx("code",{className:"text-body-sm",children:t})]})]})}};var X,Y,Z;I.parameters={...I.parameters,docs:{...(X=I.parameters)==null?void 0:X.docs,source:{originalSource:`{
...
}`,...(te=(oe=T.parameters)==null?void 0:oe.docs)==null?void 0:te.source}}};var re,ne,ae;E.parameters={...E.parameters,docs:{...(re=E.parameters)==null?void 0:re.docs,source:{originalSource:`{
  render: () => {
...
}`,...(ae=(ne=E.parameters)==null?void 0:ne.docs)==null?void 0:ae.source}}};var le,ie,se;U.parameters={...U.parameters,docs:{...(le=U.parameters)==null?void 0:le.docs,source:{originalSource:`{
  render: () => <Dropdown.Root>
      <Dropdown.Select placeholder="Select an option" width="md">
...
}`,...(se=(ie=U.parameters)==null?void 0:ie.docs)==null?void 0:se.source}}};var de,pe,ce;z.parameters={...z.parameters,docs:{...(de=z.parameters)==null?void 0:de.docs,source:{originalSource:`{
...
}`,...(ce=(pe=z.parameters)==null?void 0:pe.docs)==null?void 0:ce.source}}};var ue,me,ve;q.parameters={...q.parameters,docs:{...(ue=q.parameters)==null?void 0:ue.docs,source:{originalSource:`{
...
}`,...(ve=(me=q.parameters)==null?void 0:me.docs)==null?void 0:ve.source}}};var he,we,xe;L.parameters={...L.parameters,docs:{...(he=L.parameters)==null?void 0:he.docs,source:{originalSource:`{
  render: () => <div className="flex flex-col gap-4 items-start">
      <div>
        <h3 className="text-label-sm text-[var(--color-text-subtle)] mb-[var(--primitive-spacing-2)]">
          Small (160px)
...
}`,...(xe=(we=L.parameters)==null?void 0:we.docs)==null?void 0:xe.source}}};var De,Oe,be;M.parameters={...M.parameters,docs:{...(De=M.parameters)==null?void 0:De.docs,source:{originalSource:`{
  render: () => <Dropdown.Root>
