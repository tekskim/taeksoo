import{j as t,r as g}from"./iframe-DD6jyF7N.js";import{t as n}from"./cn-BMXv33oC.js";import{I as D}from"./InfoBox-CczFL6NU.js";function i({children:e,className:r,...a}){return t.jsx("div",{"data-figma-name":"[TDS] DetailPageHeader",className:n("bg-[var(--color-surface-default)]","border border-[var(--color-border-default)]","rounded-[var(--radius-lg)]","px-4 pt-3 pb-3","w-full",r),...a,children:e})}function p({children:e,className:r,...a}){return t.jsx("h5",{"data-figma-name":"[TDS] DetailPageHeader/Title",className:n("text-heading-h5","text-[var(--color-text-default)]","mb-3",r),...a,children:e})}function c({children:e,className:r,...a}){return t.jsx("div",{"data-figma-name":"[TDS] DetailPageHeader/Actions",className:n("flex items-center gap-1","mb-3",r),...a,children:e})}function b(e){if(e<=4)return[e];if(e===5)return[3,2];if(e===6)return[4,2];if(e===7)return[4,3];if(e===8)return[4,4];if(e===9)return[4,3,2];if(e===10)return[4,4,2];if(e===11)return[4,4,3];if(e===12)return[4,4,4];const r=[];let a=e;for(;a>0;)r.push(Math.min(4,a)),a-=Math.min(4,a);return r}function f({children:e,className:r,...a}){const l=g.Children.toArray(e),d=l.length,o=b(d);if(o.length===1)return t.jsx("div",{"data-figma-name":"[TDS] DetailPageHeader/InfoGrid",className:n("flex items-stretch gap-3","w-full",r),...a,children:e});let m=0;const h=o.map(s=>{const u=l.slice(m,m+s);return m+=s,u});return t.jsx("div",{"data-figma-name":"[TDS] DetailPageHeader/InfoGrid",className:n("flex flex-col gap-3","w-full",r),...a,children:h.map((s,u)=>t.jsx("div",{className:"flex items-stretch gap-3 w-full",children:s},u))})}function v({label:e,value:r,copyable:a=!1,status:l,tooltip:d,className:o}){return t.jsx(D,{label:e,value:r,tooltip:d,copyable:a,status:l,className:n("flex-1",o)})}i.Title=p;i.Actions=c;i.InfoGrid=f;i.InfoCard=v;i.__docgenInfo={description:"",methods:[{name:"Title",docblock:null,modifiers:["static"],params:[{name:"{ children, className, ...props }: DetailHeaderTitleProps",optional:!1,type:{name:"DetailHeaderTitleProps",alias:"DetailHeaderTitleProps"}}],returns:null},{name:"Actions",docblock:null,modifiers:["static"],params:[{name:"{ children, className, ...props }: DetailHeaderActionsProps",optional:!1,type:{name:"DetailHeaderActionsProps",alias:"DetailHeaderActionsProps"}}],returns:null},{name:"InfoGrid",docblock:null,modifiers:["static"],params:[{name:"{ children, className, ...props }: DetailHeaderInfoGridProps",optional:!1,type:{name:"DetailHeaderInfoGridProps",alias:"DetailHeaderInfoGridProps"}}],returns:null},{name:"InfoCard",docblock:null,modifiers:["static"],params:[{name:`{
  label,
  value,
  copyable = false,
  status,
