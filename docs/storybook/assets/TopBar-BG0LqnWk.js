import{j as e}from"./iframe-DkQu90e3.js";import{I as f}from"./IconLayoutSidebar-DDQVDKAL.js";import{c as l}from"./createReactComponent-Bn1mjhIb.js";/**
 ...
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const v=[["path",{d:"M5 12l14 0",key:"svg-0"}],["path",{d:"M13 18l6 -6",key:"svg-1"}],["path",{d:"M13 6l6 6",key:"svg-2"}]],h=l("outline","arrow-right","ArrowRight",v),x=({onSidebarToggle:a,onBack:t,onForward:r,canGoBack:o=!0,canGoForward:s=!0,breadcrumb:i,actions:d,showSidebarToggle:c=!1,showSidebarToggleAfterBreadcrumb:u=!1,showNavigation:p=!0,className:b=""})=>{const n=`
  ...
  `;return e.jsxs("header",{"data-figma-name":"TopBar",className:`
        flex items-center
        w-full
        h-[var(--topbar-height)]
