import{j as e}from"./iframe-DD6jyF7N.js";import{S as a}from"./StatusIndicator-BPt7c4Qh.js";import"./preload-helper-C1FmrZbK.js";import"./cn-BMXv33oC.js";import"./Tooltip-Cq1DH4En.js";import"./index-CW36Fogi.js";import"./IconTool-DsXw3ZZq.js";import"./createReactComponent-BZMrecJg.js";import"./IconEdit-CsZ2fob0.js";import"./IconAlertTriangle-1kVqwTuZ.js";const Le={title:"Components/StatusIndicator",component:a,parameters:{layout:"centered",docs:{description:{component:"리소스나 작업의 상태를 시각적으로 표시하는 컴포넌트입니다."}}},tags:["autodocs"],argTypes:{status:{control:"select",options:["active","error","building","deleting","suspended","shelved","shelved-offloaded","mounted","shutoff","paused","pending","draft","verify-resized","deactivated","in-use","maintenance","degraded","no-monitor","down"],description:"상태 유형"},layout:{control:"select",options:["icon-only","badge"],description:"레이아웃 유형"},size:{control:"select",options:["sm","md","lg"],description:"크기 (icon-only 레이아웃에만 적용)"},label:{control:"text",description:"커스텀 라벨 (기본값 덮어쓰기)"}}},s={args:{status:"active",layout:"default"}},t={args:{status:"error",layout:"default"}},r={args:{status:"building",layout:"default"}},i={args:{status:"pending",layout:"default"}},o={name:"Layout - Icon Only",args:{status:"active",layout:"icon-only",size:"md"}},n={name:"Layout - Default (Pill)",args:{status:"active",layout:"default"}},c={name:"Layout - Badge",args:{status:"active",layout:"badge"}},d={name:"All Sizes (Icon Only)",render:()=>e.jsxs("div",{className:"flex items-center gap-[var(--primitive-spacing-4)]",children:[e.jsxs("div",{className:"flex flex-col items-center gap-[var(--primitive-spacing-2)]",children:[e.jsx(a,{status:"active",layout:"icon-only",size:"sm"}),e.jsx("span",{className:"text-body-sm text-[var(--color-text-subtle)]",children:"sm"})]}),e.jsxs("div",{className:"flex flex-col items-center gap-[var(--primitive-spacing-2)]",children:[e.jsx(a,{status:"active",layout:"icon-only",size:"md"}),e.jsx("span",{className:"text-body-sm text-[var(--color-text-subtle)]",children:"md"})]}),e.jsxs("div",{className:"flex flex-col items-center gap-[var(--primitive-spacing-2)]",children:[e.jsx(a,{status:"active",layout:"icon-only",size:"lg"}),e.jsx("span",{className:"text-body-sm text-[var(--color-text-subtle)]",children:"lg"})]})]})},l={name:"Category - Success (Green)",render:()=>e.jsx("div",{className:"flex flex-col gap-[var(--primitive-spacing-3)]",children:e.jsx(a,{status:"active",layout:"badge"})})},u={name:"Category - Danger (Red)",render:()=>e.jsx("div",{className:"flex flex-col gap-[var(--primitive-spacing-3)]",children:e.jsx(a,{status:"error",layout:"badge"})})},p={name:"Category - Info (Blue)",render:()=>e.jsxs("div",{className:"flex flex-col gap-[var(--primitive-spacing-3)]",children:[e.jsx(a,{status:"building",layout:"badge"}),e.jsx(a,{status:"deleting",layout:"badge"}),e.jsx(a,{status:"pending",layout:"badge"})]})},m={name:"Category - Warning (Orange)",render:()=>e.jsxs("div",{className:"flex flex-col gap-[var(--primitive-spacing-3)]",children:[e.jsx(a,{status:"verify-resized",layout:"badge"}),e.jsx(a,{status:"degraded",layout:"badge"}),e.jsx(a,{status:"no-monitor",layout:"badge"}),e.jsx(a,{status:"down",layout:"badge"}),e.jsx(a,{status:"maintenance",layout:"badge"})]})},v={name:"Category - Muted (Gray)",render:()=>e.jsxs("div",{className:"flex flex-wrap gap-[var(--primitive-spacing-3)]",children:[e.jsx(a,{status:"suspended",layout:"badge"}),e.jsx(a,{status:"shelved",layout:"badge"}),e.jsx(a,{status:"shelved-offloaded",layout:"badge"}),e.jsx(a,{status:"mounted",layout:"badge"}),e.jsx(a,{status:"shutoff",layout:"badge"}),e.jsx(a,{status:"paused",layout:"badge"}),e.jsx(a,{status:"draft",layout:"badge"}),e.jsx(a,{status:"deactivated",layout:"badge"}),e.jsx(a,{status:"in-use",layout:"badge"})]})},g={name:"All Statuses",render:()=>{const ye=["active","error","building","deleting","suspended","shelved","shelved-offloaded","mounted","shutoff","paused","pending","draft","verify-resized","deactivated","in-use","maintenance","degraded","no-monitor","down"];return e.jsx("div",{className:"flex flex-col gap-[var(--primitive-spacing-4)]",children:e.jsx("div",{className:"grid grid-cols-3 gap-[var(--primitive-spacing-4)]",children:ye.map(f=>e.jsxs("div",{className:"flex items-center gap-[var(--primitive-spacing-3)]",children:[e.jsx(a,{status:f,layout:"icon-only",size:"md"}),e.jsx(a,{status:f,layout:"badge"})]},f))})})}},x={name:"With Custom Label",args:{status:"active",layout:"badge",label:"Running"}},y={name:"Use Case - Instance Table",render:()=>e.jsx("div",{className:"border border-[var(--color-border-default)] rounded-[var(--primitive-radius-lg)] overflow-hidden",children:e.jsxs("table",{className:"w-full text-body-md",children:[e.jsx("thead",{className:"bg-[var(--color-surface-subtle)]",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-[var(--primitive-spacing-4)] py-[var(--primitive-spacing-2)] text-left",children:"Instance"}),e.jsx("th",{className:"px-[var(--primitive-spacing-4)] py-[var(--primitive-spacing-2)] text-left",children:"Status"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{className:"border-t",children:[e.jsx("td",{className:"px-[var(--primitive-spacing-4)] py-[var(--primitive-spacing-2)]",children:"web-server-01"}),e.jsx("td",{className:"px-[var(--primitive-spacing-4)] py-[var(--primitive-spacing-2)]",children:e.jsx(a,{status:"active",layout:"icon-only",size:"sm"})})]}),e.jsxs("tr",{className:"border-t",children:[e.jsx("td",{className:"px-[var(--primitive-spacing-4)] py-[var(--primitive-spacing-2)]",children:"web-server-02"}),e.jsx("td",{className:"px-[var(--primitive-spacing-4)] py-[var(--primitive-spacing-2)]",children:e.jsx(a,{status:"building",layout:"icon-only",size:"sm"})})]}),e.jsxs("tr",{className:"border-t",children:[e.jsx("td",{className:"px-[var(--primitive-spacing-4)] py-[var(--primitive-spacing-2)]",children:"db-server-01"}),e.jsx("td",{className:"px-[var(--primitive-spacing-4)] py-[var(--primitive-spacing-2)]",children:e.jsx(a,{status:"error",layout:"icon-only",size:"sm"})})]}),e.jsxs("tr",{className:"border-t",children:[e.jsx("td",{className:"px-[var(--primitive-spacing-4)] py-[var(--primitive-spacing-2)]",children:"cache-server-01"}),e.jsx("td",{className:"px-[var(--primitive-spacing-4)] py-[var(--primitive-spacing-2)]",children:e.jsx(a,{status:"shutoff",layout:"icon-only",size:"sm"})})]})]})]})})},b={name:"Use Case - Resource Card",render:()=>e.jsxs("div",{className:"border border-[var(--color-border-default)] rounded-[var(--primitive-radius-lg)] p-[var(--primitive-spacing-4)] w-64",children:[e.jsxs("div",{className:"flex items-center justify-between mb-[var(--primitive-spacing-3)]",children:[e.jsx("h3",{className:"text-label-lg text-[var(--color-text-default)]",children:"Production Server"}),e.jsx(a,{status:"active",layout:"badge"})]}),e.jsxs("div",{className:"text-body-md text-[var(--color-text-muted)]",children:[e.jsx("p",{children:"CPU: 45%"}),e.jsx("p",{children:"Memory: 2.4 GB / 8 GB"}),e.jsx("p",{children:"Uptime: 15 days"})]})]})};var h,S,j;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    status: 'active',
    layout: 'default'
  }
}`,...(j=(S=s.parameters)==null?void 0:S.docs)==null?void 0:j.source}}};var N,I,z;t.parameters={...t.parameters,docs:{...(N=t.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    status: 'error',
    layout: 'default'
  }
...
}`,...(ae=(ee=m.parameters)==null?void 0:ee.docs)==null?void 0:ae.source}}};var se,te,re;v.parameters={...v.parameters,docs:{...(se=v.parameters)==null?void 0:se.docs,source:{originalSource:`{
...
}`,...(re=(te=v.parameters)==null?void 0:te.docs)==null?void 0:re.source}}};var ie,oe,ne;g.parameters={...g.parameters,docs:{...(ie=g.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  name: 'All Statuses',
  render: () => {
...
}`,...(me=(pe=y.parameters)==null?void 0:pe.docs)==null?void 0:me.source}}};var ve,ge,xe;b.parameters={...b.parameters,docs:{...(ve=b.parameters)==null?void 0:ve.docs,source:{originalSource:`{
...
}`,...(xe=(ge=b.parameters)==null?void 0:ge.docs)==null?void 0:xe.source}}};const Be=["Active","Error","Building","Pending","IconOnly","DefaultLayout","BadgeLayout","AllSizes","SuccessStatuses","DangerStatuses","InfoStatuses","WarningStatuses","MutedStatuses","AllStatuses","CustomLabel","InstanceTable","ResourceCard"];export{s as Active,d as AllSizes,g as AllStatuses,c as BadgeLayout,r as Building,x as CustomLabel,u as DangerStatuses,n as DefaultLayout,t as Error,o as IconOnly,p as InfoStatuses,y as InstanceTable,v as MutedStatuses,i as Pending,b as ResourceCard,l as SuccessStatuses,m as WarningStatuses,Be as __namedExportsOrder,Le as default};
