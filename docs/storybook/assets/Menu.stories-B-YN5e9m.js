import{j as e,r as Y}from"./iframe-D96dQDLz.js";import{t as z}from"./bundle-mjs-BZSatpsL.js";import{L as Z,B as ee}from"./chunk-JZWAC4HX-BYxYPSrz.js";import{V as S}from"./Stack-o3rwwWCc.js";import{I as ae}from"./IconChevronDown-B3KfbvkI.js";import{I as se}from"./IconChevronRight-DfXvK1WI.js";import{I as h}from"./IconHome-CCxDsjnd.js";import{I}from"./IconFolder-BbIK-0K_.js";import{I as k}from"./IconSettings-V_NTaVXh.js";import{I as re}from"./IconFile-o-Waz1iF.js";import{I as te}from"./IconUser-BKMwiuY3.js";import{I as oe}from"./IconTrash-Dlq7Hary.js";import{c as ne}from"./createReactComponent-Dvr8b43U.js";import"./preload-helper-C1FmrZbK.js";/**
 * @license @tabler/icons-react v3.36.1 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const ie=[["path",{d:"M14 8v-2a2 2 0 0 0 -2 -2h-7a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h7a2 2 0 0 0 2 -2v-2",key:"svg-0"}],["path",{d:"M9 12h12l-3 -3",key:"svg-1"}],["path",{d:"M18 15l3 -3",key:"svg-2"}]],le=ne("outline","logout","Logout",ie);function a({icon:s,label:n,href:l,active:t=!1,badge:i,onClick:o,disabled:r=!1}){const c=["w-[175px]","px-[var(--menu-item-padding-x)]","py-[var(--menu-item-padding-y)]","rounded-[var(--menu-item-radius)]","flex items-center","gap-[var(--menu-item-gap)]","text-[length:var(--font-size-11)]","transition-colors duration-[var(--duration-fast)]","focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-border-focus)]"].join(" "),M=t?"bg-[var(--color-state-info-bg)] text-[var(--color-action-primary)] font-medium":r?"text-[var(--color-text-disabled)] cursor-not-allowed":"text-[var(--color-text-default)] hover:bg-[var(--color-surface-subtle)] font-normal",y=e.jsxs(e.Fragment,{children:[s&&e.jsx("span",{className:`shrink-0 ${t?"text-[var(--color-action-primary)]":"text-[var(--color-text-default)]"}`,children:s}),e.jsx("span",{className:"text-left truncate",children:n}),i&&e.jsx("span",{className:"px-1.5 py-0.5 text-[10px] font-medium bg-[var(--color-state-info-bg)] text-[var(--color-action-primary)] rounded",children:i})]});return l?e.jsx(Z,{to:l,onClick:r?X=>X.preventDefault():o,className:z(c,M),"aria-current":t?"page":void 0,"aria-disabled":r,children:y}):e.jsx("button",{type:"button",onClick:r?void 0:o,className:z(c,M),"aria-disabled":r,children:y})}a.__docgenInfo={description:"",methods:[],displayName:"MenuItem",props:{icon:{required:!1,tsType:{name:"ReactNode"},description:"Menu icon"},label:{required:!0,tsType:{name:"string"},description:"Menu label"},href:{required:!1,tsType:{name:"string"},description:"Link URL"},active:{required:!1,tsType:{name:"boolean"},description:"Active state",defaultValue:{value:"false",computed:!1}},badge:{required:!1,tsType:{name:"string"},description:"Badge text (New, Beta, etc.)"},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Click handler"},disabled:{required:!1,tsType:{name:"boolean"},description:"Disabled state",defaultValue:{value:"false",computed:!1}}}};function j({title:s,children:n,defaultOpen:l=!0,collapsible:t=!0,onTitleClick:i}){const[o,r]=Y.useState(l),c=()=>{t&&r(!o),i&&i()};return e.jsxs(S,{gap:2,className:"w-[175px]",children:[t?e.jsxs("button",{onClick:c,className:"flex items-center gap-1 w-[175px] group focus:outline-none px-[var(--menu-section-padding-x)] py-[var(--menu-section-padding-y)]",children:[e.jsx("span",{className:"text-[length:var(--font-size-11)] font-medium text-[var(--color-text-subtle)] group-hover:text-[var(--color-text-muted)] transition-colors duration-[var(--duration-fast)]",children:s}),o?e.jsx(ae,{size:16,className:"text-[var(--color-text-disabled)]",stroke:1}):e.jsx(se,{size:16,className:"text-[var(--color-text-disabled)]",stroke:1})]}):e.jsx("span",{className:"w-[175px] text-[length:var(--font-size-11)] font-medium text-[var(--color-text-subtle)] px-[var(--menu-section-padding-x)] py-[var(--menu-section-padding-y)]",children:s}),o&&e.jsx(S,{gap:0,className:"w-[175px]",children:n})]})}j.__docgenInfo={description:"",methods:[],displayName:"MenuSection",props:{title:{required:!0,tsType:{name:"string"},description:"Section title"},children:{required:!0,tsType:{name:"ReactNode"},description:"Menu items"},defaultOpen:{required:!1,tsType:{name:"boolean"},description:"Default open state",defaultValue:{value:"true",computed:!1}},collapsible:{required:!1,tsType:{name:"boolean"},description:"Collapsible",defaultValue:{value:"true",computed:!1}},onTitleClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Click handler for title"}}};function v({spacing:s="md"}){const n={sm:"my-1",md:"my-[var(--menu-divider-margin)]",lg:"my-3"};return e.jsx("div",{className:`w-full h-px bg-[var(--color-border-default)] ${n[s]}`})}v.__docgenInfo={description:"",methods:[],displayName:"MenuDivider",props:{spacing:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"Vertical spacing",defaultValue:{value:"'md'",computed:!1}}}};const Me={title:"Components/Menu",component:a,tags:["autodocs"],decorators:[s=>e.jsx(ee,{children:e.jsx("div",{className:"bg-[var(--color-surface-default)] p-4 rounded-lg border border-[var(--color-border-default)] w-fit",children:e.jsx(s,{})})})],parameters:{docs:{description:{component:`
## Menu 컴포넌트
...
}`,...(H=(A=f.parameters)==null?void 0:A.docs)==null?void 0:H.source}}};var W,O,U;x.parameters={...x.parameters,docs:{...(W=x.parameters)==null?void 0:W.docs,source:{originalSource:`{
...
}`,...(Q=(K=g.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};const ye=["Default","Active","Disabled","WithBadge","WithoutIcon","AllStates","SidebarMenu","CompactMenu"];export{u as Active,x as AllStates,g as CompactMenu,d as Default,m as Disabled,b as SidebarMenu,p as WithBadge,f as WithoutIcon,ye as __namedExportsOrder,Me as default};
