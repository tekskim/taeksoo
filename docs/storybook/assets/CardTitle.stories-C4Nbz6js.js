import{j as e}from"./iframe-DKmDJy9M.js";import{I as ne}from"./IconLock-DyzPmnfw.js";import{I as oe}from"./IconCloud-QoGrAsGB.js";import{c as le}from"./createReactComponent-DB1W9lnY.js";import"./preload-helper-C1FmrZbK.js";/**
 * @license @tabler/icons-react v3.36.1 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const ce=[["path",{d:"M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873l-6.158 -3.245",key:"svg-0"}]],ue=le("outline","star","Star",ce);function de({color:t="success"}){const s={success:"bg-[var(--color-success,#4ade80)]",warning:"bg-[var(--color-warning,#facc15)]",error:"bg-[var(--color-danger,#ef4444)]",info:"bg-[var(--color-action-primary,#3b82f6)]",muted:"bg-[var(--color-text-muted,#64748b)]"};return e.jsx("div",{className:`w-6 h-6 rounded-full ${s[t]} flex items-center justify-center shrink-0`,children:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:e.jsx("path",{d:"M13.3334 4L6.00008 11.3333L2.66675 8",stroke:"white",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})}function me({badge:t}){const s={default:"bg-[var(--color-surface-subtle)] text-[var(--color-text-muted)]",success:"bg-green-50 text-green-600",info:"bg-blue-50 text-blue-500",warning:"bg-amber-50 text-amber-600",muted:"bg-gray-100 text-[var(--color-text-muted)]"};return e.jsxs("span",{className:`inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md text-[11px] font-medium leading-4 ${s[t.variant||"muted"]}`,children:[t.icon&&e.jsx("span",{className:"w-[9px] h-[9px]",children:t.icon}),t.label]})}function a({title:t,description:s,showStatus:X=!1,statusColor:Z="success",badges:f,side:x="none",gaugeValue:ee,gaugeLabel:te,sideIcon:v,className:ae="",onClick:b}){const se=f&&f.length>0;return e.jsxs("div",{className:`flex items-start gap-3 ${ae} ${b?"cursor-pointer":""}`,onClick:b,children:[X&&e.jsx(de,{color:Z}),e.jsxs("div",{className:"flex-1 min-w-0 flex flex-col gap-3",children:[e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("h4",{className:"text-[16px] font-semibold leading-6 text-[var(--color-text-default)] truncate",children:t}),s&&e.jsx("p",{className:"text-[12px] leading-4 text-[var(--color-text-subtle)] line-clamp-2",children:s})]}),se&&e.jsx("div",{className:"flex flex-wrap gap-1",children:f.map((re,ie)=>e.jsx(me,{badge:re},ie))})]}),x==="gauge"&&e.jsxs("div",{className:"flex flex-col items-end gap-1 shrink-0",children:[e.jsx("span",{className:"text-[16px] font-semibold leading-6 text-[var(--color-text-default)]",children:ee}),e.jsx("span",{className:"text-[12px] leading-4 text-[var(--color-text-subtle)]",children:te})]}),x==="icon"&&v&&e.jsx("div",{className:"flex items-center justify-end shrink-0",children:v})]})}a.__docgenInfo={description:`CardTitle - A flexible card header component
...
}`,...(j=(y=i.parameters)==null?void 0:y.docs)==null?void 0:j.source}}};var T,k,N;n.parameters={...n.parameters,docs:{...(T=n.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
...
}`,...(N=(k=n.parameters)==null?void 0:k.docs)==null?void 0:N.source}}};var I,W,P;o.parameters={...o.parameters,docs:{...(I=o.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
...
}`,...(E=(A=c.parameters)==null?void 0:A.docs)==null?void 0:E.source}}};var M,q,G;u.parameters={...u.parameters,docs:{...(M=u.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
...
}`,...(G=(q=u.parameters)==null?void 0:q.docs)==null?void 0:G.source}}};var D,z,_;d.parameters={...d.parameters,docs:{...(D=d.parameters)==null?void 0:D.docs,source:{originalSource:`{
...
}`,...(_=(z=d.parameters)==null?void 0:z.docs)==null?void 0:_.source}}};var R,$,H;m.parameters={...m.parameters,docs:{...(R=m.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => <div className="flex flex-col gap-4">
