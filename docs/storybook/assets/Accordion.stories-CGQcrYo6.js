import{r as i,j as e}from"./iframe-CsZHcOUf.js";import{t as A}from"./cn-CshvV4Tc.js";import{I as be}from"./IconChevronDown-CoAmE0_C.js";import"./preload-helper-C1FmrZbK.js";import"./createReactComponent-C2Lh4gVY.js";const ue=i.createContext(null),ge=()=>{const o=i.useContext(ue);if(!o)throw new Error("Accordion components must be used within an Accordion.Root");return o},he=i.createContext(null),Ae=()=>{const o=i.useContext(he);if(!o)throw new Error("Accordion.Trigger and Accordion.Panel must be used within an Accordion.Item");return o},R=i.forwardRef(({allowMultiple:o=!1,defaultExpanded:n=[],expanded:s,onChange:t,variant:a="default",children:l,className:m,...u},x)=>{const[c,g]=i.useState(n),p=s!==void 0,d=p?s:c,E=i.useCallback(v=>{let h;d.includes(v)?h=d.filter(fe=>fe!==v):o?h=[...d,v]:h=[v],p||g(h),t==null||t(h)},[d,o,p,t]),ve={default:"",bordered:"border border-[var(--color-border-default)] rounded-[var(--radius-md)]",separated:"space-y-2"};return e.jsx(ue.Provider,{value:{expandedItems:d,toggleItem:E,allowMultiple:o,variant:a},children:e.jsx("div",{ref:x,className:A(ve[a],m),...u,children:l})})});R.displayName="Accordion.Root";const k=i.forwardRef(({id:o,disabled:n=!1,children:s,className:t,...a},l)=>{const{expandedItems:m,variant:u}=ge(),x=i.useId(),c=m.includes(o),g=`accordion-trigger-${x}`,p=`accordion-panel-${x}`,d={default:"border-b border-[var(--color-border-subtle)] last:border-b-0",bordered:"border-b border-[var(--color-border-subtle)] last:border-b-0",separated:"border border-[var(--color-border-default)] rounded-[var(--radius-md)] overflow-hidden"};return e.jsx(he.Provider,{value:{itemId:o,isExpanded:c,triggerId:g,panelId:p},children:e.jsx("div",{ref:l,"data-state":c?"open":"closed","data-disabled":n||void 0,className:A(d[u],n&&"opacity-50",t),...a,children:s})})});k.displayName="Accordion.Item";const q=i.forwardRef(({children:o,iconPosition:n="right",hideIcon:s=!1,className:t,...a},l)=>{const{toggleItem:m,variant:u}=ge(),{itemId:x,isExpanded:c,triggerId:g,panelId:p}=Ae(),d=()=>{m(x)},E={default:"",bordered:c?"bg-[var(--color-surface-subtle)]":"",separated:c?"bg-[var(--color-surface-subtle)]":""};return e.jsxs("button",{ref:l,type:"button",id:g,"aria-expanded":c,"aria-controls":p,onClick:d,className:A("flex items-center justify-between w-full","px-4 py-3","text-body-md font-medium text-[var(--color-text-default)]","cursor-pointer","hover:bg-[var(--color-surface-subtle)]","transition-colors duration-[var(--duration-fast)]","focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--color-action-primary)]",E[u],n==="left"&&"flex-row-reverse",t),...a,children:[e.jsx("span",{className:"flex-1 text-left",children:o}),!s&&e.jsx(be,{size:12,stroke:1.5,className:A("shrink-0 text-[var(--color-text-muted)]","transition-transform duration-[var(--duration-fast)]",c&&"rotate-180",n==="left"&&"mr-2",n==="right"&&"ml-2")})]})});q.displayName="Accordion.Trigger";const M=i.forwardRef(({children:o,className:n,...s},t)=>{const{isExpanded:a,triggerId:l,panelId:m}=Ae();return a?e.jsx("div",{ref:t,id:m,role:"region","aria-labelledby":l,className:A("px-4 py-3 text-body-md text-[var(--color-text-default)]",n),...s,children:o}):null});M.displayName="Accordion.Panel";const r={Root:R,Item:k,Trigger:q,Panel:M};R.__docgenInfo={description:"",methods:[],displayName:"Accordion.Root",props:{allowMultiple:{required:!1,tsType:{name:"boolean"},description:"Allow multiple items to be expanded",defaultValue:{value:"false",computed:!1}},defaultExpanded:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:"Default expanded items",defaultValue:{value:"[]",computed:!1}},expanded:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:"Controlled expanded items"},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: string[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"string"}],raw:"string[]"},name:"expanded"}],return:{name:"void"}}},description:"Callback when expanded items change"},variant:{required:!1,tsType:{name:"union",raw:"'default' | 'bordered' | 'separated'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'bordered'"},{name:"literal",value:"'separated'"}]},description:"Visual variant",defaultValue:{value:"'default'",computed:!1}},children:{required:!0,tsType:{name:"ReactNode"},description:"Children (Accordion.Item)"}},composes:["HTMLAttributes"]};k.__docgenInfo={description:"",methods:[],displayName:"Accordion.Item",props:{id:{required:!0,tsType:{name:"string"},description:"Unique identifier for this item"},disabled:{required:!1,tsType:{name:"boolean"},description:"Disabled state",defaultValue:{value:"false",computed:!1}},children:{required:!0,tsType:{name:"ReactNode"},description:"Children"}},composes:["HTMLAttributes"]};q.__docgenInfo={description:"",methods:[],displayName:"Accordion.Trigger",props:{children:{required:!0,tsType:{name:"ReactNode"},description:"Trigger content"},iconPosition:{required:!1,tsType:{name:"union",raw:"'left' | 'right'",elements:[{name:"literal",value:"'left'"},{name:"literal",value:"'right'"}]},description:"Icon position",defaultValue:{value:"'right'",computed:!1}},hideIcon:{required:!1,tsType:{name:"boolean"},description:"Hide icon",defaultValue:{value:"false",computed:!1}}},composes:["HTMLAttributes"]};M.__docgenInfo={description:"",methods:[],displayName:"Accordion.Panel",props:{children:{required:!0,tsType:{name:"ReactNode"},description:"Panel content"}},composes:["HTMLAttributes"]};const Ne={title:"Components/Accordion",component:r.Root,parameters:{layout:"centered"}},f={render:()=>e.jsx("div",{className:"w-[400px]",children:e.jsxs(r.Root,{children:[e.jsxs(r.Item,{id:"item-1",children:[e.jsx(r.Trigger,{children:"What is a design system?"}),e.jsx(r.Panel,{children:"A design system is a collection of reusable components, guided by clear standards, that can be assembled together to build any number of applications."})]}),e.jsxs(r.Item,{id:"item-2",children:[e.jsx(r.Trigger,{children:"Why use a design system?"}),e.jsx(r.Panel,{children:"Design systems help teams build better products faster by providing a shared language and reusable components that ensure consistency across all touchpoints."})]}),e.jsxs(r.Item,{id:"item-3",children:[e.jsx(r.Trigger,{children:"How do I get started?"}),e.jsx(r.Panel,{children:"Start by installing the package and importing the components you need. Check out our documentation for detailed examples and usage guidelines."})]})]})})},b={render:()=>e.jsx("div",{className:"w-[400px]",children:e.jsxs(r.Root,{defaultExpanded:["item-1"],children:[e.jsxs(r.Item,{id:"item-1",children:[e.jsx(r.Trigger,{children:"Section 1 (Initially Expanded)"}),e.jsx(r.Panel,{children:"This section is expanded by default. Click to collapse it."})]}),e.jsxs(r.Item,{id:"item-2",children:[e.jsx(r.Trigger,{children:"Section 2"}),e.jsx(r.Panel,{children:"Content for section 2."})]}),e.jsxs(r.Item,{id:"item-3",children:[e.jsx(r.Trigger,{children:"Section 3"}),e.jsx(r.Panel,{children:"Content for section 3."})]})]})})},j={render:()=>e.jsx("div",{className:"w-[400px]",children:e.jsxs(r.Root,{allowMultiple:!0,defaultExpanded:["item-1","item-2"],children:[e.jsxs(r.Item,{id:"item-1",children:[e.jsx(r.Trigger,{children:"Section 1"}),e.jsx(r.Panel,{children:"Multiple sections can be open at the same time with allowMultiple prop."})]}),e.jsxs(r.Item,{id:"item-2",children:[e.jsx(r.Trigger,{children:"Section 2"}),e.jsx(r.Panel,{children:"This section is also open by default."})]}),e.jsxs(r.Item,{id:"item-3",children:[e.jsx(r.Trigger,{children:"Section 3"}),e.jsx(r.Panel,{children:"Click to expand this section without closing others."})]})]})})},I={render:()=>e.jsx("div",{className:"w-[400px]",children:e.jsxs(r.Root,{variant:"bordered",children:[e.jsxs(r.Item,{id:"item-1",children:[e.jsx(r.Trigger,{children:"Bordered Section 1"}),e.jsx(r.Panel,{children:"Content for bordered accordion section 1."})]}),e.jsxs(r.Item,{id:"item-2",children:[e.jsx(r.Trigger,{children:"Bordered Section 2"}),e.jsx(r.Panel,{children:"Content for bordered accordion section 2."})]}),e.jsxs(r.Item,{id:"item-3",children:[e.jsx(r.Trigger,{children:"Bordered Section 3"}),e.jsx(r.Panel,{children:"Content for bordered accordion section 3."})]})]})})},y={render:()=>e.jsx("div",{className:"w-[400px]",children:e.jsxs(r.Root,{variant:"separated",children:[e.jsxs(r.Item,{id:"item-1",children:[e.jsx(r.Trigger,{children:"Separated Section 1"}),e.jsx(r.Panel,{children:"Each section has its own border and spacing."})]}),e.jsxs(r.Item,{id:"item-2",children:[e.jsx(r.Trigger,{children:"Separated Section 2"}),e.jsx(r.Panel,{children:"Good for when sections need visual separation."})]}),e.jsxs(r.Item,{id:"item-3",children:[e.jsx(r.Trigger,{children:"Separated Section 3"}),e.jsx(r.Panel,{children:"Each item is individually styled."})]})]})})},T={render:()=>e.jsx("div",{className:"w-[400px]",children:e.jsxs(r.Root,{children:[e.jsxs(r.Item,{id:"item-1",children:[e.jsx(r.Trigger,{iconPosition:"left",children:"Icon on the left"}),e.jsx(r.Panel,{children:"The chevron icon is positioned on the left side."})]}),e.jsxs(r.Item,{id:"item-2",children:[e.jsx(r.Trigger,{iconPosition:"left",children:"Another section"}),e.jsx(r.Panel,{children:"Content goes here."})]})]})})},P={render:()=>e.jsx("div",{className:"w-[400px]",children:e.jsxs(r.Root,{children:[e.jsxs(r.Item,{id:"item-1",children:[e.jsx(r.Trigger,{hideIcon:!0,children:"No icon visible"}),e.jsx(r.Panel,{children:"This accordion has no chevron icon."})]}),e.jsxs(r.Item,{id:"item-2",children:[e.jsx(r.Trigger,{hideIcon:!0,children:"Another section"}),e.jsx(r.Panel,{children:"Content goes here."})]})]})})},N={render:()=>{const[o,n]=i.useState(["item-1"]);return e.jsxs("div",{className:"w-[400px] flex flex-col gap-[var(--primitive-spacing-4)]",children:[e.jsxs("div",{className:"flex gap-[var(--primitive-spacing-2)]",children:[e.jsx("button",{className:"px-3 py-1.5 text-body-sm bg-[var(--color-surface-muted)] rounded-[var(--primitive-radius-md)] hover:bg-[var(--color-surface-subtle)]",onClick:()=>n(["item-1","item-2","item-3"]),children:"Expand All"}),e.jsx("button",{className:"px-3 py-1.5 text-body-sm bg-[var(--color-surface-muted)] rounded-[var(--primitive-radius-md)] hover:bg-[var(--color-surface-subtle)]",onClick:()=>n([]),children:"Collapse All"})]}),e.jsxs(r.Root,{expanded:o,onChange:n,allowMultiple:!0,children:[e.jsxs(r.Item,{id:"item-1",children:[e.jsx(r.Trigger,{children:"Controlled Section 1"}),e.jsx(r.Panel,{children:"This accordion is controlled externally."})]}),e.jsxs(r.Item,{id:"item-2",children:[e.jsx(r.Trigger,{children:"Controlled Section 2"}),e.jsx(r.Panel,{children:"Use the buttons above to control all sections."})]}),e.jsxs(r.Item,{id:"item-3",children:[e.jsx(r.Trigger,{children:"Controlled Section 3"}),e.jsx(r.Panel,{children:"Or click individual sections to toggle them."})]})]}),e.jsxs("p",{className:"text-body-sm text-[var(--color-text-muted)]",children:["Expanded: ",o.length>0?o.join(", "):"None"]})]})}},w={render:()=>e.jsx("div",{className:"w-[400px]",children:e.jsxs(r.Root,{children:[e.jsxs(r.Item,{id:"item-1",children:[e.jsx(r.Trigger,{children:"Enabled Section"}),e.jsx(r.Panel,{children:"This section can be expanded and collapsed."})]}),e.jsxs(r.Item,{id:"item-2",disabled:!0,children:[e.jsx(r.Trigger,{children:"Disabled Section"}),e.jsx(r.Panel,{children:"This section cannot be interacted with."})]}),e.jsxs(r.Item,{id:"item-3",children:[e.jsx(r.Trigger,{children:"Another Enabled Section"}),e.jsx(r.Panel,{children:"Content for this section."})]})]})})},S={render:()=>e.jsxs("div",{className:"w-[500px]",children:[e.jsx("h2",{className:"text-heading-h5 text-[var(--color-text-default)] mb-[var(--primitive-spacing-4)]",children:"Frequently Asked Questions"}),e.jsxs(r.Root,{variant:"separated",children:[e.jsxs(r.Item,{id:"faq-1",children:[e.jsx(r.Trigger,{children:"How do I reset my password?"}),e.jsx(r.Panel,{children:e.jsx("p",{className:"text-[var(--color-text-muted)]",children:`Click on the "Forgot Password" link on the login page. Enter your email address and we'll send you instructions to reset your password.`})})]}),e.jsxs(r.Item,{id:"faq-2",children:[e.jsx(r.Trigger,{children:"What payment methods do you accept?"}),e.jsx(r.Panel,{children:e.jsx("p",{className:"text-[var(--color-text-muted)]",children:"We accept all major credit cards (Visa, MasterCard, American Express), PayPal, and bank transfers for enterprise customers."})})]}),e.jsxs(r.Item,{id:"faq-3",children:[e.jsx(r.Trigger,{children:"How can I contact support?"}),e.jsx(r.Panel,{children:e.jsx("p",{className:"text-[var(--color-text-muted)]",children:"You can reach our support team via email at support@example.com or through the live chat feature available in your dashboard 24/7."})})]}),e.jsxs(r.Item,{id:"faq-4",children:[e.jsx(r.Trigger,{children:"Is there a free trial available?"}),e.jsx(r.Panel,{children:e.jsx("p",{className:"text-[var(--color-text-muted)]",children:"Yes! We offer a 14-day free trial with full access to all features. No credit card required to start."})})]})]})]})},C={render:()=>e.jsxs("div",{className:"w-[400px]",children:[e.jsx("h3",{className:"text-heading-h6 text-[var(--color-text-default)] mb-[var(--primitive-spacing-3)]",children:"Settings"}),e.jsxs(r.Root,{variant:"bordered",allowMultiple:!0,children:[e.jsxs(r.Item,{id:"general",children:[e.jsx(r.Trigger,{children:"General"}),e.jsx(r.Panel,{children:e.jsxs("div",{className:"flex flex-col gap-[var(--primitive-spacing-3)]",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("span",{className:"text-body-md",children:"Language"}),e.jsx("span",{className:"text-body-md text-[var(--color-text-muted)]",children:"English"})]}),e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("span",{className:"text-body-md",children:"Timezone"}),e.jsx("span",{className:"text-body-md text-[var(--color-text-muted)]",children:"UTC+9"})]})]})})]}),e.jsxs(r.Item,{id:"notifications",children:[e.jsx(r.Trigger,{children:"Notifications"}),e.jsx(r.Panel,{children:e.jsxs("div",{className:"flex flex-col gap-[var(--primitive-spacing-3)]",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("span",{className:"text-body-md",children:"Email"}),e.jsx("span",{className:"text-body-md text-[var(--color-state-success)]",children:"Enabled"})]}),e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("span",{className:"text-body-md",children:"Push"}),e.jsx("span",{className:"text-body-md text-[var(--color-text-muted)]",children:"Disabled"})]})]})})]}),e.jsxs(r.Item,{id:"security",children:[e.jsx(r.Trigger,{children:"Security"}),e.jsx(r.Panel,{children:e.jsxs("div",{className:"flex flex-col gap-[var(--primitive-spacing-3)]",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("span",{className:"text-body-md",children:"Two-factor auth"}),e.jsx("span",{className:"text-body-md text-[var(--color-state-success)]",children:"Active"})]}),e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("span",{className:"text-body-md",children:"Session timeout"}),e.jsx("span",{className:"text-body-md text-[var(--color-text-muted)]",children:"30 minutes"})]})]})})]})]})]})};var D,H,W;f.parameters={...f.parameters,docs:{...(D=f.parameters)==null?void 0:D.docs,source:{originalSource:`{
...
}`,...(W=(H=f.parameters)==null?void 0:H.docs)==null?void 0:W.source}}};var _,V,B;b.parameters={...b.parameters,docs:{...(_=b.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => <div className="w-[400px]">
...
}`,...(B=(V=b.parameters)==null?void 0:V.docs)==null?void 0:B.source}}};var L,F,U;j.parameters={...j.parameters,docs:{...(L=j.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => <div className="w-[400px]">
...
}`,...(U=(F=j.parameters)==null?void 0:F.docs)==null?void 0:U.source}}};var G,Q,Y;I.parameters={...I.parameters,docs:{...(G=I.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => <div className="w-[400px]">
...
}`,...(Y=(Q=I.parameters)==null?void 0:Q.docs)==null?void 0:Y.source}}};var z,O,$;y.parameters={...y.parameters,docs:{...(z=y.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => <div className="w-[400px]">
...
}`,...($=(O=y.parameters)==null?void 0:O.docs)==null?void 0:$.source}}};var J,K,X;T.parameters={...T.parameters,docs:{...(J=T.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: () => <div className="w-[400px]">
      <Accordion.Root>
        <Accordion.Item id="item-1">
...
}`,...(re=(ee=P.parameters)==null?void 0:ee.docs)==null?void 0:re.source}}};var oe,ne,ie;N.parameters={...N.parameters,docs:{...(oe=N.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: () => {
    const [expanded, setExpanded] = useState<string[]>(['item-1']);
    return <div className="w-[400px] flex flex-col gap-[var(--primitive-spacing-4)]">
        <div className="flex gap-[var(--primitive-spacing-2)]">
          <button className="px-3 py-1.5 text-body-sm bg-[var(--color-surface-muted)] rounded-[var(--primitive-radius-md)] hover:bg-[var(--color-surface-subtle)]" onClick={() => setExpanded(['item-1', 'item-2', 'item-3'])}>
            Expand All
          </button>
          <button className="px-3 py-1.5 text-body-sm bg-[var(--color-surface-muted)] rounded-[var(--primitive-radius-md)] hover:bg-[var(--color-surface-subtle)]" onClick={() => setExpanded([])}>
            Collapse All
          </button>
        </div>
...
}`,...(ie=(ne=N.parameters)==null?void 0:ne.docs)==null?void 0:ie.source}}};var te,ce,de;w.parameters={...w.parameters,docs:{...(te=w.parameters)==null?void 0:te.docs,source:{originalSource:`{
  render: () => <div className="w-[400px]">
      <Accordion.Root>
        <Accordion.Item id="item-1">
