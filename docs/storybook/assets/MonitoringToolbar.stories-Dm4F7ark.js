import{r as o,j as e}from"./iframe-ko1KmZFS.js";import{I as ue}from"./IconX-CZRrzHtO.js";import{I as he}from"./IconCalendar-U1wDkSn5.js";import{D as pe}from"./DatePicker-BBHFt4KW.js";import{I as ge}from"./IconRefresh-Cp26whh3.js";import"./preload-helper-C1FmrZbK.js";import"./createReactComponent-B-brzlrB.js";import"./IconChevronLeft-C5r8jC9a.js";import"./IconChevronRight-BpkBDwLd.js";const ve=[{label:"30m",value:"30m"},{label:"1h",value:"1h"},{label:"6h",value:"6h"},{label:"12h",value:"12h"},{label:"24h",value:"24h"}],fe=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],R=t=>{if(!t)return"";const r=fe[t.getMonth()],l=t.getDate().toString().padStart(2,"0"),n=t.getFullYear();return`${r} ${l}, ${n}`},m=({timeRangeOptions:t=ve,timeRange:r,defaultTimeRange:l="30m",onTimeRangeChange:n,customPeriod:p,defaultCustomPeriod:K=null,onCustomPeriodChange:s,onRefresh:Q,showRefresh:Z=!0,maxDate:ee=new Date,minDate:ae,className:te=""})=>{const g=r!==void 0,v=p!==void 0,[ne,D]=o.useState(l),[oe,S]=o.useState(K),re=g?r:ne,i=v?p:oe,[f,c]=o.useState(!1),[d,b]=o.useState(null),[u,x]=o.useState(null),[M,h]=o.useState(!0),P=o.useRef(null);o.useEffect(()=>{const a=k=>{P.current&&!P.current.contains(k.target)&&c(!1)};return f&&document.addEventListener("mousedown",a),()=>document.removeEventListener("mousedown",a)},[f]);const le=a=>{g||D(a),v||S(null),n==null||n(a),s==null||s(null)},se=()=>{if(i)b(i.start),x(i.end);else{const a=new Date,k=new Date(a.getTime()-7*24*60*60*1e3);b(k),x(a)}h(!0),c(!0)},ie=()=>{if(d&&u){const a={start:d,end:u};v||S(a),g||D("custom"),s==null||s(a),n==null||n("custom"),c(!1)}},me=a=>{a.stopPropagation(),v||S(null),g||D(l),s==null||s(null),n==null||n(l)},ce=()=>{i&&(b(i.start),x(i.end)),h(!0),c(!0)},de=a=>{b(a.start),x(a.end),h(!a.start||!!a.end)},$=i!==null;return e.jsxs("div",{"data-figma-name":"[TDS] MonitoringToolbar",className:`monitoring-toolbar ${te}`,children:[e.jsx("div",{className:"monitoring-toolbar-segments",children:t.map(a=>e.jsx("button",{type:"button",className:`monitoring-toolbar-segment ${re===a.value&&!$?"monitoring-toolbar-segment-active":""}`,onClick:()=>le(a.value),children:a.label},a.value))}),e.jsxs("div",{className:"monitoring-toolbar-period",ref:P,children:[$?e.jsxs("div",{className:"monitoring-toolbar-period-tag",children:[e.jsxs("span",{className:"monitoring-toolbar-period-tag-text",onClick:ce,children:[R(i.start),e.jsx("span",{className:"monitoring-toolbar-period-tag-divider",children:"—"}),R(i.end)]}),e.jsx("button",{type:"button",className:"monitoring-toolbar-period-tag-close",onClick:me,"aria-label":"Clear custom period",children:e.jsx(ue,{size:12,stroke:2})})]}):e.jsxs("button",{type:"button",className:`monitoring-toolbar-period-btn ${f?"monitoring-toolbar-period-btn-active":""}`,onClick:se,children:[e.jsx(he,{size:12,stroke:2}),e.jsx("span",{children:"Period"})]}),f&&e.jsxs("div",{className:"monitoring-toolbar-dropdown",children:[e.jsxs("div",{className:"monitoring-toolbar-dropdown-header",children:[e.jsxs("div",{className:`monitoring-toolbar-date-box ${M?"monitoring-toolbar-date-box-active":""}`,onClick:()=>h(!0),children:[e.jsx("span",{className:"monitoring-toolbar-date-label",children:"START"}),e.jsx("span",{className:"monitoring-toolbar-date-value",children:R(d)})]}),e.jsx("div",{className:"monitoring-toolbar-date-separator",children:"~"}),e.jsxs("div",{className:`monitoring-toolbar-date-box ${M?"":"monitoring-toolbar-date-box-active"}`,onClick:()=>h(!1),children:[e.jsx("span",{className:"monitoring-toolbar-date-label",children:"END"}),e.jsx("span",{className:"monitoring-toolbar-date-value",children:R(u)})]})]}),e.jsx(pe,{mode:"range",rangeValue:{start:d,end:u},onRangeChange:de,maxDate:ee,minDate:ae}),e.jsxs("div",{className:"monitoring-toolbar-dropdown-actions",children:[e.jsx("button",{type:"button",className:"monitoring-toolbar-dropdown-cancel",onClick:()=>c(!1),children:"Cancel"}),e.jsx("button",{type:"button",className:"monitoring-toolbar-dropdown-apply",onClick:ie,disabled:!d||!u,children:"Apply"})]})]})]}),Z&&e.jsx("button",{type:"button",className:"monitoring-toolbar-refresh",onClick:Q,"aria-label":"Refresh",children:e.jsx(ge,{size:12,stroke:1.5})})]})};m.__docgenInfo={description:"",methods:[],displayName:"MonitoringToolbar",props:{timeRangeOptions:{required:!1,tsType:{name:"Array",elements:[{name:"TimeRangeOption"}],raw:"TimeRangeOption[]"},description:"Time range options to display",defaultValue:{value:`[
  { label: '30m', value: '30m' },
  { label: '1h', value: '1h' },
  { label: '6h', value: '6h' },
  { label: '12h', value: '12h' },
...
/>
\`\`\`
        `}}},argTypes:{showRefresh:{control:"boolean",description:"새로고침 버튼 표시",table:{defaultValue:{summary:"true"}}},defaultTimeRange:{control:"select",options:["30m","1h","3h","6h","12h","24h"],description:"기본 시간 범위",table:{defaultValue:{summary:"30m"}}}}},T={render:()=>e.jsx(m,{onTimeRangeChange:t=>console.log("Time range:",t),onRefresh:()=>console.log("Refresh")})},w={render:function(){const[r,l]=o.useState("1h");return e.jsxs("div",{className:"flex flex-col gap-[var(--primitive-spacing-4)]",children:[e.jsx(m,{timeRange:r,onTimeRangeChange:l,onRefresh:()=>console.log("Refresh")}),e.jsxs("p",{className:"text-body-md text-[var(--color-text-muted)]",children:["Selected: ",r]})]})}},y={render:()=>e.jsx(m,{showRefresh:!1,onTimeRangeChange:t=>console.log("Time range:",t)})},j={render:()=>e.jsx(m,{timeRangeOptions:[{label:"15m",value:"30m"},{label:"30m",value:"30m"},{label:"1h",value:"1h"},{label:"2h",value:"3h"},{label:"4h",value:"6h"}],onTimeRangeChange:t=>console.log("Time range:",t),onRefresh:()=>console.log("Refresh")})},N={render:function(){const[r,l]=o.useState("custom"),[n,p]=o.useState({start:new Date(Date.now()-7*24*60*60*1e3),end:new Date});return e.jsxs("div",{className:"flex flex-col gap-[var(--primitive-spacing-4)]",children:[e.jsx(m,{timeRange:r,onTimeRangeChange:l,customPeriod:n,onCustomPeriodChange:p,onRefresh:()=>console.log("Refresh")}),e.jsx("p",{className:"text-body-md text-[var(--color-text-muted)]",children:n?`Custom: ${n.start.toLocaleDateString()} - ${n.end.toLocaleDateString()}`:`Selected: ${r}`})]})}},C={render:()=>e.jsxs("div",{className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-[var(--primitive-radius-lg)] p-[var(--primitive-spacing-4)]",children:[e.jsxs("div",{className:"flex items-center justify-between mb-[var(--primitive-spacing-4)]",children:[e.jsx("h2",{className:"text-heading-h4",children:"CPU Usage"}),e.jsx(m,{defaultTimeRange:"1h",onTimeRangeChange:t=>console.log("Time range:",t),onRefresh:()=>console.log("Refresh")})]}),e.jsx("div",{className:"h-[200px] bg-[var(--color-surface-subtle)] rounded-[var(--primitive-radius-lg)] flex items-center justify-center text-[var(--color-text-muted)]",children:"Chart Placeholder"})]})};var O,q,I;T.parameters={...T.parameters,docs:{...(O=T.parameters)==null?void 0:O.docs,source:{originalSource:`{
