import{r,j as e}from"./iframe-CsZHcOUf.js";import{I as ue}from"./IconX-DSnl1fNg.js";import{I as he}from"./IconCalendar-6fG57P4g.js";import{D as pe}from"./DatePicker-snvrst_G.js";import{I as ge}from"./IconRefresh-Bbwdyjts.js";import"./preload-helper-C1FmrZbK.js";import"./createReactComponent-C2Lh4gVY.js";import"./IconChevronLeft-nzKjfkZz.js";import"./IconChevronRight-CHyVK_ct.js";const fe=[{label:"30m",value:"30m"},{label:"1h",value:"1h"},{label:"6h",value:"6h"},{label:"12h",value:"12h"},{label:"24h",value:"24h"}],R=a=>{if(!a)return"";const n=a.getFullYear(),s=(a.getMonth()+1).toString().padStart(2,"0"),o=a.getDate().toString().padStart(2,"0");return`${n}.${s}.${o}`},m=({timeRangeOptions:a=fe,timeRange:n,defaultTimeRange:s="30m",onTimeRangeChange:o,customPeriod:p,defaultCustomPeriod:K=null,onCustomPeriodChange:l,onRefresh:Q,showRefresh:Z=!0,maxDate:ee=new Date,minDate:te,className:ae=""})=>{const g=n!==void 0,f=p!==void 0,[oe,N]=r.useState(s),[re,D]=r.useState(K),ne=g?n:oe,i=f?p:re,[v,c]=r.useState(!1),[d,b]=r.useState(null),[u,x]=r.useState(null),[M,h]=r.useState(!0),P=r.useRef(null);r.useEffect(()=>{const t=k=>{P.current&&!P.current.contains(k.target)&&c(!1)};return v&&document.addEventListener("mousedown",t),()=>document.removeEventListener("mousedown",t)},[v]);const se=t=>{g||N(t),f||D(null),o==null||o(t),l==null||l(null)},le=()=>{if(i)b(i.start),x(i.end);else{const t=new Date,k=new Date(t.getTime()-7*24*60*60*1e3);b(k),x(t)}h(!0),c(!0)},ie=()=>{if(d&&u){const t={start:d,end:u};f||D(t),g||N("custom"),l==null||l(t),o==null||o("custom"),c(!1)}},me=t=>{t.stopPropagation(),f||D(null),g||N(s),l==null||l(null),o==null||o(s)},ce=()=>{i&&(b(i.start),x(i.end)),h(!0),c(!0)},de=t=>{b(t.start),x(t.end),h(!t.start||!!t.end)},$=i!==null;return e.jsxs("div",{className:`monitoring-toolbar ${ae}`,children:[e.jsx("div",{className:"monitoring-toolbar-segments",children:a.map(t=>e.jsx("button",{type:"button",className:`monitoring-toolbar-segment ${ne===t.value&&!$?"monitoring-toolbar-segment-active":""}`,onClick:()=>se(t.value),children:t.label},t.value))}),e.jsxs("div",{className:"monitoring-toolbar-period",ref:P,children:[$?e.jsxs("div",{className:"monitoring-toolbar-period-tag",children:[e.jsxs("span",{className:"monitoring-toolbar-period-tag-text",onClick:ce,children:[R(i.start),e.jsx("span",{className:"monitoring-toolbar-period-tag-divider",children:"—"}),R(i.end)]}),e.jsx("button",{type:"button",className:"monitoring-toolbar-period-tag-close",onClick:me,"aria-label":"Clear custom period",children:e.jsx(ue,{size:12,stroke:2})})]}):e.jsxs("button",{type:"button",className:`monitoring-toolbar-period-btn ${v?"monitoring-toolbar-period-btn-active":""}`,onClick:le,children:[e.jsx(he,{size:12,stroke:2}),e.jsx("span",{children:"Period"})]}),v&&e.jsxs("div",{className:"monitoring-toolbar-dropdown",children:[e.jsxs("div",{className:"monitoring-toolbar-dropdown-header",children:[e.jsxs("div",{className:`monitoring-toolbar-date-box ${M?"monitoring-toolbar-date-box-active":""}`,onClick:()=>h(!0),children:[e.jsx("span",{className:"monitoring-toolbar-date-label",children:"START"}),e.jsx("span",{className:"monitoring-toolbar-date-value",children:R(d)})]}),e.jsx("div",{className:"monitoring-toolbar-date-separator",children:"~"}),e.jsxs("div",{className:`monitoring-toolbar-date-box ${M?"":"monitoring-toolbar-date-box-active"}`,onClick:()=>h(!1),children:[e.jsx("span",{className:"monitoring-toolbar-date-label",children:"END"}),e.jsx("span",{className:"monitoring-toolbar-date-value",children:R(u)})]})]}),e.jsx(pe,{mode:"range",rangeValue:{start:d,end:u},onRangeChange:de,maxDate:ee,minDate:te}),e.jsxs("div",{className:"monitoring-toolbar-dropdown-actions",children:[e.jsx("button",{type:"button",className:"monitoring-toolbar-dropdown-cancel",onClick:()=>c(!1),children:"Cancel"}),e.jsx("button",{type:"button",className:"monitoring-toolbar-dropdown-apply",onClick:ie,disabled:!d||!u,children:"Apply"})]})]})]}),Z&&e.jsx("button",{type:"button",className:"monitoring-toolbar-refresh",onClick:Q,"aria-label":"Refresh",children:e.jsx(ge,{size:12,stroke:1.5})})]})};m.__docgenInfo={description:"",methods:[],displayName:"MonitoringToolbar",props:{timeRangeOptions:{required:!1,tsType:{name:"Array",elements:[{name:"TimeRangeOption"}],raw:"TimeRangeOption[]"},description:"Time range options to display",defaultValue:{value:`[
  { label: '30m', value: '30m' },
  { label: '1h', value: '1h' },
  { label: '6h', value: '6h' },
  { label: '12h', value: '12h' },
...
/>
\`\`\`
        `}}},argTypes:{showRefresh:{control:"boolean",description:"새로고침 버튼 표시",table:{defaultValue:{summary:"true"}}},defaultTimeRange:{control:"select",options:["30m","1h","3h","6h","12h","24h"],description:"기본 시간 범위",table:{defaultValue:{summary:"30m"}}}}},T={render:()=>e.jsx(m,{onTimeRangeChange:a=>console.log("Time range:",a),onRefresh:()=>console.log("Refresh")})},w={render:function(){const[n,s]=r.useState("1h");return e.jsxs("div",{className:"flex flex-col gap-[var(--primitive-spacing-4)]",children:[e.jsx(m,{timeRange:n,onTimeRangeChange:s,onRefresh:()=>console.log("Refresh")}),e.jsxs("p",{className:"text-body-md text-[var(--color-text-muted)]",children:["Selected: ",n]})]})}},y={render:()=>e.jsx(m,{showRefresh:!1,onTimeRangeChange:a=>console.log("Time range:",a)})},j={render:()=>e.jsx(m,{timeRangeOptions:[{label:"15m",value:"30m"},{label:"30m",value:"30m"},{label:"1h",value:"1h"},{label:"2h",value:"3h"},{label:"4h",value:"6h"}],onTimeRangeChange:a=>console.log("Time range:",a),onRefresh:()=>console.log("Refresh")})},C={render:function(){const[n,s]=r.useState("custom"),[o,p]=r.useState({start:new Date(Date.now()-7*24*60*60*1e3),end:new Date});return e.jsxs("div",{className:"flex flex-col gap-[var(--primitive-spacing-4)]",children:[e.jsx(m,{timeRange:n,onTimeRangeChange:s,customPeriod:o,onCustomPeriodChange:p,onRefresh:()=>console.log("Refresh")}),e.jsx("p",{className:"text-body-md text-[var(--color-text-muted)]",children:o?`Custom: ${o.start.toLocaleDateString()} - ${o.end.toLocaleDateString()}`:`Selected: ${n}`})]})}},S={render:()=>e.jsxs("div",{className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-[var(--primitive-radius-lg)] p-[var(--primitive-spacing-4)]",children:[e.jsxs("div",{className:"flex items-center justify-between mb-[var(--primitive-spacing-4)]",children:[e.jsx("h2",{className:"text-heading-h4",children:"CPU Usage"}),e.jsx(m,{defaultTimeRange:"1h",onTimeRangeChange:a=>console.log("Time range:",a),onRefresh:()=>console.log("Refresh")})]}),e.jsx("div",{className:"h-[200px] bg-[var(--color-surface-subtle)] rounded-[var(--primitive-radius-lg)] flex items-center justify-center text-[var(--color-text-muted)]",children:"Chart Placeholder"})]})};var q,I,O;T.parameters={...T.parameters,docs:{...(q=T.parameters)==null?void 0:q.docs,source:{originalSource:`{
...
}`,...(L=(E=w.parameters)==null?void 0:E.docs)==null?void 0:L.source}}};var A,U,W;y.parameters={...y.parameters,docs:{...(A=y.parameters)==null?void 0:A.docs,source:{originalSource:`{
...
}`,...(F=(z=j.parameters)==null?void 0:z.docs)==null?void 0:F.source}}};var X,Y,B;C.parameters={...C.parameters,docs:{...(X=C.parameters)==null?void 0:X.docs,source:{originalSource:`{
...
}`,...(J=(H=S.parameters)==null?void 0:H.docs)==null?void 0:J.source}}};const Ne=["Default","Controlled","WithoutRefresh","CustomOptions","WithCustomPeriod","InDashboardContext"];export{w as Controlled,j as CustomOptions,T as Default,S as InDashboardContext,C as WithCustomPeriod,y as WithoutRefresh,Ne as __namedExportsOrder,Se as default};
