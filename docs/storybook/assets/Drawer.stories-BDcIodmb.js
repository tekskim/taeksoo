...
\`\`\`
...
}`,...(R=(P=m.parameters)==null?void 0:P.docs)==null?void 0:R.source}}};var U,M,z;p.parameters={...p.parameters,docs:{...(U=p.parameters)==null?void 0:U.docs,source:{originalSource:`{
...
}`,...(z=(M=p.parameters)==null?void 0:M.docs)==null?void 0:z.source}}};var _,q,G;f.parameters={...f.parameters,docs:{...(_=f.parameters)==null?void 0:_.docs,source:{originalSource:`{
  ...
  render: function ScrollableDrawer() {
    ...
    return <>
        ...
        <Drawer isOpen={isOpen} onClose={() => setIsOpen(false)} title="Long Content" footer={<Button onClick={() => setIsOpen(false)} fullWidth>Close</Button>}>
          <div className="flex flex-col gap-4">
            {Array.from({
            length: 20
