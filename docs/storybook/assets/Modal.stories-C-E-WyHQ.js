import{r as a,j as e}from"./iframe-CzLct1Ct.js";import{r as oe}from"./index-CZa75-BM.js";import{t as w}from"./cn-BMXv33oC.js";import{u as re}from"./useFocusTrap-noI1xz6p.js";import{B as o}from"./Button-kAA1kjx0.js";import{F as B}from"./FormField-DsPb4fJ_.js";import{I as E}from"./Input-b2yaocsu.js";import"./preload-helper-C1FmrZbK.js";function N(s){const n=a.useId();return s?`${s}-${n}`:n}function u({isOpen:s,onClose:n,title:t,description:r,children:i,showCloseButton:p=!1,closeOnBackdropClick:l=!0,closeOnEscape:f=!0,className:x,...g}){const[d,C]=a.useState(s),[S,M]=a.useState(!1),k=N("modal-title"),T=N("modal-desc"),ee=re(s);a.useEffect(()=>{if(s)C(!0),requestAnimationFrame(()=>{requestAnimationFrame(()=>{M(!0)})});else{M(!1);const c=setTimeout(()=>{C(!1)},200);return()=>clearTimeout(c)}},[s]),a.useEffect(()=>{if(!s||!f)return;const c=ae=>{ae.key==="Escape"&&n()};return document.addEventListener("keydown",c),()=>document.removeEventListener("keydown",c)},[s,f,n]),a.useEffect(()=>(s?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[s]);const te=a.useCallback(()=>{l&&n()},[l,n]);if(!d)return null;const ne=w("fixed inset-0 z-[var(--z-modal)]","bg-black/60","flex items-center justify-center","transition-opacity duration-200 ease-out",S?"opacity-100":"opacity-0"),se=w("bg-[var(--color-surface-default)]","border border-[var(--color-border-default)]","rounded-[var(--radius-xl)]","shadow-[0px_0px_4px_0px_rgba(0,0,0,0.1)]","p-6","flex flex-col gap-4","transition-all duration-200 ease-out",S?"opacity-100 scale-100":"opacity-0 scale-95","w-[344px]",x);return oe.createPortal(e.jsx("div",{className:ne,onClick:te,children:e.jsxs("div",{"data-figma-name":"[TDS] Overlay",...g,ref:ee,className:se,onClick:c=>c.stopPropagation(),role:"dialog","aria-modal":"true","aria-labelledby":k,"aria-describedby":r?T:void 0,children:[e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("h2",{id:k,className:"text-heading-h5 text-[var(--color-text-default)]",children:t}),r&&e.jsx("p",{id:T,className:"text-body-md text-[var(--color-text-subtle)]",children:r})]}),i]})}),document.body)}function m({isOpen:s,onClose:n,onConfirm:t,title:r,description:i,confirmText:p="Confirm",cancelText:l="Cancel",confirmVariant:f="primary",infoLabel:x,infoValue:g,isLoading:d=!1,...C}){return e.jsxs(u,{isOpen:s,onClose:n,title:r,description:i,...C,children:[x&&g&&e.jsxs("div",{className:"bg-[var(--color-surface-subtle)] rounded-[var(--radius-md)] px-4 py-3 flex flex-col gap-1.5",children:[e.jsx("span",{className:"text-label-sm text-[var(--color-text-subtle)]",children:x}),e.jsx("span",{className:"text-body-md text-[var(--color-text-default)]",children:g})]}),e.jsxs("div",{className:"flex gap-2 w-full",children:[e.jsx(o,{variant:"outline",size:"md",onClick:n,disabled:d,className:"flex-1",children:l}),e.jsx(o,{variant:f,size:"md",onClick:t,disabled:d,className:"flex-1",children:d?"Processing...":p})]})]})}m.__docgenInfo={description:"",methods:[],displayName:"ConfirmModal",props:{confirmText:{required:!1,tsType:{name:"string"},description:"Confirm button text",defaultValue:{value:"'Confirm'",computed:!1}},cancelText:{required:!1,tsType:{name:"string"},description:"Cancel button text",defaultValue:{value:"'Cancel'",computed:!1}},confirmVariant:{required:!1,tsType:{name:"union",raw:"'primary' | 'danger' | 'warning'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'danger'"},{name:"literal",value:"'warning'"}]},description:"Confirm button variant",defaultValue:{value:"'primary'",computed:!1}},onConfirm:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Callback when confirmed"},infoLabel:{required:!1,tsType:{name:"string"},description:"Info box content"},infoValue:{required:!1,tsType:{name:"string"},description:"Info box value"},isLoading:{required:!1,tsType:{name:"boolean"},description:"Loading state",defaultValue:{value:"false",computed:!1}}},composes:["Omit"]};const xe={title:"Components/Modal",component:u,tags:["autodocs"],parameters:{docs:{description:{component:`
## Modal 컴포넌트
