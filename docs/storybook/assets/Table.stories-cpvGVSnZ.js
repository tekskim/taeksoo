import{r as y,j as e}from"./iframe-D96dQDLz.js";import{C as W}from"./Checkbox-DjL_E0Wu.js";import{c as ye}from"./createReactComponent-Dvr8b43U.js";import{I as ze}from"./IconChevronUp-ZtmF7E_l.js";import{I as Ue}from"./IconChevronDown-B3KfbvkI.js";import{B as h}from"./Button-BBWIKsKq.js";import{B as he}from"./Badge-Dax5U36t.js";import{I as Ee}from"./IconEdit-DoLVRIuq.js";import{I as $e}from"./IconTrash-Dlq7Hary.js";import"./preload-helper-C1FmrZbK.js";import"./bundle-mjs-BZSatpsL.js";import"./IconMinus-hJv9kC-c.js";import"./IconCheck-KE79Jf-a.js";/**
 ...
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const De=[["path",{d:"M8 9l4 -4l4 4",key:"svg-0"}],["path",{d:"M16 15l-4 4l-4 -4",key:"svg-1"}]],_e=ye("outline","selector","Selector",De);function c({columns:l,data:s,rowKey:a,selectable:d=!1,selectedKeys:i=[],onSelectionChange:n,hideSelectAll:z=!1,stickyHeader:U=!1,maxHeight:v,onRowClick:E,emptyMessage:fe="No data",className:ve="",rowHeight:I}){const[g,D]=y.useState(null),[x,$]=y.useState(null),_=y.useCallback(t=>typeof a=="function"?a(t):String(t[a]),[a]),we=t=>{g===t?x==="asc"?$("desc"):x==="desc"&&(D(null),$(null)):(D(t),$("asc"))},p=y.useMemo(()=>!g||!x?s:[...s].sort((t,r)=>{const m=t[g],u=r[g];if(m===u)return 0;if(m==null)return 1;if(u==null)return-1;const o=m<u?-1:1;return x==="asc"?o:-o}),[s,g,x]),ke=t=>{i.includes(t)?n==null||n(i.filter(r=>r!==t)):n==null||n([...i,t])},je=()=>{const t=p.map(_);i.length===p.length&&p.length>0?n==null||n([]):n==null||n(t)},Ce=p.length>0&&i.length===p.length,Ne=i.length>0&&i.length<p.length,Te=t=>g!==t?e.jsx(_e,{size:14,stroke:1,className:"text-[var(--color-text-disabled)]"}):x==="asc"?e.jsx(ze,{size:14,stroke:1,className:"text-[var(--color-action-primary)]"}):e.jsx(Ue,{size:14,stroke:1,className:"text-[var(--color-action-primary)]"}),Se=U||!!v,V=t=>{const r={};return t.width?(r.width=t.width,r.flexShrink=0,r.flexGrow=0):(r.flex=t.flex??1,r.minWidth=0),t.minWidth&&(r.minWidth=t.minWidth),t.maxWidth&&(r.maxWidth=t.maxWidth),r};return e.jsx("div",{className:`flex flex-col gap-[var(--table-row-gap)] ${ve}`,style:I?{"--table-row-height":I}:void 0,children:e.jsx("div",{className:`overflow-x-auto ${v?"overflow-y-auto":""}`,style:{...v?{maxHeight:v}:{}},children:e.jsxs("div",{className:"min-w-fit w-full",children:[e.jsxs("div",{className:`
            flex items-stretch
          ...
          `,children:[d&&e.jsx("div",{className:`
              ...
              `,children:!z&&e.jsx(W,{checked:Ce,indeterminate:Ne,onChange:je,"aria-label":"Select all rows"})}),l.map((t,r)=>{const u=r===0?d:!0;return e.jsx("div",{className:`
                  flex items-center
                  px-[var(--table-cell-padding-x)]
                  py-[var(--table-header-padding-y)]
                ...
                `,style:V(t),onClick:t.sortable?()=>we(t.key):void 0,title:t.label,children:t.headerRender?t.headerRender():e.jsxs("div",{className:`
                    ...
                    `,children:[e.jsx("span",{className:"whitespace-nowrap truncate",title:t.label,children:t.label}),t.sortable&&e.jsx("span",{className:"flex-shrink-0",children:Te(t.key)})]})},t.key)})]}),e.jsx("div",{className:"flex flex-col gap-[var(--table-row-gap)] mt-[var(--table-row-gap)] w-full",children:p.length===0?e.jsx("div",{className:`
                px-[var(--table-cell-padding-x)]
              ...
              `,children:fe}):p.map((t,r)=>{const m=_(t),u=i.includes(m);return e.jsxs("div",{className:`
                    flex items-stretch
                    ...
                    ${E?"cursor-pointer":""}
                  `,onClick:E?()=>E(t,r):void 0,children:[d&&e.jsx("div",{className:`
                        shrink-0
                        flex items-center
                        w-[var(--table-checkbox-width)]
                        px-[var(--table-cell-padding-x)]
                        py-[var(--table-cell-padding-y)]
                      `,onClick:o=>o.stopPropagation(),children:e.jsx(W,{checked:u,onChange:()=>ke(m),"aria-label":`Select row ${r+1}`})}),l.map((o,Ae)=>{const Ke=Ae===0?d:!0,B=t[o.key],Re=typeof B=="string"||typeof B=="number"?String(B):void 0;return e.jsx("div",{className:`
                          flex items-center
                          px-[var(--table-cell-padding-x)]
                          py-[var(--table-cell-padding-y)]
                          text-[length:var(--table-font-size)]
...
/>
\`\`\`
        `}}}},w={render:()=>e.jsx(c,{columns:f,data:b,rowKey:"id"})},k={render:()=>{const l=[{key:"name",label:"Name",width:"180px"},{key:"email",label:"Email"},{key:"role",label:"Role",width:"100px"},{key:"status",label:"Status",width:"100px",align:"center",render:s=>{const d={active:{theme:"green",label:"Active"},inactive:{theme:"gray",label:"Inactive"},pending:{theme:"yellow",label:"Pending"}}[s];return e.jsx(he,{theme:d.theme,type:"subtle",size:"sm",children:d.label})}}];return e.jsx(c,{columns:l,data:b,rowKey:"id"})}},j={render:function(){const[s,a]=y.useState([]);return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx(c,{columns:f,data:b,rowKey:"id",selectable:!0,selectedKeys:s,onSelectionChange:a}),e.jsxs("p",{className:"text-sm text-[var(--color-text-muted)]",children:["Selected: ",s.length>0?s.join(", "):"None"]})]})}},C={render:()=>{const l=[{key:"name",label:"Name",sortable:!0},{key:"email",label:"Email",sortable:!0},{key:"role",label:"Role",sortable:!0},{key:"createdAt",label:"Created At",sortable:!0,width:"120px"}];return e.jsx(c,{columns:l,data:b,rowKey:"id"})}},N={render:()=>{const l=[{key:"name",label:"Name"},{key:"email",label:"Email"},{key:"role",label:"Role",width:"100px"},{key:"actions",label:"",width:"100px",align:"right",render:(s,a)=>e.jsxs("div",{className:"flex items-center justify-end gap-1",children:[e.jsx(h,{variant:"ghost",size:"sm",icon:e.jsx(Ee,{size:14}),"aria-label":`Edit ${a.name}`}),e.jsx(h,{variant:"ghost",size:"sm",icon:e.jsx($e,{size:14}),"aria-label":`Delete ${a.name}`})]})}];return e.jsx(c,{columns:l,data:b,rowKey:"id"})}},T={render:()=>{const l=s=>{alert(`Clicked on: ${s.name}`)};return e.jsx(c,{columns:f,data:b,rowKey:"id",onRowClick:l})}},S={render:()=>e.jsx(c,{columns:f,data:[],rowKey:"id",emptyMessage:"No users found. Create your first user to get started."})},A={render:()=>{const l=Array.from({length:20},(s,a)=>({id:String(a+1),name:`User ${a+1}`,email:`user${a+1}@example.com`,role:a%3===0?"Admin":a%3===1?"Editor":"Viewer",status:a%3===0?"active":a%3===1?"inactive":"pending",createdAt:"2024-01-01"}));return e.jsx(c,{columns:f,data:l,rowKey:"id",maxHeight:"300px",stickyHeader:!0})}},K={render:()=>{const l=[{key:"name",label:"Name (Left)",align:"left"},{key:"email",label:"Email (Center)",align:"center"},{key:"role",label:"Role (Right)",align:"right"}];return e.jsx(c,{columns:l,data:b,rowKey:"id"})}},R={render:function(){const[s,a]=y.useState([]),d=[{key:"name",label:"User",width:"200px",sortable:!0,render:(i,n)=>e.jsxs("div",{className:"flex flex-col",children:[e.jsx("span",{className:"font-medium",children:i}),e.jsx("span",{className:"text-[11px] text-[var(--color-text-muted)]",children:n.email})]})},{key:"role",label:"Role",width:"100px",sortable:!0},{key:"status",label:"Status",width:"100px",align:"center",render:i=>{const n={active:{theme:"green",label:"Active"},inactive:{theme:"gray",label:"Inactive"},pending:{theme:"yellow",label:"Pending"}},{theme:z,label:U}=n[i];return e.jsx(he,{theme:z,type:"subtle",size:"sm",dot:!0,children:U})}},{key:"createdAt",label:"Created",width:"120px",sortable:!0,render:i=>e.jsx("span",{className:"text-[var(--color-text-muted)]",children:i})},{key:"actions",label:"",width:"48px",align:"center",render:()=>e.jsx(h,{variant:"ghost",size:"sm",icon:e.jsx(Ie,{size:14}),"aria-label":"More actions"})}];return e.jsxs("div",{className:"flex flex-col gap-4",children:[s.length>0&&e.jsxs("div",{className:"flex items-center gap-2 p-2 bg-[var(--color-surface-subtle)] rounded",children:[e.jsxs("span",{className:"text-sm",children:[s.length," selected"]}),e.jsx(h,{variant:"ghost",size:"sm",onClick:()=>a([]),children:"Clear"}),e.jsx(h,{variant:"danger",size:"sm",children:"Delete Selected"})]}),e.jsx(c,{columns:d,data:b,rowKey:"id",selectable:!0,selectedKeys:s,onSelectionChange:a})]})}};var q,M,H;w.parameters={...w.parameters,docs:{...(q=w.parameters)==null?void 0:q.docs,source:{originalSource:`{
...
}`,...(L=(F=k.parameters)==null?void 0:F.docs)==null?void 0:L.source}}};var J,G,O;j.parameters={...j.parameters,docs:{...(J=j.parameters)==null?void 0:J.docs,source:{originalSource:`{
...
}`,...(O=(G=j.parameters)==null?void 0:G.docs)==null?void 0:O.source}}};var Q,X,Y;C.parameters={...C.parameters,docs:{...(Q=C.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  render: () => {
