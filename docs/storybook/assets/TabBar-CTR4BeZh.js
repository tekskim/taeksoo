import{r as u,j as t}from"./iframe-IHmg4wqj.js";import{I as C}from"./IconX-Cqqx2THU.js";import{I as E}from"./IconPlus-CUC_CCwj.js";import{I as O}from"./IconMinus-ChFWmO2b.js";import{I as V}from"./IconSquare-Cb8_D0L-.js";const D=u.createContext(!1);D.Provider;function L(){return u.useContext(D)}const P=({tabs:m,activeTab:p,onTabChange:T,onTabClose:o,onTabAdd:g,onTabReorder:l,showAddButton:h=!0,showWindowControls:f=!0,showBottomBorder:I=!0,onMinimize:j,onMaximize:z,onWindowClose:w,className:a=""})=>{const s=L(),i=f&&!s,[n,v]=u.useState(null),[k,y]=u.useState(null),N=e=>{T(e)},q=(e,r)=>{e.stopPropagation(),o==null||o(r)},S=(e,r)=>{v(r),e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",r),requestAnimationFrame(()=>{e.target.style.opacity="0.5"})},$=e=>{v(null),y(null),e.target.style.opacity="1"},A=(e,r)=>{e.preventDefault(),e.dataTransfer.dropEffect="move",n&&n!==r&&y(r)},B=()=>{y(null)},M=(e,r)=>{if(e.preventDefault(),y(null),!n||!l)return;const c=m.findIndex(x=>x.id===n),b=m.findIndex(x=>x.id===r);c!==-1&&b!==-1&&c!==b&&l(c,b),v(null)};return t.jsxs("div",{className:`
        relative
        flex items-center
        w-full
        h-[var(--tabbar-height)]
      ...
      `,children:[t.jsx("div",{className:`
          ...
          h-full
          min-w-0
        `,children:m.map(e=>{const r=e.id===p,c=e.label??e.title??"",b=e.fixed?!1:e.closable!==!1,x=n===e.id,W=k===e.id;return t.jsxs("div",{"data-tab-id":e.id,onClick:()=>N(e.id),draggable:!!l,onDragStart:d=>S(d,e.id),onDragEnd:$,onDragOver:d=>A(d,e.id),onDragLeave:B,onDrop:d=>M(d,e.id),className:`
                group
                relative
                flex items-center
                h-full
              ...
              `,children:[r&&t.jsx("div",{className:"absolute bottom-0 left-0 right-0 h-[2px] bg-[var(--color-action-primary)] z-20"}),e.icon&&t.jsx("span",{className:`
                  shrink-0
                ...
                `,children:c}),b&&o&&t.jsx("button",{type:"button",onClick:d=>q(d,e.id),className:`
                  ...
                  `,"aria-label":`Close ${c}`,children:t.jsx(C,{size:12,stroke:1})})]},e.id)})}),h&&g&&t.jsx("button",{type:"button",onClick:g,className:`
            shrink-0
            flex items-center justify-center
