import{j as e}from"./iframe-B4qQhCO6.js";import{S as t}from"./SectionCard-xf8wg-Dr.js";import{B as S}from"./Button-BTL-mhRW.js";import{I as g}from"./IconEdit-DTriKS-t.js";import{I as Q}from"./IconCheck-BgbQWatL.js";import{I as N}from"./IconProgress-DbKHTUrD.js";import{I as X}from"./IconMinus-rv-rEP72.js";import{H as Y,V as v}from"./Stack-Dcn3-Ul-.js";import"./preload-helper-C1FmrZbK.js";import"./bundle-mjs-BZSatpsL.js";import"./chunk-JZWAC4HX-DCwoNyDI.js";import"./createReactComponent-Bds5dDb0.js";function r({status:a}){return a==="done"?e.jsx("div",{className:"w-4 h-4 shrink-0 rounded-full bg-[var(--color-state-success)] flex items-center justify-center",children:e.jsx(Q,{size:10,stroke:2.5,className:"text-white"})}):a==="active"?e.jsx("div",{className:"w-4 h-4 shrink-0 flex items-center justify-center",children:e.jsx(N,{size:16,stroke:1.5,className:"text-[var(--color-text-subtle)] animate-spin"})}):a==="writing"?e.jsx("div",{className:"w-4 h-4 shrink-0 flex items-center justify-center",children:e.jsx(N,{size:16,stroke:1.5,className:"text-[var(--color-text-subtle)] animate-spin"})}):a==="skipped"?e.jsx("div",{className:"w-4 h-4 shrink-0 flex items-center justify-center",children:e.jsx(X,{size:12,stroke:1.5,className:"text-[var(--color-text-subtle)]"})}):e.jsx("div",{className:"w-4 h-4 shrink-0 rounded-full border border-[var(--color-border-default)]"})}function f({title:a}){return e.jsx("div",{className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-lg px-4 py-3",children:e.jsx("div",{className:"h-[28px] flex items-center",children:e.jsx("h5",{className:"text-heading-h5 text-[var(--color-text-default)]",children:a})})})}function j({title:a,onEdit:s}){return e.jsx("div",{className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-lg px-4 py-3",children:e.jsxs("div",{className:"h-[28px] flex items-center justify-between",children:[e.jsx("h5",{className:"text-heading-h5 text-[var(--color-text-default)]",children:a}),s?e.jsxs(Y,{gap:3,align:"center",children:[e.jsx("span",{className:"text-body-md text-[var(--color-text-subtle)]",children:"Writing..."}),e.jsx(S,{variant:"secondary",size:"sm",leftIcon:e.jsx(g,{size:12}),onClick:s,children:"Edit"})]}):e.jsx("span",{className:"text-body-md text-[var(--color-text-subtle)]",children:"Writing..."})]})})}function h({title:a,onEdit:s}){return e.jsx("div",{className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-lg px-4 py-3",children:e.jsxs("div",{className:"flex items-center justify-between h-[28px]",children:[e.jsx("h5",{className:"text-heading-h5 text-[var(--color-text-default)]",children:a}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-body-md text-[var(--color-text-muted)]",children:"Not configured"}),e.jsx(S,{variant:"secondary",size:"sm",leftIcon:e.jsx(g,{size:12}),onClick:s,children:"Edit"})]})]})})}function w({title:a,onEdit:s,children:n}){return e.jsxs(t,{children:[e.jsx(t.Header,{title:a,showDivider:!1,actions:e.jsx(S,{variant:"outline",size:"sm",leftIcon:e.jsx(g,{size:12}),onClick:s,children:"Edit"})}),e.jsx("div",{className:"flex flex-col w-full gap-3",children:n})]})}function i({title:a,status:s,onEdit:n,summaryContent:K,children:L}){switch(s){case"pre":return e.jsx(f,{title:a});case"writing":return e.jsx(j,{title:a});case"skipped":return e.jsx(h,{title:a,onEdit:n||(()=>{})});case"done":return e.jsx(w,{title:a,onEdit:n||(()=>{}),children:K});case"active":default:return e.jsx(e.Fragment,{children:L})}}r.__docgenInfo={description:"",methods:[],displayName:"WizardSectionStatusIcon",props:{status:{required:!0,tsType:{name:"union",raw:"'pre' | 'active' | 'done' | 'skipped' | 'writing'",elements:[{name:"literal",value:"'pre'"},{name:"literal",value:"'active'"},{name:"literal",value:"'done'"},{name:"literal",value:"'skipped'"},{name:"literal",value:"'writing'"}]},description:""}}};f.__docgenInfo={description:"",methods:[],displayName:"PreSection",props:{title:{required:!0,tsType:{name:"string"},description:""}}};j.__docgenInfo={description:"",methods:[],displayName:"WritingSection",props:{title:{required:!0,tsType:{name:"string"},description:""},onEdit:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};h.__docgenInfo={description:"",methods:[],displayName:"SkippedSection",props:{title:{required:!0,tsType:{name:"string"},description:""},onEdit:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};w.__docgenInfo={description:"",methods:[],displayName:"DoneSection",props:{title:{required:!0,tsType:{name:"string"},description:""},onEdit:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};i.__docgenInfo={description:`WizardSection - 마법사(Wizard) 패턴의 섹션 컴포넌트
