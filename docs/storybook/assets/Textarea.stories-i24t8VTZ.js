import{r as u,j as e}from"./iframe-DD6jyF7N.js";import{t as Ye}from"./cn-BMXv33oC.js";import{F as r}from"./FormField-DyBG4uKp.js";import"./preload-helper-C1FmrZbK.js";const t=u.forwardRef(({variant:n="default",label:o,helperText:i,error:a,fullWidth:be=!1,showCount:ge=!1,maxLength:z,className:ye="",id:Fe,disabled:c,readOnly:p,value:W,defaultValue:R,required:Te=!1,resize:je="none",autoResize:we=!1,minRows:S=3,maxRows:C,success:ze,autosize:We,onChange:V,...q},Ve)=>{const d=Fe||`textarea-${Math.random().toString(36).substr(2,9)}`,Re=u.useRef(null),D=Ve||Re,s=we||We,Se=String(W??R??"").length,E=()=>{const l=D.current;if(!l||!s)return;l.style.height="auto";const N=parseInt(getComputedStyle(l).lineHeight)||20,M=parseInt(getComputedStyle(l).paddingTop)+parseInt(getComputedStyle(l).paddingBottom)||16,Ie=N*S+M,_e=C?N*C+M:1/0,Pe=Math.min(Math.max(l.scrollHeight,Ie),_e);l.style.height=`${Pe}px`};u.useEffect(()=>{s&&E()},[W,s]);const Ce=l=>{V==null||V(l),s&&E()},qe={none:"resize-none",vertical:"resize-y",horizontal:"resize-x",both:"resize"},De=["block w-full","min-h-[var(--textarea-min-height)]","px-[var(--input-padding-x)]","py-[var(--input-padding-y)]","text-[length:var(--input-font-size)]","leading-[var(--input-line-height)]","bg-[var(--input-bg)]","text-[var(--color-text-default)]","border-[length:var(--input-border-width)]","border-solid","transition-all duration-[var(--duration-fast)]","placeholder:text-[var(--color-text-subtle)]","focus:outline-none"],Ee=p?[]:["focus:border-[var(--input-border-focus)]","focus:shadow-[0_0_0_1px_var(--input-border-focus)]"],Ne={default:"rounded-[var(--input-radius)]",code:"rounded-[var(--input-radius-code)] font-mono"},Me=()=>a?"border-[var(--input-border-error)]":ze?"border-[var(--color-state-success)]":p?"border-[var(--input-border-readonly)]":"border-[var(--input-border)]",Oe=c?"bg-[var(--input-bg-disabled)] text-[var(--input-text-disabled)] cursor-not-allowed border-transparent resize-none":"",Ae=p&&!c?"cursor-default":"",Le=Ye(De.join(" "),Ee.join(" "),Ne[n],Me(),Oe,Ae,!c&&!s&&qe[je],s&&"resize-none overflow-hidden",ye),He=["flex flex-col gap-2",be?"w-full":"w-fit"].join(" ");return e.jsxs("div",{className:He,"data-figma-name":"[TDS] Textarea",children:[o&&e.jsxs("label",{htmlFor:d,className:"text-label-lg text-[var(--color-text-default)]",children:[o,Te&&e.jsx("span",{className:"text-[var(--color-state-danger)] ml-0.5",children:"*"})]}),i&&!a&&e.jsx("p",{id:`${d}-helper`,className:"text-body-sm text-[var(--color-text-subtle)]",children:i}),e.jsxs("div",{className:"relative h-fit",children:[e.jsx("textarea",{ref:D,id:d,className:Le,disabled:c,readOnly:p,maxLength:z,value:W,defaultValue:R,rows:s?S:q.rows,"aria-invalid":!!a,"aria-describedby":a?`${d}-error`:i?`${d}-helper`:void 0,onChange:Ce,...q}),ge&&z&&e.jsxs("div",{className:"absolute bottom-2 right-2 text-body-sm text-[var(--color-text-subtle)]",children:[Se,"/",z]})]}),a&&e.jsx("p",{id:`${d}-error`,className:"text-body-sm text-[var(--color-state-danger)]",children:a})]})});t.displayName="Textarea";t.__docgenInfo={description:"",methods:[],displayName:"Textarea",props:{variant:{required:!1,tsType:{name:"union",raw:"'default' | 'code'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'code'"}]},description:"Textarea variant",defaultValue:{value:"'default'",computed:!1}},label:{required:!1,tsType:{name:"string"},description:"Label text"},helperText:{required:!1,tsType:{name:"string"},description:"Helper text"},error:{required:!1,tsType:{name:"string"},description:"Error message"},fullWidth:{required:!1,tsType:{name:"boolean"},description:"Full width",defaultValue:{value:"false",computed:!1}},showCount:{required:!1,tsType:{name:"boolean"},description:"Show character count",defaultValue:{value:"false",computed:!1}},maxLength:{required:!1,tsType:{name:"number"},description:"Max character count"},required:{required:!1,tsType:{name:"boolean"},description:"Required field indicator",defaultValue:{value:"false",computed:!1}},resize:{required:!1,tsType:{name:"union",raw:"'none' | 'vertical' | 'horizontal' | 'both'",elements:[{name:"literal",value:"'none'"},{name:"literal",value:"'vertical'"},{name:"literal",value:"'horizontal'"},{name:"literal",value:"'both'"}]},description:"Resize behavior",defaultValue:{value:"'none'",computed:!1}},autoResize:{required:!1,tsType:{name:"boolean"},description:"Auto-resize based on content",defaultValue:{value:"false",computed:!1}},minRows:{required:!1,tsType:{name:"number"},description:"Minimum rows (when autoResize is true)",defaultValue:{value:"3",computed:!1}},maxRows:{required:!1,tsType:{name:"number"},description:"Maximum rows (when autoResize is true)"},success:{required:!1,tsType:{name:"boolean"},description:"@deprecated Use error for validation"},autosize:{required:!1,tsType:{name:"boolean"},description:"@deprecated Use autoResize instead"},className:{defaultValue:{value:"''",computed:!1},required:!1}},composes:["Omit"]};const Je={title:"Components/Textarea",component:t,tags:["autodocs"],parameters:{docs:{description:{component:`
## Textarea 컴포넌트
...
}`,...($=(Y=x.parameters)==null?void 0:Y.docs)==null?void 0:$.source}}};var k,B,U;f.parameters={...f.parameters,docs:{...(k=f.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => <div style={{
    width: '400px'
  }}>
...
}`,...(U=(B=f.parameters)==null?void 0:B.docs)==null?void 0:U.source}}};var J,G,K;v.parameters={...v.parameters,docs:{...(J=v.parameters)==null?void 0:J.docs,source:{originalSource:`{
...
}`,...(de=(oe=F.parameters)==null?void 0:oe.docs)==null?void 0:de.source}}};var ne,ue,ce;T.parameters={...T.parameters,docs:{...(ne=T.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  render: () => <div style={{
    width: '400px'
  }}>
...
}`,...(ce=(ue=T.parameters)==null?void 0:ue.docs)==null?void 0:ce.source}}};var pe,me,he;j.parameters={...j.parameters,docs:{...(pe=j.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  render: () => <div style={{
    width: '400px'
  }}>
...
}`,...(he=(me=j.parameters)==null?void 0:me.docs)==null?void 0:he.source}}};var xe,fe,ve;w.parameters={...w.parameters,docs:{...(xe=w.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  render: () => <div className="flex flex-col gap-[var(--primitive-spacing-4)]" style={{
    width: '400px'
  }}>
...
}`,...(ve=(fe=w.parameters)==null?void 0:fe.docs)==null?void 0:ve.source}}};const Ge=["Default","WithLabel","Required","WithHelperText","WithCharacterCount","WithError","CodeVariant","AutoResize","ResizeOptions","Disabled","ReadOnly","AllStates"];export{w as AllStates,y as AutoResize,g as CodeVariant,m as Default,T as Disabled,j as ReadOnly,x as Required,F as ResizeOptions,v as WithCharacterCount,b as WithError,f as WithHelperText,h as WithLabel,Ge as __namedExportsOrder,Je as default};
