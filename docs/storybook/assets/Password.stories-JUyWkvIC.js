import{r as u,j as e}from"./iframe-CsZHcOUf.js";import{t as h}from"./cn-CshvV4Tc.js";import{I as Ve,a as ze}from"./IconEye-DG00z1ef.js";import{V as N}from"./Stack-CKOQlJBR.js";import{F as t}from"./FormField-DcPjmuus.js";import{B as Le}from"./Button-B8wqjk7E.js";import"./preload-helper-C1FmrZbK.js";import"./createReactComponent-C2Lh4gVY.js";const ke={sm:"h-[var(--input-height-sm)] text-[length:var(--input-font-size-sm)]",md:"h-[var(--input-height-md)] text-[length:var(--input-font-size)]"},r=u.forwardRef(({size:a="md",label:l,helperText:s,error:d,fullWidth:m=!1,showToggle:o=!0,showLabel:n="Show password",hideLabel:Fe="Hide password",className:Ee="",id:je,disabled:p,readOnly:i,required:W=!1,success:Se,...ye},Ce)=>{const[w,Te]=u.useState(!1),c=je||`password-${Math.random().toString(36).substr(2,9)}`,D=!!d,M=typeof d=="string"?d:void 0,qe=()=>D?"border-[var(--input-border-error)]":Se?"border-[var(--color-state-success)]":i?"border-[var(--input-border-readonly)]":"border-[var(--input-border)]",De=h("flex flex-col gap-[var(--input-label-gap)]",m?"w-full":"w-[var(--input-default-width)]"),Me=h("flex items-center","w-full",ke[a],"px-[var(--input-padding-x)]","bg-[var(--input-bg)]","border rounded-[var(--input-radius)]",qe(),"transition-colors duration-[var(--duration-fast)]","focus-within:border-[var(--input-border-focus)]",p&&"bg-[var(--input-bg-disabled)] cursor-not-allowed",i&&"bg-[var(--input-bg-readonly)]"),Ne=h("flex-1 h-full","bg-transparent","border-none outline-none","text-[var(--color-text-default)]","placeholder:text-[var(--input-placeholder)]",p&&"text-[var(--color-text-subtle)] cursor-not-allowed",i&&"cursor-default",Ee),We=h("flex items-center justify-center","p-1 ml-2","rounded","text-[var(--color-text-muted)]","hover:text-[var(--color-text-default)]","hover:bg-[var(--color-surface-subtle)]","transition-colors duration-[var(--duration-fast)]","cursor-pointer","focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-action-primary)]",(p||i)&&"pointer-events-none opacity-50");return e.jsxs("div",{className:De,children:[l&&e.jsxs("label",{htmlFor:c,className:"text-label-sm text-[var(--color-text-default)]",children:[l,W&&e.jsx("span",{className:"text-[var(--color-state-danger)] ml-0.5",children:"*"})]}),e.jsxs("div",{className:Me,children:[e.jsx("input",{ref:Ce,id:c,type:w?"text":"password",disabled:p,readOnly:i,required:W,"aria-invalid":D,"aria-describedby":M?`${c}-error`:s?`${c}-helper`:void 0,className:Ne,...ye}),o&&e.jsx("button",{type:"button",tabIndex:p||i?-1:0,onClick:()=>Te(!w),"aria-label":w?Fe:n,className:We,children:w?e.jsx(Ve,{size:a==="sm"?14:16,stroke:1.5}):e.jsx(ze,{size:a==="sm"?14:16,stroke:1.5})})]}),s&&!D&&e.jsx("p",{id:`${c}-helper`,className:"text-body-sm text-[var(--color-text-subtle)]",children:s}),M&&e.jsx("p",{id:`${c}-error`,className:"text-body-sm text-[var(--color-state-danger)]",children:M})]})});r.displayName="Password";r.__docgenInfo={description:"",methods:[],displayName:"Password",props:{size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"}]},description:"Input size",defaultValue:{value:"'md'",computed:!1}},label:{required:!1,tsType:{name:"string"},description:"Label text"},helperText:{required:!1,tsType:{name:"string"},description:"Helper text"},error:{required:!1,tsType:{name:"union",raw:"boolean | string",elements:[{name:"boolean"},{name:"string"}]},description:"Error state or message"},fullWidth:{required:!1,tsType:{name:"boolean"},description:"Full width mode",defaultValue:{value:"false",computed:!1}},showToggle:{required:!1,tsType:{name:"boolean"},description:"Show password toggle by default",defaultValue:{value:"true",computed:!1}},showLabel:{required:!1,tsType:{name:"string"},description:"Custom toggle button aria label for show state",defaultValue:{value:"'Show password'",computed:!1}},hideLabel:{required:!1,tsType:{name:"string"},description:"Custom toggle button aria label for hide state",defaultValue:{value:"'Hide password'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes",defaultValue:{value:"''",computed:!1}},success:{required:!1,tsType:{name:"boolean"},description:"@deprecated Use error for validation states"},required:{defaultValue:{value:"false",computed:!1},required:!1}},composes:["Omit"]};const Ze={title:"Components/Password",component:r,parameters:{layout:"centered"},argTypes:{size:{control:{type:"select"},options:["sm","md"]}}},f={args:{placeholder:"Enter password"}},P={render:()=>e.jsx(t,{label:"Password",children:e.jsx(r,{placeholder:"Enter your password"})})},g={render:()=>e.jsx(t,{label:"Password",required:!0,children:e.jsx(r,{placeholder:"Enter your password"})})},x={render:()=>e.jsx(t,{label:"Password",helperText:"Password must be at least 8 characters",children:e.jsx(r,{placeholder:"Enter your password"})})},b={render:()=>e.jsxs(N,{gap:4,children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-label-sm text-[var(--color-text-subtle)] mb-[var(--primitive-spacing-2)]",children:"Small"}),e.jsx(r,{size:"sm",placeholder:"Small password input"})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-label-sm text-[var(--color-text-subtle)] mb-[var(--primitive-spacing-2)]",children:"Medium (default)"}),e.jsx(r,{size:"md",placeholder:"Medium password input"})]})]})},v={render:()=>e.jsx(t,{label:"Password",children:e.jsx(r,{placeholder:"Enter password",disabled:!0,value:"secret123"})})},F={render:()=>e.jsx(t,{label:"Password",children:e.jsx(r,{value:"secret123",readOnly:!0})})},E={render:()=>e.jsx(t,{label:"Password",errorMessage:"Password is required",error:!0,children:e.jsx(r,{placeholder:"Enter password"})})},j={render:()=>e.jsx(t,{label:"Password",helperText:"This field has an error",error:!0,children:e.jsx(r,{placeholder:"Enter password"})})},S={render:()=>e.jsx(t,{label:"Password",children:e.jsx(r,{placeholder:"Enter password",showToggle:!1})})},y={render:()=>e.jsx(t,{label:"Password",children:e.jsx(r,{placeholder:"Enter password",showLabel:"비밀번호 보기",hideLabel:"비밀번호 숨기기"})})},C={render:()=>e.jsx("div",{style:{width:"400px"},children:e.jsx(t,{label:"Password",children:e.jsx(r,{placeholder:"Enter password",fullWidth:!0})})})},T={render:()=>{const[a,l]=u.useState(""),[s,d]=u.useState(""),m=o=>{o.length<8?d("Password must be at least 8 characters"):/[A-Z]/.test(o)?/[0-9]/.test(o)?d(""):d("Password must contain at least one number"):d("Password must contain at least one uppercase letter")};return e.jsxs(N,{gap:4,children:[e.jsx(t,{label:"Password",helperText:s?void 0:"Min 8 characters, 1 uppercase, 1 number",errorMessage:s||void 0,error:!!s,children:e.jsx(r,{placeholder:"Enter a strong password",value:a,onChange:o=>{l(o.target.value),m(o.target.value)}})}),e.jsxs("p",{className:"text-body-sm text-[var(--color-text-muted)]",children:["Password length: ",a.length]})]})}},q={render:()=>{const[a,l]=u.useState({currentPassword:"",newPassword:"",confirmPassword:""}),[s,d]=u.useState({currentPassword:"",newPassword:"",confirmPassword:""}),m=o=>{o.preventDefault();const n={...s};a.currentPassword||(n.currentPassword="Current password is required"),a.newPassword.length<8&&(n.newPassword="New password must be at least 8 characters"),a.newPassword!==a.confirmPassword&&(n.confirmPassword="Passwords do not match"),d(n)};return e.jsx("form",{onSubmit:m,style:{width:"320px"},children:e.jsxs(N,{gap:4,children:[e.jsx(t,{label:"Current Password",required:!0,errorMessage:s.currentPassword||void 0,error:!!s.currentPassword,children:e.jsx(r,{placeholder:"Enter current password",value:a.currentPassword,onChange:o=>{l({...a,currentPassword:o.target.value}),d({...s,currentPassword:""})},fullWidth:!0})}),e.jsx(t,{label:"New Password",required:!0,helperText:"Minimum 8 characters",errorMessage:s.newPassword||void 0,error:!!s.newPassword,children:e.jsx(r,{placeholder:"Enter new password",value:a.newPassword,onChange:o=>{l({...a,newPassword:o.target.value}),d({...s,newPassword:""})},fullWidth:!0})}),e.jsx(t,{label:"Confirm Password",required:!0,errorMessage:s.confirmPassword||void 0,error:!!s.confirmPassword,children:e.jsx(r,{placeholder:"Confirm new password",value:a.confirmPassword,onChange:o=>{l({...a,confirmPassword:o.target.value}),d({...s,confirmPassword:""})},fullWidth:!0})}),e.jsx(Le,{type:"submit",variant:"primary",size:"md",fullWidth:!0,children:"Change Password"})]})})}};var V,z,L;f.parameters={...f.parameters,docs:{...(V=f.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    placeholder: 'Enter password'
  }
}`,...(L=(z=f.parameters)==null?void 0:z.docs)==null?void 0:L.source}}};var k,B,I;P.parameters={...P.parameters,docs:{...(k=P.parameters)==null?void 0:k.docs,source:{originalSource:`{
