import{r as h,j as i,R as t}from"./iframe-CsZHcOUf.js";function b({status:u,type:s="icon",icon:e,text:c,iconSize:N=22,onClick:d,className:m="",isSelected:f=!1,children:n}){const[p,o]=h.useState(!1),a=u||(f?"selected":p?"hover":"default"),v={default:"bg-[var(--color-surface-default)]",hover:"bg-[var(--color-surface-subtle)]",selected:"bg-[var(--color-info-weak-bg)]"},l={default:"text-[var(--color-text-muted)]",hover:"text-[var(--color-text-default)]",selected:"text-[var(--color-action-primary)]"},x={default:"text-[var(--color-text-muted)]",hover:"text-[var(--color-text-default)]",selected:"text-[var(--color-action-primary)]"},y=`
