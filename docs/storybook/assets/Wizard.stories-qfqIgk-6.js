import{j as e}from"./iframe-iHQO5Mqm.js";import{S as t}from"./SectionCard-5h9Pp3cU.js";import{B as v}from"./Button-9zQlOYxA.js";import{I as g}from"./IconEdit-CSXljq5-.js";import{I as L}from"./IconCheck-ai78HtyZ.js";import{I as Q}from"./IconProgress-4uI9DAdp.js";import{I as X}from"./IconMinus-B--iY0Bg.js";import{I as Y}from"./IconCircleDashed-TXPmLnCP.js";import{H as Z,V as S}from"./Stack-CS-kulzC.js";import"./preload-helper-C1FmrZbK.js";import"./cn-8AORBNJN.js";import"./chunk-JZWAC4HX-em8q0N27.js";import"./createReactComponent-CEVQAvfZ.js";function s({status:a}){return a==="done"?e.jsx("div",{className:"w-4 h-4 shrink-0 rounded-full bg-[var(--color-state-success)] flex items-center justify-center",children:e.jsx(L,{size:10,stroke:2.5,className:"text-white"})}):a==="active"||a==="writing"?e.jsx("div",{className:"w-4 h-4 shrink-0 flex items-center justify-center",children:e.jsx(Q,{size:20,stroke:1.5,className:"text-[var(--color-text-muted)]"})}):a==="skipped"?e.jsx("div",{className:"w-4 h-4 shrink-0 flex items-center justify-center",children:e.jsx(X,{size:12,stroke:1.5,className:"text-[var(--color-text-subtle)]"})}):e.jsx("div",{className:"w-4 h-4 shrink-0 flex items-center justify-center",children:e.jsx(Y,{size:20,stroke:1.5,className:"text-[var(--color-border-default)]"})})}function f({title:a}){return e.jsx("div",{"data-figma-name":"WizardSection",className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-lg px-4 py-3",children:e.jsx("div",{className:"h-[28px] flex items-center",children:e.jsx("h5",{className:"text-heading-h5 text-[var(--color-text-default)]",children:a})})})}function j({title:a,onEdit:r}){return e.jsx("div",{"data-figma-name":"WizardSection",className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-lg px-4 py-3",children:e.jsxs("div",{className:"h-[28px] flex items-center justify-between",children:[e.jsx("h5",{className:"text-heading-h5 text-[var(--color-text-default)]",children:a}),r?e.jsxs(Z,{gap:3,align:"center",children:[e.jsx("span",{className:"text-body-md text-[var(--color-text-subtle)]",children:"Writing..."}),e.jsx(v,{variant:"secondary",size:"sm",leftIcon:e.jsx(g,{size:12}),onClick:r,children:"Edit"})]}):e.jsx("span",{className:"text-body-md text-[var(--color-text-subtle)]",children:"Writing..."})]})})}function h({title:a,onEdit:r}){return e.jsx("div",{"data-figma-name":"WizardSection",className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-lg px-4 py-3",children:e.jsxs("div",{className:"flex items-center justify-between h-[28px]",children:[e.jsx("h5",{className:"text-heading-h5 text-[var(--color-text-default)]",children:a}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-body-md text-[var(--color-text-muted)]",children:"Not configured"}),e.jsx(v,{variant:"secondary",size:"sm",leftIcon:e.jsx(g,{size:12}),onClick:r,children:"Edit"})]})]})})}function w({title:a,onEdit:r,children:n}){return e.jsxs(t,{children:[e.jsx(t.Header,{title:a,showDivider:!1,actions:e.jsx(v,{variant:"outline",size:"sm",leftIcon:e.jsx(g,{size:12}),onClick:r,children:"Edit"})}),e.jsx("div",{className:"flex flex-col w-full gap-3",children:n})]})}function i({title:a,status:r,onEdit:n,summaryContent:J,children:K}){switch(r){case"pre":return e.jsx(f,{title:a});case"writing":return e.jsx(j,{title:a});case"skipped":return e.jsx(h,{title:a,onEdit:n||(()=>{})});case"done":return e.jsx(w,{title:a,onEdit:n||(()=>{}),children:J});case"active":default:return e.jsx(e.Fragment,{children:K})}}s.__docgenInfo={description:"",methods:[],displayName:"WizardSectionStatusIcon",props:{status:{required:!0,tsType:{name:"union",raw:"'pre' | 'active' | 'done' | 'skipped' | 'writing'",elements:[{name:"literal",value:"'pre'"},{name:"literal",value:"'active'"},{name:"literal",value:"'done'"},{name:"literal",value:"'skipped'"},{name:"literal",value:"'writing'"}]},description:""}}};f.__docgenInfo={description:"",methods:[],displayName:"PreSection",props:{title:{required:!0,tsType:{name:"string"},description:""}}};j.__docgenInfo={description:"",methods:[],displayName:"WritingSection",props:{title:{required:!0,tsType:{name:"string"},description:""},onEdit:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};h.__docgenInfo={description:"",methods:[],displayName:"SkippedSection",props:{title:{required:!0,tsType:{name:"string"},description:""},onEdit:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};w.__docgenInfo={description:"",methods:[],displayName:"DoneSection",props:{title:{required:!0,tsType:{name:"string"},description:""},onEdit:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};i.__docgenInfo={description:`WizardSection - 마법사(Wizard) 패턴의 섹션 컴포넌트
...
- writing: 작성 중 (회전 아이콘, Writing... 표시)`,methods:[],displayName:"WizardSection",props:{title:{required:!0,tsType:{name:"string"},description:""},status:{required:!0,tsType:{name:"union",raw:"'pre' | 'active' | 'done' | 'skipped' | 'writing'",elements:[{name:"literal",value:"'pre'"},{name:"literal",value:"'active'"},{name:"literal",value:"'done'"},{name:"literal",value:"'skipped'"},{name:"literal",value:"'writing'"}]},description:""},onEdit:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},summaryContent:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Content to show when status is 'done'"},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Content to show when status is 'active'"}}};const me={title:"Components/Wizard",component:i,tags:["autodocs"],decorators:[a=>e.jsx("div",{className:"max-w-2xl",children:e.jsx(a,{})})],parameters:{docs:{description:{component:`
## Wizard 컴포넌트
...
/>
\`\`\`
        `}}},argTypes:{status:{control:"select",options:["pre","active","done","skipped","writing"],description:"섹션 상태"}}},o={name:"Status Icons",render:()=>e.jsxs("div",{className:"flex items-center gap-[var(--primitive-spacing-4)]",children:[e.jsxs("div",{className:"flex items-center gap-[var(--primitive-spacing-2)]",children:[e.jsx(s,{status:"pre"}),e.jsx("span",{className:"text-body-md",children:"Pre (Waiting)"})]}),e.jsxs("div",{className:"flex items-center gap-[var(--primitive-spacing-2)]",children:[e.jsx(s,{status:"active"}),e.jsx("span",{className:"text-body-md",children:"Active"})]}),e.jsxs("div",{className:"flex items-center gap-[var(--primitive-spacing-2)]",children:[e.jsx(s,{status:"writing"}),e.jsx("span",{className:"text-body-md",children:"Writing"})]}),e.jsxs("div",{className:"flex items-center gap-[var(--primitive-spacing-2)]",children:[e.jsx(s,{status:"done"}),e.jsx("span",{className:"text-body-md",children:"Done"})]}),e.jsxs("div",{className:"flex items-center gap-[var(--primitive-spacing-2)]",children:[e.jsx(s,{status:"skipped"}),e.jsx("span",{className:"text-body-md",children:"Skipped"})]})]})},c={name:"Pre Section",render:()=>e.jsx(f,{title:"Network Configuration"})},d={name:"Writing Section",render:()=>e.jsx(j,{title:"Storage Settings",onEdit:()=>console.log("Edit clicked")})},l={name:"Skipped Section",render:()=>e.jsx(h,{title:"Advanced Options",onEdit:()=>console.log("Edit clicked")})},p={name:"Done Section",render:()=>e.jsxs(w,{title:"Basic information",onEdit:()=>console.log("Edit clicked"),children:[e.jsx(t.DataRow,{label:"Instance Name",value:"production-server-01",showDivider:!1}),e.jsx(t.DataRow,{label:"Description",value:"Main production web server"}),e.jsx(t.DataRow,{label:"Region",value:"us-east-1"})]})},m={name:"All States",render:()=>e.jsxs(S,{gap:4,children:[e.jsx(i,{title:"Step 1: Basic Info",status:"done",onEdit:()=>{},summaryContent:e.jsxs(e.Fragment,{children:[e.jsx(t.DataRow,{label:"Name",value:"my-instance",showDivider:!1}),e.jsx(t.DataRow,{label:"Type",value:"m5.large"})]})}),e.jsx(i,{title:"Step 2: Configuration",status:"active",children:e.jsxs(t,{isActive:!0,children:[e.jsx(t.Header,{title:"Step 2: Configuration"}),e.jsx(t.Content,{children:e.jsx("p",{className:"text-body-md text-[var(--color-text-muted)]",children:"Configure your instance settings here..."})})]})}),e.jsx(i,{title:"Step 3: Network",status:"pre"}),e.jsx(i,{title:"Step 4: Storage",status:"pre"})]})},u={name:"Full Wizard Example",render:()=>e.jsxs(S,{gap:4,children:[e.jsx(i,{title:"Basic information",status:"done",onEdit:()=>console.log("Edit Basic Info"),summaryContent:e.jsxs(e.Fragment,{children:[e.jsx(t.DataRow,{label:"Instance Name",value:"web-server-prod-01",showDivider:!1}),e.jsx(t.DataRow,{label:"Description",value:"Production web server for main application"}),e.jsx(t.DataRow,{label:"Project",value:"E-commerce Platform"})]})}),e.jsx(i,{title:"Instance Type",status:"done",onEdit:()=>console.log("Edit Instance Type"),summaryContent:e.jsxs(e.Fragment,{children:[e.jsx(t.DataRow,{label:"Type",value:"m5.xlarge",showDivider:!1}),e.jsx(t.DataRow,{label:"vCPU",value:"4"}),e.jsx(t.DataRow,{label:"Memory",value:"16 GB"})]})}),e.jsx(i,{title:"Network Configuration",status:"active",children:e.jsxs(t,{isActive:!0,children:[e.jsx(t.Header,{title:"Network Configuration"}),e.jsx(t.Content,{children:e.jsx("div",{className:"text-body-md text-[var(--color-text-muted)] py-[var(--primitive-spacing-4)]",children:"Select VPC, subnet, and security group settings..."})})]})}),e.jsx(i,{title:"Storage",status:"pre"}),e.jsx(i,{title:"Security",status:"pre"}),e.jsx(i,{title:"Review & Create",status:"pre"})]})},x={name:"With Skipped Steps",render:()=>e.jsxs(S,{gap:4,children:[e.jsx(i,{title:"Required Settings",status:"done",onEdit:()=>{},summaryContent:e.jsx(t.DataRow,{label:"Name",value:"my-resource",showDivider:!1})}),e.jsx(i,{title:"Optional: Tags",status:"skipped",onEdit:()=>console.log("Configure tags")}),e.jsx(i,{title:"Optional: Monitoring",status:"skipped",onEdit:()=>console.log("Configure monitoring")}),e.jsx(i,{title:"Review",status:"active",children:e.jsxs(t,{isActive:!0,children:[e.jsx(t.Header,{title:"Review"}),e.jsx(t.Content,{children:e.jsx("p",{className:"text-body-md text-[var(--color-text-muted)]",children:"Review your configuration before creating..."})})]})})]})};var y,C,N;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
  name: 'Status Icons',
...
}`,...(N=(C=o.parameters)==null?void 0:C.docs)==null?void 0:N.source}}};var b,k,W;c.parameters={...c.parameters,docs:{...(b=c.parameters)==null?void 0:b.docs,source:{originalSource:`{
  name: 'Pre Section',
...
}`,...(G=(U=x.parameters)==null?void 0:U.docs)==null?void 0:G.source}}};const ue=["StatusIcons","PreSectionExample","WritingSectionExample","SkippedSectionExample","DoneSectionExample","AllStates","FullWizardExample","WithSkippedSteps"];export{m as AllStates,p as DoneSectionExample,u as FullWizardExample,c as PreSectionExample,l as SkippedSectionExample,o as StatusIcons,x as WithSkippedSteps,d as WritingSectionExample,ue as __namedExportsOrder,me as default};
