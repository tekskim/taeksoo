import{j as e}from"./iframe-Cu1YwpPb.js";import{S as t}from"./SectionCard-DetSJ1Cu.js";import{B as S}from"./Button-BqnzwiOg.js";import{I as g}from"./IconEdit-BTHdRBaL.js";import{I as Q}from"./IconCheck-DlvezMje.js";import{I as N}from"./IconProgress-RHM3t8Xb.js";import{I as X}from"./IconMinus-C7R9aqhd.js";import{H as Y,V as v}from"./Stack-fk-7pwCU.js";import"./preload-helper-C1FmrZbK.js";import"./bundle-mjs-BZSatpsL.js";import"./chunk-JZWAC4HX-Bnto_-lS.js";import"./createReactComponent-CCqVgkXm.js";function r({status:a}){return a==="done"?e.jsx("div",{className:"w-4 h-4 shrink-0 rounded-full bg-[var(--color-state-success)] flex items-center justify-center",children:e.jsx(Q,{size:10,stroke:2.5,className:"text-white"})}):a==="active"?e.jsx("div",{className:"w-4 h-4 shrink-0 flex items-center justify-center",children:e.jsx(N,{size:12,stroke:1.5,className:"text-[var(--color-text-subtle)] animate-spin"})}):a==="writing"?e.jsx("div",{className:"w-4 h-4 shrink-0 flex items-center justify-center",children:e.jsx(N,{size:12,stroke:1.5,className:"text-[var(--color-text-subtle)] animate-spin"})}):a==="skipped"?e.jsx("div",{className:"w-4 h-4 shrink-0 flex items-center justify-center",children:e.jsx(X,{size:12,stroke:1.5,className:"text-[var(--color-text-subtle)]"})}):e.jsx("div",{className:"w-4 h-4 shrink-0 rounded-full border border-[var(--color-border-default)]"})}function f({title:a}){return e.jsx("div",{className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-lg px-4 py-[12px]",children:e.jsx("div",{className:"h-[28px] flex items-center",children:e.jsx("h5",{className:"text-heading-h5 text-[var(--color-text-default)]",children:a})})})}function j({title:a,onEdit:s}){return e.jsx("div",{className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-lg px-4 py-[12px]",children:e.jsxs("div",{className:"h-[28px] flex items-center justify-between",children:[e.jsx("h5",{className:"text-heading-h5 text-[var(--color-text-default)]",children:a}),s?e.jsxs(Y,{gap:3,align:"center",children:[e.jsx("span",{className:"text-body-md text-[var(--color-text-subtle)]",children:"Writing..."}),e.jsx(S,{variant:"secondary",size:"sm",leftIcon:e.jsx(g,{size:12}),onClick:s,children:"Edit"})]}):e.jsx("span",{className:"text-body-md text-[var(--color-text-subtle)]",children:"Writing..."})]})})}function h({title:a,onEdit:s}){return e.jsx("div",{className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-lg px-4 py-[12px]",children:e.jsxs("div",{className:"flex items-center justify-between h-[28px]",children:[e.jsx("h5",{className:"text-heading-h5 text-[var(--color-text-default)]",children:a}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-body-md text-[var(--color-text-muted)]",children:"Not configured"}),e.jsx(S,{variant:"secondary",size:"sm",leftIcon:e.jsx(g,{size:12}),onClick:s,children:"Edit"})]})]})})}function w({title:a,onEdit:s,children:n}){return e.jsxs(t,{children:[e.jsx(t.Header,{title:a,showDivider:!1,actions:e.jsx(S,{variant:"outline",size:"sm",leftIcon:e.jsx(g,{size:12}),onClick:s,children:"Edit"})}),e.jsx("div",{className:"flex flex-col w-full gap-3",children:n})]})}function i({title:a,status:s,onEdit:n,summaryContent:K,children:L}){switch(s){case"pre":return e.jsx(f,{title:a});case"writing":return e.jsx(j,{title:a});case"skipped":return e.jsx(h,{title:a,onEdit:n||(()=>{})});case"done":return e.jsx(w,{title:a,onEdit:n||(()=>{}),children:K});case"active":default:return e.jsx(e.Fragment,{children:L})}}r.__docgenInfo={description:"",methods:[],displayName:"WizardSectionStatusIcon",props:{status:{required:!0,tsType:{name:"union",raw:"'pre' | 'active' | 'done' | 'skipped' | 'writing'",elements:[{name:"literal",value:"'pre'"},{name:"literal",value:"'active'"},{name:"literal",value:"'done'"},{name:"literal",value:"'skipped'"},{name:"literal",value:"'writing'"}]},description:""}}};f.__docgenInfo={description:"",methods:[],displayName:"PreSection",props:{title:{required:!0,tsType:{name:"string"},description:""}}};j.__docgenInfo={description:"",methods:[],displayName:"WritingSection",props:{title:{required:!0,tsType:{name:"string"},description:""},onEdit:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};h.__docgenInfo={description:"",methods:[],displayName:"SkippedSection",props:{title:{required:!0,tsType:{name:"string"},description:""},onEdit:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};w.__docgenInfo={description:"",methods:[],displayName:"DoneSection",props:{title:{required:!0,tsType:{name:"string"},description:""},onEdit:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};i.__docgenInfo={description:`WizardSection - 마법사(Wizard) 패턴의 섹션 컴포넌트
...
- writing: 작성 중 (회전 아이콘, Writing... 표시)`,methods:[],displayName:"WizardSection",props:{title:{required:!0,tsType:{name:"string"},description:""},status:{required:!0,tsType:{name:"union",raw:"'pre' | 'active' | 'done' | 'skipped' | 'writing'",elements:[{name:"literal",value:"'pre'"},{name:"literal",value:"'active'"},{name:"literal",value:"'done'"},{name:"literal",value:"'skipped'"},{name:"literal",value:"'writing'"}]},description:""},onEdit:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},summaryContent:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Content to show when status is 'done'"},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Content to show when status is 'active'"}}};const le={title:"Components/Wizard",component:i,tags:["autodocs"],decorators:[a=>e.jsx("div",{className:"max-w-2xl",children:e.jsx(a,{})})],parameters:{docs:{description:{component:`
## Wizard 컴포넌트
...
}`,...(D=(W=c.parameters)==null?void 0:W.docs)==null?void 0:D.source}}};var E,R,z;d.parameters={...d.parameters,docs:{...(E=d.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: 'Writing Section',
  render: () => <WritingSection title="Storage Settings" onEdit={() => console.log('Edit clicked')} />
}`,...(z=(R=d.parameters)==null?void 0:R.docs)==null?void 0:z.source}}};var I,T,P;l.parameters={...l.parameters,docs:{...(I=l.parameters)==null?void 0:I.docs,source:{originalSource:`{
  name: 'Skipped Section',
  render: () => <SkippedSection title="Advanced Options" onEdit={() => console.log('Edit clicked')} />
}`,...(P=(T=l.parameters)==null?void 0:T.docs)==null?void 0:P.source}}};var q,A,_;p.parameters={...p.parameters,docs:{...(q=p.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: 'Done Section',
