import{r as k,j as e}from"./iframe-iHQO5Mqm.js";import{r as me}from"./index-HVRJ0oH1.js";import{t as fe}from"./cn-8AORBNJN.js";import{I as ge}from"./IconX-gJXINq1T.js";import{I as xe}from"./IconChevronDown-LyXUQX2K.js";import{I as ve}from"./IconChevronRight-Ctj-S6VH.js";import{c as be}from"./createReactComponent-CEVQAvfZ.js";import{P as he}from"./ProgressBar-B4MfwSd9.js";import{N as Ce}from"./NumberInput-BOVE9B2U.js";import{B as E}from"./Button-9zQlOYxA.js";import{I as ye}from"./IconCircleDashed-TXPmLnCP.js";import{I as je}from"./IconProgress-4uI9DAdp.js";import{I as Ne}from"./IconAlertTriangle-C3nCRCP9.js";import{I as Ie}from"./IconCheck-ai78HtyZ.js";import"./preload-helper-C1FmrZbK.js";import"./IconAlertCircle-xIuC-r38.js";import"./IconChevronUp-DKe8af00.js";/**
 * @license @tabler/icons-react v3.36.1 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const Te=[["path",{d:"M11 12a1 1 0 1 0 2 0a1 1 0 1 0 -2 0",key:"svg-0"}],["path",{d:"M7 12a5 5 0 1 0 10 0a5 5 0 1 0 -10 0",key:"svg-1"}],["path",{d:"M3 12a9 9 0 1 0 18 0a9 9 0 1 0 -18 0",key:"svg-2"}]],A=be("outline","target","Target",Te),q={"top-left":"top-4 left-4","top-right":"top-4 right-4","bottom-left":"bottom-4 left-4","bottom-right":"bottom-4 right-4"};function we({status:o}){switch(o){case"success":return e.jsx("div",{className:"size-4 rounded-full border border-[var(--color-state-success)] bg-[var(--color-state-success)] shrink-0 flex items-center justify-center",children:e.jsx(Ie,{size:10,stroke:2,className:"text-white"})});case"warning":return e.jsx("div",{className:"size-4 rounded-full border border-[var(--color-state-danger)] bg-[var(--color-state-danger)] shrink-0 flex items-center justify-center",children:e.jsx(Ne,{size:10,stroke:2,className:"text-white"})});case"processing":return e.jsx("div",{className:"size-4 shrink-0 flex items-center justify-center",children:e.jsx(je,{size:20,stroke:1.5,className:"text-[var(--color-text-muted)]"})});default:return e.jsx("div",{className:"size-4 shrink-0 flex items-center justify-center",children:e.jsx(ye,{size:20,stroke:1.5,className:"text-[var(--color-border-default)]"})})}}function a({title:o,sections:l=[],quota:h=[],instanceCount:Z=1,onInstanceCountChange:C,cancelLabel:ee="Cancel",actionLabel:te="Create",actionEnabled:y=!1,onCancel:g,onAction:x,position:se="top-left",showCloseButton:ae=!1,onClose:j,isOpen:re=!0,zIndex:N,portal:v=!0,width:le="320px",className:oe,style:ie,...ne}){const[ce,I]=k.useState(()=>{const t={};return l.forEach((s,i)=>{t[i]=s.collapsible?s.defaultExpanded??!0:!0}),t});if(k.useEffect(()=>{const t={};l.forEach((s,i)=>{t[i]=s.collapsible?s.defaultExpanded??!0:!0}),I(t)},[l]),!re)return null;const ue=t=>{I(s=>({...s,[t]:!s[t]}))},de=[v?"fixed":"relative","z-[var(--z-popover)]","bg-[var(--color-surface-default)]","border border-[var(--color-border-default)]","rounded-[var(--primitive-radius-lg)]","overflow-hidden","flex flex-col","h-fit","max-h-[calc(100vh-2rem)]",...v?[q[se||"top-left"]||q["top-left"]]:[]],pe={...ie,width:le,...N&&{zIndex:N}},b=e.jsxs("div",{"data-figma-name":"FloatingCard",className:fe(de.join(" "),oe),style:pe,...ne,children:[ae&&j&&e.jsx("button",{type:"button",onClick:j,className:`
...
}`,...(B=(z=n.parameters)==null?void 0:z.docs)==null?void 0:B.source}}};var P,D,F;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
