import{r as E,j as e}from"./iframe-BGa_n0Au.js";import{r as ye}from"./index-TWFM_iTt.js";import{g as Ne}from"./overlayscrollbars-react-BA-Ii52A.js";import{t as je}from"./cn-BMXv33oC.js";import{I as Ie}from"./IconX-Cu2ORRPW.js";import{I as Te}from"./IconChevronDown-CkPvAR8y.js";import{I as Se}from"./IconChevronRight-Cpu_3G4S.js";import{c as we}from"./createReactComponent-B5dOz73m.js";import{P as ke}from"./ProgressBar-Cdd5n5zt.js";import{N as Ee}from"./NumberInput-zY6TU2Ta.js";import{B as A}from"./Button-DSEeEmmE.js";import{I as Ae}from"./IconCircleDashed-BRMGqDIa.js";import{I as qe}from"./IconProgress-nQmfoeUe.js";import{I as Ve}from"./IconAlertTriangle-D-uwEaCA.js";import{I as Be}from"./IconCheck-pdhJp_YJ.js";import"./preload-helper-C1FmrZbK.js";import"./IconAlertCircle-nErGPt13.js";import"./IconChevronUp-DG3taHF5.js";/**
 * @license @tabler/icons-react v3.36.1 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const De=[["path",{d:"M11 12a1 1 0 1 0 2 0a1 1 0 1 0 -2 0",key:"svg-0"}],["path",{d:"M7 12a5 5 0 1 0 10 0a5 5 0 1 0 -10 0",key:"svg-1"}],["path",{d:"M3 12a9 9 0 1 0 18 0a9 9 0 1 0 -18 0",key:"svg-2"}]],q=we("outline","target","Target",De),V={"top-left":"top-4 left-4","top-right":"top-4 right-4","bottom-left":"bottom-4 left-4","bottom-right":"bottom-4 right-4"};function ze({status:o}){switch(o){case"success":return e.jsx("div",{className:"size-4 rounded-full border border-[var(--color-state-success)] bg-[var(--color-state-success)] shrink-0 flex items-center justify-center",children:e.jsx(Be,{size:10,stroke:2,className:"text-[var(--color-text-on-primary)]"})});case"warning":return e.jsx("div",{className:"size-4 rounded-full border border-[var(--color-state-danger)] bg-[var(--color-state-danger)] shrink-0 flex items-center justify-center",children:e.jsx(Ve,{size:10,stroke:2,className:"text-[var(--color-text-on-primary)]"})});case"processing":return e.jsx("div",{className:"size-4 shrink-0 flex items-center justify-center",children:e.jsx(qe,{size:20,stroke:1.5,className:"text-[var(--color-text-muted)]"})});default:return e.jsx("div",{className:"size-4 shrink-0 flex items-center justify-center",children:e.jsx(Ae,{size:20,stroke:1.5,className:"text-[var(--color-border-default)]"})})}}function a({title:o,sections:l=[],quota:y=[],instanceCount:oe=1,onInstanceCountChange:N,cancelLabel:ie="Cancel",actionLabel:ne="Create",actionEnabled:ce=!1,onCancel:x,onAction:b,position:ue="top-left",showCloseButton:de=!1,onClose:j,isOpen:pe=!0,zIndex:I,portal:h=!0,width:me="320px",className:fe,style:ge,...ve}){const[xe,T]=E.useState(()=>{const t={};return l.forEach((s,i)=>{t[i]=s.collapsible?s.defaultExpanded??!0:!0}),t});if(E.useEffect(()=>{const t={};l.forEach((s,i)=>{t[i]=s.collapsible?s.defaultExpanded??!0:!0}),T(t)},[l]),!pe)return null;const be=t=>{T(s=>({...s,[t]:!s[t]}))},he=[h?"fixed":"relative","z-[var(--z-popover)]","bg-[var(--color-surface-default)]","border border-[var(--color-border-default)]","rounded-[var(--primitive-radius-lg)]","overflow-hidden","flex flex-col","h-fit","max-h-[calc(100vh-2rem)]",...h?[V[ue||"top-left"]||V["top-left"]]:[]],Ce={...ge,width:me,...I&&{zIndex:I}},C=e.jsxs("div",{"data-figma-name":"[TDS] FloatingCard",className:je(he.join(" "),fe),style:Ce,...ve,children:[de&&j&&e.jsx("button",{type:"button",onClick:j,className:`
            ...
            z-10
          `,"aria-label":"Close",children:e.jsx(Ie,{size:12,stroke:1})}),e.jsxs("div",{className:"flex flex-col h-fit min-h-0 gap-0",children:[e.jsxs(Ne,{options:{overflow:{x:"hidden",y:"scroll"},scrollbars:{autoHide:"scroll",autoHideDelay:800}},defer:!1,className:"flex flex-col gap-4 shrink-0 m-4 rounded-md",style:{maxHeight:"340px",minHeight:"160px",padding:"16px",border:"1px solid var(--color-border-default)",background:"var(--color-surface-subtle)"},children:[e.jsx("h2",{className:"text-label-lg text-[var(--color-text-default)] shrink-0",children:o}),l&&l.length>0&&e.jsx("div",{className:"flex flex-col gap-6 w-full",children:l.map((t,s)=>{const i=t.items.length>0&&t.items.every(r=>r.status==="success"),S=t.showSuccessIcon&&i,w=t.collapsible??t.items.length>0,k=xe[s]??t.defaultExpanded??!0;return e.jsxs("div",{className:"flex flex-col gap-2 w-full",children:[w?e.jsxs("button",{type:"button",onClick:()=>be(s),className:"flex items-center justify-between w-full rounded px-2 -mx-2 py-1 transition-colors duration-[var(--duration-fast)] group cursor-pointer hover:bg-[var(--color-surface-muted)]",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[k?e.jsx(Te,{size:16,stroke:1,className:"text-[var(--color-text-muted)] group-hover:text-[var(--color-text-default)] transition-colors"}):e.jsx(Se,{size:16,stroke:1,className:"text-[var(--color-text-muted)] group-hover:text-[var(--color-text-default)] transition-colors"}),e.jsx("span",{className:"text-label-md text-[var(--color-text-default)]",children:t.tabTitle})]}),S&&e.jsx("span",{className:"text-[var(--color-state-success)]",children:e.jsx(q,{size:12,stroke:1})})]}):e.jsxs("div",{className:"flex items-center justify-between w-full",children:[e.jsx("span",{className:"text-label-md text-[var(--color-text-default)]",children:t.tabTitle}),S&&e.jsx("span",{className:"text-[var(--color-state-success)]",children:e.jsx(q,{size:12,stroke:1})})]}),w&&k&&t.items.length>0&&e.jsx("div",{className:"flex flex-col gap-1 pl-4 w-full",children:t.items.map(r=>e.jsxs("button",{type:"button",className:"flex items-center justify-between gap-2 w-full rounded px-2 -mx-2 py-1 transition-colors duration-[var(--duration-fast)] text-left group cursor-pointer hover:bg-[var(--color-surface-muted)]",onClick:r.onClick,disabled:!r.onClick,children:[e.jsx("span",{className:"text-body-sm text-[var(--color-text-subtle)] group-hover:text-[var(--color-text-default)] transition-colors",children:r.title}),r.status==="writing"?e.jsx("span",{className:"text-body-sm text-[var(--color-text-subtle)] shrink-0",children:"Writing..."}):e.jsx(ze,{status:r.status})]},r.id))})]},s)})})]}),y.length>0&&e.jsx("div",{className:"shrink-0 m-4 rounded-md",style:{padding:"16px",border:"1px solid var(--color-border-default)",background:"var(--color-surface-default)"},children:e.jsxs("div",{className:"flex flex-col items-start gap-3 w-full",children:[e.jsx("h3",{className:"text-label-md text-[var(--color-text-default)]",children:"Quota"}),e.jsx("div",{className:"flex flex-col gap-3 w-full",children:y.map((t,s)=>e.jsxs("div",{className:"flex flex-col gap-1 w-full",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-body-md text-[var(--color-text-default)]",children:t.label}),e.jsxs("span",{className:"text-body-md text-[var(--color-text-muted)]",children:[t.current,"/",t.total,t.unit?` ${t.unit}`:""]})]}),e.jsx(ke,{value:t.current,max:t.total,variant:"default",showValue:!1,className:"h-1"})]},s))})]})}),N&&e.jsxs("div",{className:"px-6 py-4 flex flex-col gap-2 shrink-0 bg-[var(--color-surface-default)]",children:[e.jsx("label",{className:"text-label-md text-[var(--color-text-default)]",children:"Number of Instances"}),e.jsx(Ee,{value:oe,onChange:t=>N(t),min:1,size:"sm",fullWidth:!0})]}),(x||b)&&e.jsxs("div",{className:"px-6 pb-6 pt-4 flex flex-row gap-2 shrink-0 bg-[var(--color-surface-default)]",children:[x&&e.jsx(A,{variant:"secondary",size:"md",onClick:x,className:"flex-[0.3]",children:ie}),b&&e.jsx(A,{variant:"primary",size:"md",onClick:b,disabled:!ce,className:"flex-[0.7]",children:ne})]})]})]});return h&&typeof document<"u"&&document.body?ye.createPortal(C,document.body):C}a.__docgenInfo={description:"",methods:[],displayName:"FloatingCard",props:{title:{required:!0,tsType:{name:"string"},description:""},sections:{required:!1,tsType:{name:"Array",elements:[{name:"FloatingCardSection"}],raw:"FloatingCardSection[]"},description:"",defaultValue:{value:"[]",computed:!1}},quota:{required:!1,tsType:{name:"Array",elements:[{name:"QuotaItem"}],raw:"QuotaItem[]"},description:"",defaultValue:{value:"[]",computed:!1}},instanceCount:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},onInstanceCountChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(count: number) => void",signature:{arguments:[{type:{name:"number"},name:"count"}],return:{name:"void"}}},description:""},cancelLabel:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'Cancel'",computed:!1}},actionLabel:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'Create'",computed:!1}},actionEnabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},onCancel:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onAction:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},position:{required:!1,tsType:{name:"union",raw:"'top-left' | 'top-right' | 'bottom-left' | 'bottom-right'",elements:[{name:"literal",value:"'top-left'"},{name:"literal",value:"'top-right'"},{name:"literal",value:"'bottom-left'"},{name:"literal",value:"'bottom-right'"}]},description:"",defaultValue:{value:"'top-left'",computed:!1}},showCloseButton:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},isOpen:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},zIndex:{required:!1,tsType:{name:"number"},description:""},portal:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},width:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'320px'",computed:!1}}},composes:["Omit"]};const tt={title:"Components/FloatingCard",component:a,tags:["autodocs"],parameters:{layout:"fullscreen",docs:{description:{component:`
## FloatingCard 컴포넌트
...
}`,...(z=(D=n.parameters)==null?void 0:D.docs)==null?void 0:z.source}}};var P,F,M;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
...
}`,...(G=(_=d.parameters)==null?void 0:_.docs)==null?void 0:G.source}}};var H,O,U;p.parameters={...p.parameters,docs:{...(H=p.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: () => <div className="relative h-[500px] bg-[var(--color-surface-subtle)] p-[var(--primitive-spacing-4)]">
...
}`,...(U=(O=p.parameters)==null?void 0:O.docs)==null?void 0:U.source}}};var K,X,$;m.parameters={...m.parameters,docs:{...(K=m.parameters)==null?void 0:K.docs,source:{originalSource:`{
...
}`,...(le=(re=v.parameters)==null?void 0:re.docs)==null?void 0:le.source}}};const st=["Default","WithQuota","WithInstanceCount","AllStatuses","ActionEnabled","WithCloseButton","WritingStatus","DisabledAction","MultipleSections"];export{p as ActionEnabled,d as AllStatuses,n as Default,g as DisabledAction,v as MultipleSections,m as WithCloseButton,u as WithInstanceCount,c as WithQuota,f as WritingStatus,st as __namedExportsOrder,tt as default};
