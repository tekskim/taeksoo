import{r as M,j as e}from"./iframe-Dtaoqwlr.js";import{c as Y}from"./createReactComponent-oNNwel7Z.js";import{T as J,a as K,b as j}from"./Tabs-C4TTUHjH.js";import{C as Q}from"./Chip-DmCyc_hd.js";import{I as X}from"./IconChevronUp-DjJYUBnm.js";import{I as Z}from"./IconChevronDown-Cq_QoJmu.js";import{I as R}from"./IconCircleCheck-Bsleg1kJ.js";import{I as b}from"./IconAlertCircle-HopxCNfo.js";import"./preload-helper-C1FmrZbK.js";import"./bundle-mjs-BZSatpsL.js";import"./IconX-BLi4J-TN.js";/**
 ...
 */const ee=[["path",{d:"M9 11l3 3l8 -8",key:"svg-0"}],["path",{d:"M20 12v6a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h9",key:"svg-1"}]],ae=Y("outline","checkbox","Checkbox",ee),o=({notifications:a,onMarkAsRead:r,onMarkAllAsRead:n,onNotificationClick:l,selectedId:c,onClose:i,className:d=""})=>{const[s,u]=M.useState("all"),p=a.filter(t=>s==="all"?!0:s==="unread"?!t.isRead:s==="error"?t.type==="error":!0),m=a.filter(t=>!t.isRead).length,A=a.filter(t=>t.type==="error").length;return e.jsxs("div",{className:`
      ...
      `,children:[e.jsxs("div",{onClick:()=>{a.isRead||n==null||n(a.id),l==null||l(a)},className:"flex gap-3 p-3 cursor-pointer",children:[e.jsx("div",{className:"shrink-0 pt-0.5",children:d(a.type)}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:"text-body-lg text-[var(--color-text-default)] mb-2 pr-6",children:a.message}),a.project&&e.jsx(Q,{value:a.project,variant:"default"})]}),e.jsxs("div",{className:"shrink-0 flex flex-col items-end gap-1",children:[e.jsx("div",{className:"size-6 flex items-center justify-center",children:!a.isRead&&e.jsx("div",{className:"size-2 rounded-full bg-[var(--color-action-primary)]"})}),e.jsx("span",{className:"text-body-md text-[var(--color-text-muted)]",children:a.time})]})]}),s&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",onClick:m=>{m.stopPropagation(),i(!c)},className:`
