import{r as M,j as e}from"./iframe-DKmDJy9M.js";import{c as Y}from"./createReactComponent-DB1W9lnY.js";import{T as J,a as K,b as j}from"./Tabs-DMGje0WM.js";import{C as Q}from"./Chip-4dNWv0eR.js";import{I as X}from"./IconChevronUp-BdMlYp_W.js";import{I as Z}from"./IconChevronDown-Dv8nCHc9.js";import{I as R}from"./IconCircleCheck-BHpyk4lL.js";import{I as b}from"./IconAlertCircle-CDlbxW3e.js";import"./preload-helper-C1FmrZbK.js";import"./bundle-mjs-BZSatpsL.js";import"./IconX-D1qmt8Yz.js";/**
 ...
 */const ee=[["path",{d:"M9 11l3 3l8 -8",key:"svg-0"}],["path",{d:"M20 12v6a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h9",key:"svg-1"}]],ae=Y("outline","checkbox","Checkbox",ee),o=({notifications:a,onMarkAsRead:r,onMarkAllAsRead:n,onNotificationClick:l,selectedId:c,onClose:i,className:d=""})=>{const[s,u]=M.useState("all"),p=a.filter(t=>s==="all"?!0:s==="unread"?!t.isRead:s==="error"?t.type==="error":!0),m=a.filter(t=>!t.isRead).length,A=a.filter(t=>t.type==="error").length;return e.jsxs("div",{className:`
      ...
      `,children:[e.jsxs("div",{onClick:()=>{a.isRead||n==null||n(a.id),l==null||l(a)},className:"flex gap-3 p-3 cursor-pointer",children:[e.jsx("div",{className:"shrink-0 pt-0.5",children:d(a.type)}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:"text-[13px] leading-[18px] text-[var(--color-text-default)] mb-2 pr-6",children:a.message}),a.project&&e.jsx(Q,{value:a.project,variant:"default"})]}),e.jsxs("div",{className:"shrink-0 flex flex-col items-end gap-1",children:[e.jsx("div",{className:"size-6 flex items-center justify-center",children:!a.isRead&&e.jsx("div",{className:"size-2 rounded-full bg-[var(--color-action-primary)]"})}),e.jsx("span",{className:"text-[12px] text-[var(--color-text-muted)]",children:a.time})]})]}),s&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",onClick:m=>{m.stopPropagation(),i(!c)},className:`
...
}`,...(I=(w=g.parameters)==null?void 0:w.docs)==null?void 0:I.source}}};var S,E,z;f.parameters={...f.parameters,docs:{...(S=f.parameters)==null?void 0:S.docs,source:{originalSource:`{
...
}`,...(z=(E=f.parameters)==null?void 0:E.docs)==null?void 0:z.source}}};var D,T,P;x.parameters={...x.parameters,docs:{...(D=x.parameters)==null?void 0:D.docs,source:{originalSource:`{
...
}`,...(P=(T=x.parameters)==null?void 0:T.docs)==null?void 0:P.source}}};var _,L,q;h.parameters={...h.parameters,docs:{...(_=h.parameters)==null?void 0:_.docs,source:{originalSource:`{
...
}`,...(q=(L=h.parameters)==null?void 0:L.docs)==null?void 0:q.source}}};var $,H,O;k.parameters={...k.parameters,docs:{...($=k.parameters)==null?void 0:$.docs,source:{originalSource:`{
...
}`,...(O=(H=k.parameters)==null?void 0:H.docs)==null?void 0:O.source}}};var F,U,B;v.parameters={...v.parameters,docs:{...(F=v.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => <NotificationCenter notifications={[{
    id: '1',
    type: 'error',
...
}`,...(W=(V=y.parameters)==null?void 0:V.docs)==null?void 0:W.source}}};const fe=["Default","Interactive","EmptyState","AllRead","OnlyErrors","WithDetails","ManyNotifications"];export{h as AllRead,g as Default,x as EmptyState,f as Interactive,y as ManyNotifications,k as OnlyErrors,v as WithDetails,fe as __namedExportsOrder,ge as default};
