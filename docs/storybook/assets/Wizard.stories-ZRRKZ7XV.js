import{j as e}from"./iframe-DKmDJy9M.js";import{S as t}from"./SectionCard-BBeHjQWF.js";import{B as g}from"./Button-BjRr-4Eh.js";import{I as S}from"./IconEdit-BlS-DZQj.js";import{I as Q}from"./IconCheck-CawMNeCL.js";import{c as X}from"./createReactComponent-DB1W9lnY.js";import{I as Y}from"./IconMinus-BpH-r4mg.js";import{H as Z,V as v}from"./Stack-DpH1vEn8.js";import"./preload-helper-C1FmrZbK.js";import"./bundle-mjs-BZSatpsL.js";import"./chunk-JZWAC4HX-CgUIFJCZ.js";/**
 * @license @tabler/icons-react v3.36.1 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const $=[["path",{d:"M10 20.777a8.942 8.942 0 0 1 -2.48 -.969",key:"svg-0"}],["path",{d:"M14 3.223a9.003 9.003 0 0 1 0 17.554",key:"svg-1"}],["path",{d:"M4.579 17.093a8.961 8.961 0 0 1 -1.227 -2.592",key:"svg-2"}],["path",{d:"M3.124 10.5c.16 -.95 .468 -1.85 .9 -2.675l.169 -.305",key:"svg-3"}],["path",{d:"M6.907 4.579a8.954 8.954 0 0 1 3.093 -1.356",key:"svg-4"}]],C=X("outline","progress","Progress",$);function r({status:a}){return a==="done"?e.jsx("div",{className:"w-4 h-4 shrink-0 rounded-full bg-[var(--color-state-success)] flex items-center justify-center",children:e.jsx(Q,{size:10,stroke:2.5,className:"text-white"})}):a==="active"?e.jsx("div",{className:"w-4 h-4 shrink-0",children:e.jsx(C,{size:16,stroke:1.5,className:"text-[var(--color-text-subtle)] animate-spin"})}):a==="writing"?e.jsx("div",{className:"w-4 h-4 shrink-0",children:e.jsx(C,{size:16,stroke:1.5,className:"text-[var(--color-text-subtle)] animate-spin"})}):a==="skipped"?e.jsx("div",{className:"w-4 h-4 shrink-0",children:e.jsx(Y,{size:16,stroke:1.5,className:"text-[var(--color-text-subtle)]"})}):e.jsx("div",{className:"w-4 h-4 shrink-0 rounded-full border border-[var(--color-border-default)]"})}function f({title:a}){return e.jsx("div",{className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-lg px-4 py-3",children:e.jsx("div",{className:"h-8 flex items-center",children:e.jsx("h5",{className:"text-[length:var(--font-size-16)] font-semibold leading-[var(--line-height-24)] text-[var(--color-text-default)]",children:a})})})}function h({title:a,onEdit:s}){return e.jsx("div",{className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-lg px-4 py-3",children:e.jsxs("div",{className:"h-8 flex items-center justify-between",children:[e.jsx("h5",{className:"text-[length:var(--font-size-16)] font-semibold leading-[var(--line-height-24)] text-[var(--color-text-default)]",children:a}),s?e.jsxs(Z,{gap:3,align:"center",children:[e.jsx("span",{className:"text-[11px] text-[var(--color-text-subtle)]",children:"Writing..."}),e.jsx(g,{variant:"outline",size:"sm",leftIcon:e.jsx(S,{size:12}),onClick:s,children:"Edit"})]}):e.jsx("span",{className:"text-[11px] text-[var(--color-text-subtle)]",children:"Writing..."})]})})}function j({title:a,onEdit:s}){return e.jsx("div",{className:"bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-lg px-4 py-3",children:e.jsxs("div",{className:"flex items-center justify-between h-8",children:[e.jsx("h5",{className:"text-[length:var(--font-size-16)] font-semibold leading-[var(--line-height-24)] text-[var(--color-text-default)]",children:a}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"text-[length:var(--font-size-12)] leading-[var(--line-height-18)] text-[var(--color-text-muted)]",children:"Not configured"}),e.jsx(g,{variant:"outline",size:"sm",leftIcon:e.jsx(S,{size:12}),onClick:s,children:"Edit"})]})]})})}function w({title:a,onEdit:s,children:n}){return e.jsxs(t,{children:[e.jsx(t.Header,{title:a,showDivider:!0,actions:e.jsx(g,{variant:"outline",size:"sm",leftIcon:e.jsx(S,{size:12}),onClick:s,children:"Edit"})}),e.jsx(t.Content,{children:n})]})}function i({title:a,status:s,onEdit:n,summaryContent:K,children:L}){switch(s){case"pre":return e.jsx(f,{title:a});case"writing":return e.jsx(h,{title:a});case"skipped":return e.jsx(j,{title:a,onEdit:n||(()=>{})});case"done":return e.jsx(w,{title:a,onEdit:n||(()=>{}),children:K});case"active":default:return e.jsx(e.Fragment,{children:L})}}r.__docgenInfo={description:"",methods:[],displayName:"WizardSectionStatusIcon",props:{status:{required:!0,tsType:{name:"union",raw:"'pre' | 'active' | 'done' | 'skipped' | 'writing'",elements:[{name:"literal",value:"'pre'"},{name:"literal",value:"'active'"},{name:"literal",value:"'done'"},{name:"literal",value:"'skipped'"},{name:"literal",value:"'writing'"}]},description:""}}};f.__docgenInfo={description:"",methods:[],displayName:"PreSection",props:{title:{required:!0,tsType:{name:"string"},description:""}}};h.__docgenInfo={description:"",methods:[],displayName:"WritingSection",props:{title:{required:!0,tsType:{name:"string"},description:""},onEdit:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};j.__docgenInfo={description:"",methods:[],displayName:"SkippedSection",props:{title:{required:!0,tsType:{name:"string"},description:""},onEdit:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};w.__docgenInfo={description:"",methods:[],displayName:"DoneSection",props:{title:{required:!0,tsType:{name:"string"},description:""},onEdit:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};i.__docgenInfo={description:`WizardSection - 마법사(Wizard) 패턴의 섹션 컴포넌트
...
- writing: 작성 중 (회전 아이콘, Writing... 표시)`,methods:[],displayName:"WizardSection",props:{title:{required:!0,tsType:{name:"string"},description:""},status:{required:!0,tsType:{name:"union",raw:"'pre' | 'active' | 'done' | 'skipped' | 'writing'",elements:[{name:"literal",value:"'pre'"},{name:"literal",value:"'active'"},{name:"literal",value:"'done'"},{name:"literal",value:"'skipped'"},{name:"literal",value:"'writing'"}]},description:""},onEdit:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},summaryContent:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Content to show when status is 'done'"},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Content to show when status is 'active'"}}};const pe={title:"Components/Wizard",component:i,tags:["autodocs"],decorators:[a=>e.jsx("div",{className:"max-w-2xl",children:e.jsx(a,{})})],parameters:{docs:{description:{component:`
## Wizard 컴포넌트
...
}`,...(P=(T=d.parameters)==null?void 0:T.docs)==null?void 0:P.source}}};var q,_,A;p.parameters={...p.parameters,docs:{...(q=p.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: 'Done Section',
...
}`,...(A=(_=p.parameters)==null?void 0:_.docs)==null?void 0:A.source}}};var B,M,V;m.parameters={...m.parameters,docs:{...(B=m.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: 'All States',
  render: () => <VStack gap={4}>
...
}`,...(V=(M=m.parameters)==null?void 0:M.docs)==null?void 0:V.source}}};var H,F,O;u.parameters={...u.parameters,docs:{...(H=u.parameters)==null?void 0:H.docs,source:{originalSource:`{
...
}`,...(O=(F=u.parameters)==null?void 0:F.docs)==null?void 0:O.source}}};var U,G,J;x.parameters={...x.parameters,docs:{...(U=x.parameters)==null?void 0:U.docs,source:{originalSource:`{
...
}`,...(J=(G=x.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};const me=["StatusIcons","PreSectionExample","WritingSectionExample","SkippedSectionExample","DoneSectionExample","AllStates","FullWizardExample","WithSkippedSteps"];export{m as AllStates,p as DoneSectionExample,u as FullWizardExample,c as PreSectionExample,d as SkippedSectionExample,o as StatusIcons,x as WithSkippedSteps,l as WritingSectionExample,me as __namedExportsOrder,pe as default};
