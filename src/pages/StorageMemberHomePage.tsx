...
import { StorageMemberSidebar } from '@/components/StorageMemberSidebar';
...
export function StorageMemberHomePage() {
  ...
  const requestsSeries: LineChartSeries[] = [
    { name: 'Requests', data: [120, 185, 240, 310, 275, 195], color: chartColors.cyan400 },
  ];

  // Mock data for Latency chart
  const latencyDetailSeries: LineChartSeries[] = [
    { name: 'GET', data: [12, 18, 32, 45, 38, 28], color: chartColors.cyan400 },
    { name: 'PUT', data: [15, 22, 38, 52, 44, 35], color: chartColors.emerald400 },
  ];

  // Mock data for Recovery Throughput chart
  const recoveryThroughputSeries: LineChartSeries[] = [
    { name: 'Recovery', data: [5, 12, 28, 42, 35, 18], color: chartColors.cyan400 },
  ];

  return (
    <PageShell
      sidebar={
        <StorageMemberSidebar
          isOpen={sidebarOpen}
      ...
      <div className="py-2">
        ...
        <div className="grid grid-cols-3 gap-6 mb-6">
          ...
          <Card title="Inventory" className="flex flex-col">
            {/* Total */}
            <div className="mb-4">
              <div className="text-heading-h2 text-[var(--color-text-default)]">4</div>
          ...
          {/* USED CAPACITY */}
          <Card title="Used capacity" className="flex flex-col">
            <div className="flex-1 flex flex-col items-center justify-center">
              <div className="text-[var(--color-text-default)]">
                <span className="text-heading-h1">383.7</span>
                <span className="text-heading-h4 ml-1">GiB</span>
              </div>
            </div>
          </Card>

          {/* AVERAGE OBJECT SIZE */}
          <Card title="Average object size" className="flex flex-col">
            <div className="flex-1 flex flex-col items-center justify-center">
              <div className="text-[var(--color-text-default)]">
                <span className="text-heading-h1">19.6</span>
                <span className="text-heading-h4 ml-1">MiB</span>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="p-4 rounded-2xl border border-[var(--color-border-default)] bg-[var(--color-surface-default)]">
          ...
          <div className="flex items-center justify-between mb-6">
            <h6 className="text-heading-h6">Object performance statistics</h6>
            <MonitoringToolbar
              timeRange={timeRange}
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            {/* Latency (Client/HTTP) Chart */}
            <LineChart
              title="Latency (Client/HTTP)"
...
export default StorageMemberHomePage;
