      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed z-[2001] bg-[var(--color-surface-default)] rounded-xl shadow-2xl flex flex-col overflow-hidden"
            style={windowStyle}
            onClick={(e) => {
              e.stopPropagation();
              setIsFocused(true);
                    ...
                    <SectionCard className="mb-6 min-w-[600px]" isActive={isEditingPassword}>
                      ...
                      <SectionCard.Content>
                        ...
                        <div className="flex flex-col gap-3 w-full">
                          ...
                          <div className="flex items-center justify-between p-3 rounded-md bg-[var(--color-surface-subtle)]">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <p className="text-body-md text-[var(--color-text-default)] pt-0.5">
                  Install a compatible application such as Google or Microsoft Authenticator app on
              ...
              <div className="flex gap-3">
                ...
                <div className="space-y-3 flex-1">
                  <p className="text-body-md text-[var(--color-text-default)] pt-0.5">
                    Enter the 6-digit verification code generated by your authenticator app to
                    complete the setup.
                  </p>
