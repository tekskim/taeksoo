          ...
          >
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <p className="text-body-md text-[var(--color-text-default)]">
                  2. Open your authenticator app and scan the QR code below, or enter the code
                  manually.
                </p>
              ...
              <div className="space-y-3">
                <p className="text-body-md text-[var(--color-text-default)]">
                  3. Enter the 6-digit verification code generated by your authenticator app to
                  complete the setup.
                </p>
