...
const tokenComparisons: TokenComparison[] = [
  ...
  // Spacing (TDS uses px for consistent sizing)
  {
    category: 'Spacing',
    token: '--primitive-spacing-0',
    tdsValue: '0',
    productionValue: '0',
    status: 'match',
  },
  ...
  // Radius (TDS uses px for consistent sizing)
  {
    category: 'Radius',
...
const componentComparisons: ComponentComparison[] = [
  // Form Controls
  {
    ...
    notes: 'size: xs/sm/md/lg, variant: primary/secondary/muted/ghost/outline/danger/warning/link',
  },
  {
    name: 'Input',
    tdsStatus: 'available',
  ...
  },
  {
    ...
    tdsStatus: 'available',
    productionStatus: 'available',
    notes: 'Compound: Label/Control/HelperText/ErrorMessage, spacing gap-1.5(6px)',
  },
  // Data Display
  {
    name: 'Table',
  ...
  // Overlay / Feedback
  {
    ...
    tdsStatus: 'available',
    productionStatus: 'available',
    notes: 'size: sm/md/lg, radius: 16px, padding: 24px',
  },
  {
    name: 'Drawer',
    tdsStatus: 'available',
    productionStatus: 'available',
    notes: 'width: 376(form)/696(selection), footer prop',
  },
  ...
  // TDS 전용 컴포넌트
  {
    ...
    notes: 'Compound: Header/Content/DataRow, 상세페이지 섹션',
  },
  {
    name: 'DetailHeader',
    tdsStatus: 'available',
    productionStatus: 'missing',
    notes: 'Compound: Title/Actions/InfoGrid/InfoCard, 상세페이지 헤더',
  },
  {
    name: 'ListToolbar',
    tdsStatus: 'available',
    productionStatus: 'missing',
    notes: 'primaryActions/bulkActions/filters, 리스트 페이지 툴바',
  },
  {
