...
function ColorCard({ color }: { color: ColorSwatch }) {
  ...
  return (
    <div className="group relative">
      {/* Color Swatch */}
      <div className="h-20 rounded-t-lg border border-white/10 transition-transform group-hover:scale-[1.02]"
      ...
      <div className="bg-neutral-900 rounded-b-lg p-3 border border-t-0 border-white/10">
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center justify-between text-xs">
            ...
            <code className="text-neutral-300 font-mono text-body-xs">{color.rgb}</code>
          </div>
          <div className="text-body-xs text-neutral-500 mt-2">{color.usage}</div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="w-52 bg-[#171717] border-r border-[#222222] py-2 rounded-l-lg flex flex-col">
      ...
      <div className="flex items-center gap-2 px-3 py-2 mb-1">
        <div className="w-5 h-5 rounded bg-gradient-to-br from-[#f87171] to-[#dc2626] flex items-center justify-center text-white text-body-xs font-bold">
          P </div>
      ...
      <div className="mt-4 px-2">
        <div className="text-label-sm text-[#4a4a4a] uppercase tracking-wider mb-1 px-2 ">
          Workspace </div>
  ...
  return (
    <div className="flex-1 bg-[#101010] rounded-r-lg flex flex-col">
      ...
      <div className="flex items-center gap-2 px-4 py-2 border-b border-[#222222]">
        <button className="flex items-center gap-1 px-2 py-1 text-body-md text-[#a1a1a1] hover:bg-[#262626] rounded">
          ...
          Filter </button>
        <button className="flex items-center gap-1 px-2 py-1 text-body-md text-[#a1a1a1] hover:bg-[#262626] rounded ml-auto">
          Display </button>
      </div>
      ...
      <div className="flex-1 p-2">
        ...
        <div className="flex items-center gap-2 px-2 py-1.5">
          ...
          <span className="text-[#4a4a4a] text-body-md">4</span>
        </div>
        ...
        <div className="space-y-0.5 mt-1">
          {issues.map((issue) => (
            ...
            >
              ...
              {/* Issue ID */}
              <span className="text-[#6b6b6b] text-body-md font-mono w-12">{issue.id}</span>
              {/* Status */}
              <div className="w-3.5 h-3.5 rounded-full border-2 border-[#6b6b6b]" />
              {/* Title */}
              <span className="text-[#f5f5f5] text-[13px] flex-1">{issue.title}</span>
              {/* Date */}
              <span className="text-[#4a4a4a] text-body-md">{issue.date}</span>
            </div>
          ))}
        </div>
      </div>
