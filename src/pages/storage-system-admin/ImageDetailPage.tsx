      ...
      <VStack gap={6}>
        ...
        <DetailHeader>
          ...
          <DetailHeader.InfoGrid>
            <DetailHeader.InfoCard label="Pool" value={`${imageData.domain}_${imageData.pool}`} />
            <DetailHeader.InfoCard label="Domain" value={imageData.domain} />
            <DetailHeader.InfoCard label="Size" value={imageData.size} copyable />
