                    ...
                    <Table
                      columns={[
                        ...
                        },
                        {
                          key: 'diskTag',
                          label: 'Disk tag',
                          flex: 1, minWidth: columnMinWidths.diskTag,
                        },
                        {
                          key: 'bootable',
                          label: 'Bootable',
                          flex: 1, minWidth: columnMinWidths.bootable,
                    ...
                    <Table
                      columns={[
                        ...
                        },
                        {
                          key: 'fixedIp',
                          label: 'Fixed IP',
                          flex: 1, minWidth: columnMinWidths.fixedIp,
                          render: (_value: string, iface: AttachedInterface) => (
                        ...
                        },
                        {
                          key: 'macAddress',
                          label: 'Mac address',
                          flex: 1, minWidth: columnMinWidths.macAddress,
                          render: (_value: string, iface: AttachedInterface) => (
                    ...
                    <Table<InstanceSnapshot>
                      columns={[
                        ...
                        },
                        {
                          key: 'diskFormat',
                          label: 'Disk format',
                          flex: 1, minWidth: columnMinWidths.diskFormat,
                          sortable: true,
                        },
                        {
                          key: 'createdAt',
