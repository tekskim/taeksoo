...
import { StorageDomainAdminSidebar } from '@/components/StorageDomainAdminSidebar';
...
export function StorageDomainAdminHomePage() {
      ...
      <div className="py-2">
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          ...
          <Card title="Inventory" className="flex flex-col">
            {/* Total */}
            <div className="mb-4">
              <div className="text-heading-h2 text-[var(--color-text-default)]">25</div>
          ...
          <Card title="Capacity" className="flex flex-col">
            <div className="flex-1 flex flex-col items-center justify-center">
              <div className="text-[var(--color-text-default)]">
                <span className="text-heading-h1">2.56</span>
                <span className="text-heading-h4 ml-1">TB</span>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="p-4 rounded-2xl border border-[var(--color-border-default)] bg-[var(--color-surface-default)]">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            {/* OSD Requests/sec Chart */}
            <LineChart
              title="OSD Requests/sec"
...
export default StorageDomainAdminHomePage;
