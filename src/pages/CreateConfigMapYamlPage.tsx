...
export function CreateConfigMapYamlPage() {
  ...
  // Update tab label
  useEffect(() => {
    updateActiveTabLabel('Create ConfigMap (YAML)');
  ...
  const handleCreate = useCallback(() => {
    // TODO: Implement actual configMap creation via API
    console.log('Creating configMap with YAML:', yamlContent);
    navigate('/container/configMaps');
            ...
            <VStack gap={6} className="flex-1 min-h-0">
              ...
              <VStack gap={2} className="flex-shrink-0">
                ...
                <p className="text-[11px] leading-[16px] text-[var(--color-text-subtle)]">
                  ConfigMap provide configuration data as key–value pairs so applications can load settings without changing container images.
                </p>
              </VStack>
...
export default CreateConfigMapYamlPage;
