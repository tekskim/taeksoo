...
export function CreateCronJobYamlPage() {
  ...
  // Update tab label
  useEffect(() => {
    updateActiveTabLabel('Create CronJob (YAML)');
  ...
  const handleCreate = useCallback(() => {
    // TODO: Implement actual cronjob creation via API
    console.log('Creating cronjob with YAML:', yamlContent);
    navigate('/container/cronjobs');
            ...
            <VStack gap={6} className="flex-1 min-h-0">
              ...
              <VStack gap={2} className="flex-shrink-0">
                ...
                <p className="text-[11px] leading-[16px] text-[var(--color-text-subtle)]">
                  Create a CronJob to run Jobs on a scheduled basis, automating recurring tasks with flexible timing and reliable execution.
                </p>
              </VStack>
...
export default CreateCronJobYamlPage;
