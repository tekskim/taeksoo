...
export function BucketsPage() {
  ...
  const columns: TableColumn<Bucket>[] = [
    ...
    },
    {
      key: 'owner',
      label: 'Owner',
      flex: 1, minWidth: columnMinWidths.owner,
      sortable: true,
    },
    {
      key: 'usedCapacity',
      label: 'Used capacity',
      flex: 1, minWidth: columnMinWidths.usedCapacity,
      sortable: true,
    },
    {
      key: 'capacityLimit',
      label: 'Capacity limit %',
      flex: 1, minWidth: columnMinWidths.capacityLimit,
      sortable: true,
    },
    {
      key: 'objects',
      label: 'Objects',
      flex: 1, minWidth: columnMinWidths.objects,
      sortable: true,
    },
    {
      key: 'objectLimit',
      label: 'Object limit %',
      flex: 1, minWidth: columnMinWidths.objectLimit,
      sortable: true,
    },
    {
      key: 'creationDate',
      label: 'CreationDate',
      flex: 1, minWidth: columnMinWidths.creationDate,
      sortable: true,
    },
    {
      key: 'action',
