  ...
  const columns: TableColumn<Bucket>[] = [
    {
      ...
      label: 'Name',
      flex: 1,
      minWidth: columnWidths.nameWide,
      sortable: true,
    ...
    },
    {
      key: 'usedCapacity',
      label: 'Used capacity',
      width: columnWidths.usedCapacity,
      sortable: true,
    },
    {
      key: 'capacityLimit',
      label: 'Capacity limit %',
      width: columnWidths.capacityLimit,
      sortable: true,
    },
    {
      key: 'objects',
      label: 'Objects',
      width: columnWidths.objects,
      sortable: true,
    },
    {
      key: 'objectLimit',
      label: 'Object limit %',
      width: columnWidths.objectLimit,
      sortable: true,
    },
    {
      key: 'creationDate',
      label: 'CreationDate',
      width: columnWidths.creationDate,
      sortable: true,
    },
    {
      key: 'action',
