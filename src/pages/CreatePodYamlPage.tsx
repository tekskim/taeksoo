...
export function CreatePodYamlPage() {
  ...
  // Update tab label
  useEffect(() => {
    updateActiveTabLabel('Create Pod (YAML)');
  ...
  const handleCreate = useCallback(() => {
    // TODO: Implement actual pod creation via API
    console.log('Creating pod with YAML:', yamlContent);
    navigate('/container/pods');
            ...
            <VStack gap={6} className="flex-1 min-h-0">
              ...
              <VStack gap={2} className="flex-shrink-0">
                ...
                <p className="text-[11px] leading-[16px] text-[var(--color-text-subtle)]">
                  Create a Kubernetes Pod by defining its containers, configuration to run workloads within your cluster.
                </p>
              </VStack>
...
export default CreatePodYamlPage;
