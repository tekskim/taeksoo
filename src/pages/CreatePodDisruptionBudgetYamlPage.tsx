...
export function CreatePodDisruptionBudgetYamlPage() {
  ...
  const handleCancel = useCallback(() => {
    navigate('/container/podDisruptionBudgets');
  }, [navigate]);

  // Handle create
  const handleCreate = useCallback(() => {
    // TODO: Implement actual podDisruptionBudget creation via API
    console.log('Creating podDisruptionBudget with YAML:', yamlContent);
    navigate('/container/podDisruptionBudgets');
            ...
            <VStack gap={6} className="flex-1 min-h-0">
              ...
              <VStack gap={2} className="flex-shrink-0">
                ...
                <p className="text-[11px] leading-[16px] text-[var(--color-text-subtle)]">
                  Pod Disruption Budget defines the minimum number of pods that must remain available during voluntary disruptions to ensure application stability.
                </p>
              </VStack>
...
export default CreatePodDisruptionBudgetYamlPage;
