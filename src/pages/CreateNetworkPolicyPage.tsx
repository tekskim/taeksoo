...
interface BasicInfoSectionProps {
  ...
  onNetworkPolicyNameChange: (value: string) => void;
  networkPolicyNameError: string | null;
  onNetworkPolicyNameErrorChange: (error: string | null) => void;
  namespace: string;
...
function BasicInfoSection({
  networkPolicyName,
  onNetworkPolicyNameChange,
  networkPolicyNameError,
  onNetworkPolicyNameErrorChange,
  namespace,
  onNamespaceChange,
  description,
  onDescriptionChange,
  ...
  const handleNext = () => {
    if (!networkPolicyName.trim()) {
      onNetworkPolicyNameErrorChange('Limit range name is required.');
      return;
    }
    onNetworkPolicyNameErrorChange(null);
    onNext();
  };
        ...
        <VStack gap={4}>
          ...
          <VStack gap={2}>
            ...
            <Input
              ...
              onChange={(e) => {
                onNetworkPolicyNameChange(e.target.value);
                if (networkPolicyNameError) onNetworkPolicyNameErrorChange(null);
              }}
...
/* ----------------------------------------
   Types for Ingress Rules Section
   ---------------------------------------- */
...
/* ----------------------------------------
   IngressRulesSection Component
   ---------------------------------------- */

interface IngressRulesSectionProps {
  ingressRules: IngressRule[];
  onIngressRulesChange: (rules: IngressRule[]) => void;
  ingressEnabled: boolean;
  onIngressEnabledChange: (enabled: boolean) => void;
  onNext: () => void;
  isEditing: boolean;
  onEditCancel: () => void;
  onEditDone: () => void;
...
function IngressRulesSection({
  ingressRules,
  onIngressRulesChange,
  ingressEnabled,
  onIngressEnabledChange,
  onNext,
  isEditing,
  onEditCancel,
  onEditDone,
}: IngressRulesSectionProps) {
  ...
  const addRule = () => {
    ...
    onIngressRulesChange([...ingressRules, newRule]);
  ...
  // Remove target from active rule
  ...
  // Update target in active rule
  const updateTarget = (targetId: string, field: keyof IngressTarget, value: string) => {
    const newRules = [...ingressRules];
    newRules[activeRuleIndex] = {
      ...newRules[activeRuleIndex],
  ...
  // Add allowed port to active rule
  ...
  // Remove allowed port from active rule
  ...
  // Update allowed port in active rule
      ...
      <SectionCard.Content>
        <VStack gap={6}>
          ...
          <Checkbox
            ...
            onChange={onIngressEnabledChange}
              ...
              <div className="flex flex-col gap-2 shrink-0">
                <div className="flex flex-col">
                  {ingressRules.map((rule, index) => (
                    ...
                    >
                      <span className="text-label-md px-1">{rule.name}</span>
                ...
                <button
                  onClick={addRule}
                  className="flex items-center gap-1 px-2 py-1 text-label-md text-[var(--color-text-subtle)] hover:text-[var(--color-text-default)]"
                >
...
export function CreateNetworkPolicyPage() {
  ...
  const handleCreate = useCallback(() => {
    ...
    if (!networkPolicyName.trim()) {
      setNetworkPolicyNameError('Limit range name is required.');
      setSectionStatus((prev) => ({
        ...prev,
        'basic-info': 'active',
      }));
                ...
                <VStack gap={4} className="flex-1">
                  ...
                  {sectionStatus['basic-info'] === 'active' && (
                    <BasicInfoSection
                      ...
                      onNetworkPolicyNameChange={setNetworkPolicyName}
                      networkPolicyNameError={networkPolicyNameError}
                      onNetworkPolicyNameErrorChange={setNetworkPolicyNameError}
                      namespace={namespace}
                  ...
                  {sectionStatus['data'] === 'active' && (
                    <IngressRulesSection
                      ...
                      onIngressRulesChange={setIngressRules}
                      ingressEnabled={ingressEnabled}
                      onIngressEnabledChange={setIngressEnabled}
