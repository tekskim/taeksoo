...
import { AIPlatformSidebar } from './AIPlatformPage';
...
export function WorkloadDetailPage() {
  ...
  return (
    <div className="fixed inset-0 bg-[var(--color-surface-subtle)]">
      ...
      {/* Main Content */}
      <main className="absolute top-0 bottom-0 right-0 left-[220px] flex flex-col bg-[var(--color-surface-default)]">
        {/* Fixed Header Area */}
        <div className="shrink-0 bg-[var(--color-surface-default)]">
          ...
          <TopBar
            ...
            breadcrumb={
              <Breadcrumb
                items={[
                  { label: 'Pods', href: '/ai-platform/workloads' },
                  { label: workload.name },
                ]}
              />
            }
                  ...
                  <TabPanel value="terminal" className="pt-0">
                    <div className="pt-6">
                      <div className="bg-[#1e1e1e] rounded-lg p-4 font-mono text-body-md text-[#d4d4d4] h-[400px] overflow-auto">
                        ...
                        <p className="text-[#808080] text-center mt-20">
                          Click to connect to terminal
                        </p>
                      </div>
                    </div>
                  </TabPanel>
