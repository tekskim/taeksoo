...
export function CreateNetworkPolicyYamlPage() {
  ...
  // Update tab label
  useEffect(() => {
    updateActiveTabLabel('Create NetworkPolicy (YAML)');
  ...
  const handleCancel = useCallback(() => {
    navigate('/container/networkPolicys');
  }, [navigate]);

  // Handle create
  const handleCreate = useCallback(() => {
    // TODO: Implement actual networkPolicy creation via API
    console.log('Creating networkPolicy with YAML:', yamlContent);
    navigate('/container/networkPolicys');
            ...
            <VStack gap={6} className="flex-1 min-h-0">
              ...
              <VStack gap={2} className="flex-shrink-0">
                ...
                <p className="text-[11px] leading-[16px] text-[var(--color-text-subtle)]">
                  Network Policy defines how groups of pods are allowed to communicate with each other and with external endpoints, providing fine-grained control over network traffic within the cluster.
                </p>
              </VStack>
...
export default CreateNetworkPolicyYamlPage;
