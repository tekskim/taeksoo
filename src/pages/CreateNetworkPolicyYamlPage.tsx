            ...
            <VStack gap={6} className="flex-1 min-h-0">
              ...
              <VStack gap={2} className="flex-shrink-0">
                ...
                <p className="text-body-sm text-[var(--color-text-subtle)]">
                  Network Policy defines how groups of pods are allowed to communicate with each
                  other and with external endpoints, providing fine-grained control over network
