...
import { IconBell, IconSearch, IconRefresh, IconGitBranch } from '@tabler/icons-react';
    ...
    <div className="fixed inset-0 bg-[var(--color-surface-subtle)]">
      ...
      >
        ...
        <TopBar
          ...
          breadcrumb={
            <Breadcrumb
              items={[{ label: 'AI Platform' }, { label: 'Operations' }, { label: 'Dependencies' }]}
            />
          }
          actions={
            <>
          ...
          <div className="pt-3 px-8 pb-20 bg-[var(--color-surface-subtle)] min-h-full">
            <VStack gap={6}>
              <HStack justify="between" align="center">
                <VStack gap={1}>
                  <h1 className="text-heading-h3 text-[var(--color-text-default)]">Dependencies</h1>
                  <p className="text-body-lg text-[var(--color-text-subtle)]">
                    Manage system dependencies and integrations.
                  </p>
                </VStack>
