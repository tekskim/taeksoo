          ...
          <div className="pt-3 px-8 pb-20 bg-[var(--color-surface-subtle)] min-h-full">
            <VStack gap={6}>
              <HStack justify="between" align="center">
                <VStack gap={1}>
                  <h1 className="text-[24px] font-semibold text-[var(--color-text-default)]">Settings</h1>
                  <p className="text-[14px] text-[var(--color-text-subtle)]">Configure AI Platform settings and preferences.</p>
                </VStack>
                <Button variant="secondary" size="sm" icon={<IconRefresh size={14} stroke={1.5} />}>Refresh</Button>
              </HStack>
              <EmptyState icon={<IconSettings size={48} stroke={1} />} title="Settings" description="Platform settings and configurations will appear here." />
            </VStack>
          </div>
        </div>
      </main>
