    ...
    <div className="fixed inset-0 bg-[var(--color-surface-subtle)]">
      ...
      <main className="absolute top-0 bottom-0 right-0 flex flex-col bg-[var(--color-surface-default)] transition-[left] duration-200" style={{ left: `${sidebarWidth}px` }}>
        ...
        <TopBar
          ...
          breadcrumb={<Breadcrumb items={[{ label: 'AI Platform' }, { label: 'Infrastructure' }, { label: 'Workloads' }]} />}
          actions={
            <>
          ...
          <div className="pt-3 px-8 pb-20 bg-[var(--color-surface-subtle)] min-h-full">
            <VStack gap={6}>
              <HStack justify="between" align="center">
                <VStack gap={1}>
                  <h1 className="text-[24px] font-semibold text-[var(--color-text-default)]">Workloads</h1>
                  <p className="text-[14px] text-[var(--color-text-subtle)]">Deploy and manage workloads on the cluster.</p>
                </VStack>
                <HStack gap={2}>
