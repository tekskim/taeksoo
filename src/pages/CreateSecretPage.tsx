...
export function CreateSecretPage() {
  ...
  const basicInfoComplete =
    secretName.trim().length > 0 && (secretType !== 'custom' || customType.trim().length > 0);
                    ...
                    <SectionCard.Content>
                      <VStack gap={4}>
                        ...
                        <VStack gap={2}>
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              if (secretNameError) setSecretNameError(null);
                            }}
                        ...
                        <VStack gap={3}>
                          <button
                            type="button"
                            className="flex items-center gap-1.5 text-[14px] font-medium text-[var(--color-text-default)] leading-[20px]"
