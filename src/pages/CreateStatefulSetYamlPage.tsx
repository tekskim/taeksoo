...
export function CreateStatefulSetYamlPage() {
  ...
  // Update tab label
  useEffect(() => {
    updateActiveTabLabel('Create StatefulSet (YAML)');
  ...
  const handleCreate = useCallback(() => {
    // TODO: Implement actual statefulset creation via API
    console.log('Creating statefulset with YAML:', yamlContent);
    navigate('/container/statefulsets');
            ...
            <VStack gap={6} className="flex-1 min-h-0">
              ...
              <VStack gap={2} className="flex-shrink-0">
                ...
                <p className="text-[11px] leading-[16px] text-[var(--color-text-subtle)]">
                  Create a StatefulSet to deploy and manage stateful applications with stable network identities and persistent storage.
                </p>
              </VStack>
...
export default CreateStatefulSetYamlPage;
