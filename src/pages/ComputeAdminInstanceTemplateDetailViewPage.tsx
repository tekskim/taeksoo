...
export function ComputeAdminInstanceTemplateDetailViewPage() {
      ...
      >
        <VStack gap={4} className="pt-8">
          ...
          <Button
            variant="secondary"
            size="md"
            onClick={() => navigate('/compute-admin/instance-templates')}
          >
            Back to templates
          </Button>
        </VStack>
        ...
        <DetailHeader>
          ...
          <DetailHeader.Actions>
            <Button
              ...
              onClick={() => navigate(`/compute-admin/instance-templates/${id}/edit`)}
            >
              Edit
            </Button>
            <Button
...
export default ComputeAdminInstanceTemplateDetailViewPage;
