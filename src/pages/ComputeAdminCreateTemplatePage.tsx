...
const mockImages: ImageRow[] = [
  { id: 'e920j30d', status: 'active', name: 'ubuntu-24.04-tk-base', version: '24.04', size: '709.98 MiB', minDisk: '10.00 MiB', minRam: '0 MiB', access: 'Public', os: 'ubuntu', createdAt: '2025-01-15' },
  { id: 'e920j31d', status: 'active', name: 'ubuntu-24.04-tk-base', version: '24.04', size: '709.98 MiB', minDisk: '10.00 MiB', minRam: '0 MiB', access: 'Public', os: 'ubuntu', createdAt: '2025-01-14' },
  { id: 'e920j32d', status: 'active', name: 'ubuntu-24.04-tk-base', version: '24.04', size: '709.98 MiB', minDisk: '10.00 MiB', minRam: '0 MiB', access: 'Public', os: 'ubuntu', createdAt: '2025-01-13' },
  { id: 'e920j35d', status: 'active', name: 'ubuntu-22.04-tk-base', version: '22.04', size: '650.12 MiB', minDisk: '10.00 MiB', minRam: '0 MiB', access: 'Public', os: 'ubuntu', createdAt: '2025-01-10' },
  { id: 'e920j37d', status: 'active', name: 'windows-server-2022', version: '2022', size: '4.5 GiB', minDisk: '40.00 GiB', minRam: '2 GiB', access: 'Public', os: 'windows', createdAt: '2025-01-08' },
  { id: 'e920j39d', status: 'active', name: 'rocky-9.3-tk-base', version: '9.3', size: '890.23 MiB', minDisk: '10.00 MiB', minRam: '0 MiB', access: 'Public', os: 'rocky', createdAt: '2025-01-05' },
];
      ...
      <SectionCard.Content gap={6} className="pt-2">
        ...
        {!isFavorite && (
          <VStack gap={4}>
            ...
            <Table<Tenant>
              columns={[
                ...
                },
                {
                  ...
                  align: 'center',
                  render: (_, row) => (
                    <StatusIndicator status={row.status === 'active' ? 'active' : 'deactivated'} layout="icon-only" />
                  ),
                },
                {
                  key: 'name',
            ...
            {/* Selection indicator */}
            <SelectionIndicator
              selectedItems={selectedTenant ? [{ id: selectedTenant, label: mockTenants.find(t => t.id === selectedTenant)?.name || selectedTenant }] : []}
      ...
      <SectionCard.Content>
        <VStack gap={4} className="pt-2">
          ...
          <VStack gap={3}>
            ...
            {/* Image Table */}
            <Table
              columns={sourceTab === 'snapshot' ? snapshotColumns : sourceTab === 'volume' ? volumeColumns : imageColumns}
                  ...
                  {sectionStatus['template-info'] === 'done' && (
                    <DoneSection title={SECTION_LABELS['template-info']} onEdit={() => handleEdit('template-info')}>
                      ...
                      {!isFavorite && (
                        <SectionCard.DataRow 
                          label="Tenant" 
                          value={selectedTenant ? mockTenants.find(t => t.id === selectedTenant)?.name || selectedTenant : '-'} 
                        />
                      )}
                    </DoneSection>
                  )}
