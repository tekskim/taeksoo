    ...
    <ComponentPageTemplate
      ...
      guidelines={
        <VStack gap={8}>
          ...
          <VStack gap={3}>
            <h4 className="text-heading-h6 text-[var(--color-text-default)]">3. 화면 구성 요소</h4>
            <VStack gap={4}>
              ...
              <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-border-default)]">
                ...
                <div className="mt-2 p-2 bg-[var(--color-state-warning-bg)] rounded-[var(--radius-sm)]">
                  <p className="text-body-sm text-[var(--color-state-warning)]">
                    Log Viewer (View Log) 기능의 경우 GUI 스타일만 동일하며, 메인 터미널 영역의
                    입력은 불가. 데이터 출력 결과만 표시.
                  </p>
                </div>
              </div>
              <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-border-default)]">
          ...
          <VStack gap={3}>
            <h4 className="text-heading-h6 text-[var(--color-text-default)]">4. UI 작동 방식</h4>
