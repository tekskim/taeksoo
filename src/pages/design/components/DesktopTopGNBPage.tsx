...
function DesktopTopGNBGuidelines() {
  return (
    <VStack gap={10}>
      ...
      {/* 5. 앱 창 애니메이션 → Desktop > App Window Animation 페이지로 이동 */}
      <VStack gap={4}>
        ...
        <Prose>
          <p>
            앱 창 애니메이션 관련 상세 사양은{' '}
            <a
              href="/design/desktop/app-window-animation"
              className="text-[var(--color-primary-default)] hover:underline"
            >
              Desktop {'>'} App Window Animation
            </a>{' '}
            페이지를 참고하세요.
          </p>
        </Prose>
      ...
      relatedLinks={[
        {
          ...
          description: '앱 창 애니메이션 상세 사양 (이 페이지에서 이동됨)',
        },
        {
