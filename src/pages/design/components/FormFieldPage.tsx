        ...
        <VStack gap={2}>
          ...
          <Prose>
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                <strong>ErrorMessage 스타일</strong>: text-body-sm, text-[var(--color-state-danger)]
                색상, role=&quot;alert&quot;.
              </li>
              <li>
                <strong>HelperText 스타일</strong>: 에러 시에도 text-body-sm,{' '}
                text-[var(--color-text-subtle)] 유지.
              </li>
              <li>
                <strong>Input 테두리</strong>: error prop으로 테두리를 danger 색상으로 변경합니다.
              </li>
              <li>
