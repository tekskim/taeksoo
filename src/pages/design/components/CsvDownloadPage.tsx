    ...
    <ComponentPageTemplate
      ...
      guidelines={
        <VStack gap={8}>
          ...
          <VStack gap={3}>
            <h4 className="text-heading-h6 text-[var(--color-text-default)]">2. CSV 파일 구조</h4>
              ...
              <table className="w-full text-body-sm border-collapse">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="py-2.5 text-[var(--color-text-muted)]">
                      로우 수가 <strong>10,000건 초과</strong> 시 대용량 파일로 분류
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <VStack gap={3}>
            <h4 className="text-heading-h6 text-[var(--color-text-default)]">실패 처리</h4>
            <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-border-default)]">
