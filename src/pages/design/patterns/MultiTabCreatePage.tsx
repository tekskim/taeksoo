            ...
            <table className="w-full text-body-sm border-collapse">
              ...
              <tbody>
                ...
                <tr className="border-b border-[var(--color-border-subtle)]">
                  ...
                  <td className="py-2.5 text-[var(--color-text-muted)]">
                    하나의 생성 프로세스 내에서 주요 설정 그룹을 구분합니다 (예: Deployment / Pod /
                    Container). 각 탭은 독립적인 구성 카드 집합을 가지며, 사용자는 자유롭게 이동
                    가능합니다. 탭 간 이동 시 입력값은 유지됩니다.
                  </td>
                </tr>
                <tr className="border-b border-[var(--color-border-subtle)]">
                  <td className="py-2.5 pr-4 font-medium text-[var(--color-text-default)]">
                  ...
                  <td className="py-2.5 text-[var(--color-text-muted)]">
                    각 탭 내에서 관련 항목을 묶는 카드형 블록 단위입니다. 한 페이지에 여러 개의
                    카드를 배치할 수 있으며, 각 카드는 접힘/펼침이 가능합니다. 상단에는 명확한
                    제목(h3 heading)을 표시하고, 내부에는 여러 개의 Form fields, 선택형 UI, 버튼
                    등이 포함됩니다.
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="py-2.5 text-[var(--color-text-muted)]">
                    ...
                    <strong> Quota</strong>: 자원 사용량 표시 /<strong> 버튼</strong>: 생성/취소
                    버튼은 이 패널 하단에 고정 배치. 클릭 시 입력값 검증(global validation)을
                    수행하고 오류 섹션으로 자동 스크롤.
                  </td>
                </tr>
              </tbody>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-state-danger)] border-opacity-30">
              ...
              <ul className="list-disc pl-4 text-body-sm text-[var(--color-text-muted)] space-y-1.5">
                ...
                <li>Add/Remove 액션 시 입력 필드의 위치나 순서를 갑작스럽게 변경하지 않습니다.</li>
                <li>탭 전환 시 페이지 전체가 새로고침되거나 입력 상태가 손실되지 않도록 합니다.</li>
              </ul>
            </div>
          </div>
        </VStack>
