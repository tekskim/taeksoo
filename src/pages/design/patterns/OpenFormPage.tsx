    ...
    └── HStack gap={6} align="start"
      ...
      guidelines={
        <VStack gap={4}>
          ...
          <div className="w-full h-px bg-[var(--color-border-default)] my-2" />

          <h3 className="text-heading-h5 text-[var(--color-text-default)]">Multi Tab Create</h3>
          ...
          <VStack gap={3}>
            <h4 className="text-heading-h6 text-[var(--color-text-default)]">
              Multi Tab Create — Accessibility Guidelines
            </h4>
            <VStack gap={4}>
              <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
