...
import imgAlerts from '@/assets/appIcon/alerts.webp';
...
function getInitialIconLayout(): DesktopIconItem[] {
  const icons = [
    ...
    { id: 'cloud-builder', icon: imgCloud, label: 'Aegis Builder' },
  ];
        ...
        <>
          ...
          <div className="fixed inset-0 z-[6001] flex items-center justify-center pointer-events-none">
            ...
            >
              ...
              >
                <img src={imgStorageAdmin} alt="Aegis Storage" className="w-16 h-16 object-cover" />
              ...
              >
                <img src={imgCloud} alt="Aegis Builder" className="w-16 h-16 object-cover" />
                <span className="text-label-md text-[var(--desktop-text)] text-center">
                  Aegis Builder
                </span>
              </button>
...
const ADMIN_APP_IDS: Set<AppId> = new Set(['storage', 'cloud-builder']);
...
export function SystemModePage() {
  ...
  const appConfigs: Record<AppId, { name: string; icon: string; initialPath: string }> = {
    ...
    'cloud-builder': { name: 'Aegis Builder', icon: imgCloud, initialPath: '/cloudbuilder' },
  };
