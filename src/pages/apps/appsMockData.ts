 ...
 */
import type { CatalogChart, InstalledApp, InstalledOperator } from './appsTypes';
...
`,
  ...
  /* ── Data Processing ── */
  {
    ...
    name: 'spark',
    description:
      'Apache Spark cluster for large-scale data processing. Runs on top of S3-compatible storage.',
    version: '9.2.0',
...
`,
  ...
  /* ── AI Dev ── */
  {
    ...
    requiredOptions: [
      ...
      {
        key: 'singleuser.storage.dynamic.storageClass',
        label: 'Storage Class',
        type: 'storageclass',
      },
...
`,
  ...
  /* ── Database ── */
  {
    ...
    name: 'postgresql',
    description:
      'PostgreSQL relational database. Used for MLflow metadata and general-purpose RDB.',
    version: '15.3.0',
...
export const namespaceOptions = [
  ...
  { value: 'kafka-operator', label: 'kafka-operator' },
];
...
export const installedOperatorsMock: InstalledOperator[] = [
  ...
  {
    id: 'op-kafka-operator-system',
    name: 'kafka-operator',
    displayName: 'Strimzi Kafka Operator',
    version: '0.51.0',
    status: 'Deployed',
    namespace: 'kafka-operator',
    installedAt: '2026-03-10 08:40',
    dependentApplicationCount: 1,
    logoUrl: 'https://cdn.simpleicons.org/apachekafka',
    resources: [
      { kind: 'Deployment', name: 'strimzi-cluster-operator', namespace: 'kafka-operator' },
      { kind: 'CustomResourceDefinition', name: 'kafkas.kafka.strimzi.io' },
      { kind: 'CustomResourceDefinition', name: 'kafkanodepools.kafka.strimzi.io' },
    ],
  },
];
...
export const dependentApplicationsByOperatorMock: Record<string, InstalledApp[]> = {
  'op-cnpg-operator-system': [installedAppsMock[0]], // postgresql
  'op-kafka-operator-system': [installedAppsMock[2]], // grafana uses kafka (mock)
};
