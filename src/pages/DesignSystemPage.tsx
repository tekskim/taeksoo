...
const layoutItems = [
  ...
  { id: 'multi-tab-create', label: 'Multi Tab Create', icon: IconListNumbers },
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={2}>
                          ...
                          <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            ...
                            <li>
                              아이콘만 사용하는 버튼에는 반드시 <code>aria-label</code>을
                              지정합니다.
                            </li>
                          </ul>
                        </VStack>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-state-danger)] border-opacity-30">
                          ...
                          <ul className="list-disc pl-4 text-body-sm text-[var(--color-text-muted)] space-y-1.5">
                            ...
                            <li>
                              버튼 라벨에 &quot;Click here&quot; 같은 모호한 표현을 사용하지
                              않습니다.
                            </li>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={4}>
                          <VStack gap={2}>
                            ...
                            <p className="text-body-md text-[var(--color-text-muted)]">
                              모든 폼 입력 요소는 <strong>FormField</strong> 컴포넌트로 감싸서
                              일관된 라벨, 설명, 에러 메시지 표시를 보장합니다.
                            </p>
                            <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              <li>
                        ...
                        <VStack gap={4}>
                              ...
                              <table className="w-full text-body-sm border-collapse">
                                ...
                                <tbody>
                                  <tr className="border-b border-[var(--color-border-subtle)]">
                                    ...
                                    <td className="py-2 pr-4 text-[var(--color-text-muted)]">
                                      값을 수정한 적 있는(touched) 필드만 형식/필수 검증 실행.
                                      미접촉 필드는 무시.
                                    </td>
                                    <td className="py-2 text-[var(--color-text-muted)]">
                          ...
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              ...
                              <li>
                                <strong>에러 해제</strong>: 사용자가 타이핑을 시작하면(onChange)
                                즉시 에러 상태를 해제합니다. 재검증은 blur 시점에 수행.
                              </li>
                            </ul>
                          </VStack>
                          <VStack gap={2}>
                        ...
                        <VStack gap={4}>
                          ...
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              ...
                              <li>
                                <strong>빈 결과</strong>: 필터 적용 후 결과가 없으면 EmptyState와
                                함께 필터 초기화 옵션 제공.
                              </li>
                            </ul>
                          </VStack>
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              <li>
                                ListToolbar 내 primaryActions 영역의 첫 번째 요소로 배치합니다.
                              </li>
                              <li>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={4}>
                          ...
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              <li>
                                placeholder로 &quot;Select [항목]&quot; 형태의 안내를 제공합니다
                                (예: Select region).
                              </li>
                    ...
                    <VStack gap={3}>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={2}>
                          ...
                          <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            <li>
                              사용자가 선택/입력한 값을 태그 형태로 표시하고, 제거 버튼(X)으로
                              삭제할 수 있습니다.
                            </li>
                            <li>
                            ...
                            <li>
                              <strong>필터</strong>: 적용된 필터 조건을 Chip으로 표시하고 개별
                              제거가 가능하게 합니다.
                            </li>
                            <li>
                              <strong>길이 제한</strong>: 텍스트가 길 경우 말줄임 처리하고
                              tooltip으로 전체 텍스트 제공.
                            </li>
                            <li>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={2}>
                          ...
                          <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            ...
                            <li>
                              <strong>페이지 변경 시</strong>: 선택 상태를 초기화하고, 테이블
                              상단으로 스크롤합니다.
                            </li>
                            <li>
                              <strong>키보드 접근</strong>: 좌우 화살표 키로 페이지 이동이
                              가능합니다.
                            </li>
                            <li>
                              <strong>총 1페이지</strong>: 항목이 페이지 크기 이하일 때도
                              Pagination을 표시하되, 페이지 이동 버튼은 disabled 처리합니다.
                            </li>
                          </ul>
                        </VStack>
                      </div>
                        ...
                        <VStack gap={4}>
                          ...
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              ...
                              <li>
                                <strong>버튼 로딩</strong>: 제출 중인 버튼은 Spinner + disabled
                                상태로 표시합니다.
                              </li>
                              <li>
                                <strong>장시간 로딩</strong>: 10초 이상 소요 시 &quot;This may take
                                a moment...&quot; 등 안내 메시지를 표시하고, 가능하면 ProgressBar로
                                전환합니다.
                              </li>
                            </ul>
                          </VStack>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={2}>
                          ...
                          <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            ...
                            <li>
                              <strong>Indeterminate</strong>: &quot;전체 선택&quot; 체크박스에서
                              일부 항목만 선택된 경우 indeterminate(—) 상태로 표시합니다.
                            </li>
                            <li>
                    ...
                    <VStack gap={3}>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={2}>
                          ...
                          <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            <li>
                              <strong>좌측</strong>: 사이드바 토글 버튼(사이드바 닫힘 시),
                              뒤로/앞으로 네비게이션, Breadcrumb.
                            </li>
                            <li>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={2}>
                          ...
                          <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            ...
                            <li>
                              <strong>탭 너비</strong>: 최대 160px, 탭 수 증가 시 자동으로
                              축소됩니다.
                            </li>
                            <li>
                              <strong>탭 추가</strong>: + 버튼으로 새 탭 추가. 기본 탭(Home 등)은
                              닫을 수 없습니다 (<code>closable: false</code>).
                            </li>
                            <li>
                        ...
                        <VStack gap={4}>
                          ...
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              ...
                              <li>
                                <strong>다중 메시지</strong>: 같은 위치에 여러 InlineMessage가
                                필요한 경우 VStack으로 8px 간격으로 스태킹합니다. 동일 variant가
                                중복되면 하나로 합칩니다.
                              </li>
                            </ul>
                          </VStack>
                        ...
                        <VStack gap={4}>
                          ...
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              ...
                              <li>
                                <strong>선택(Selection)</strong>: 체크박스로 행 선택. 헤더
                                체크박스로 전체 선택/해제. 선택 시 SelectionIndicator 및 Bulk 액션
                                활성화.
                              </li>
                              <li>
                                <strong>Sticky Header</strong>: 스크롤 시 헤더 고정. 데이터가 많을
                                때 컬럼 의미를 유지.
                              </li>
                              <li>
                                <strong>텍스트 말줄임</strong>: 긴 텍스트는 말줄임(truncate)
                                처리하고, hover 시 Tooltip으로 전체 텍스트 표시.
                              </li>
                              <li>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-state-success)] border-opacity-30">
                          ...
                          <ul className="list-disc pl-4 text-body-sm text-[var(--color-text-muted)] space-y-1.5">
                            ...
                            <li>
                              연관 리소스는 클릭하여 해당 리소스로 이동할 수 있도록 링크를
                              제공합니다.
                            </li>
                          </ul>
                        </div>
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-state-danger)] border-opacity-30">
                          ...
                          <ul className="list-disc pl-4 text-body-sm text-[var(--color-text-muted)] space-y-1.5">
                            ...
                            <li>
                              빈 상태에서 빈 테이블 구조만 보여주지 않습니다 (EmptyState 표시).
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <VStack gap={4}>
                          <VStack gap={2}>
                              ...
                              <table className="w-full text-body-sm border-collapse">
                                ...
                                <tbody>
                                  ...
                                  <tr className="border-b border-[var(--color-border-subtle)]">
                                    ...
                                    <td className="py-2 pr-4 text-[var(--color-state-info)]">
                                      파랑
                                    </td>
                                    <td className="py-2 text-[var(--color-text-muted)]">
                            ...
                            <p className="text-body-sm text-[var(--color-text-subtle)]">
                              ...
                              <code>degraded</code> 등)을 지원하며, 각 값은 위 4개 카테고리의 색상
                              중 하나로 매핑됩니다.
                            </p>
                          </VStack>
                          <VStack gap={2}>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={4}>
                          ...
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              <li>
                                아이콘 전용 버튼에는 반드시 Tooltip으로 기능 설명을 제공합니다.
                              </li>
                              <li>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={2}>
                          ...
                          <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            ...
                            <li>
                              <strong>너비</strong>: 기본 6px (<code>drawer-scroll</code>).
                              모달에서는 4px (<code>modal-scroll</code>).
                            </li>
                            <li>
...
.sidebar-scroll { scrollbar-width: thin; }`}
                    ...
                    <VStack gap={3}>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={2}>
                          ...
                          <p className="text-body-sm text-[var(--color-text-subtle)]">
                            필드 5개 부근에서 Form Drawer와 Create Page가 겹칠 수 있습니다. 이 경우
                            폼의 <strong>복잡도</strong>(섹션 구분, 조건부 필드, 연관 리소스 선택
                            등)를 기준으로 판단하세요.
                          </p>
                        </VStack>
                      </div>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={4}>
                          ...
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              <li>
                                <strong>Status</strong>: StatusIndicator로 실시간 상태를 표시. 항상
                                첫 번째 카드에 배치.
                              </li>
                              <li>
                    ...
                    <VStack gap={3}>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-state-success)] border-opacity-30">
                          ...
                          <ul className="list-disc pl-4 text-body-sm text-[var(--color-text-muted)] space-y-1.5">
                            <li>
                              Delete 등 파괴적 액션은 danger 스타일로 시각적 경고를 제공합니다.
                            </li>
                            <li>관련 있는 액션끼리 divider로 그룹을 나눕니다.</li>
                            <li>
                              키보드로 메뉴 탐색이 가능하도록 합니다 (Arrow 키, Enter, Escape).
                            </li>
                          </ul>
                        </div>
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-state-danger)] border-opacity-30">
                        ...
                        <VStack gap={4}>
                          ...
                          <VStack gap={2}>
                            ...
                            <p className="text-body-md text-[var(--color-text-muted)] mb-1">
                              다음과 같은 액션을 실행할 때 모달을 노출시켜 사용자의 실수를
                              방지합니다.
                            </p>
                            <ol className="list-decimal pl-5 text-body-md text-[var(--color-text-muted)] space-y-1">
                              <li>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-border-default)]">
                          ...
                          <ul className="list-disc pl-4 text-body-sm text-[var(--color-text-muted)] space-y-0.5">
                            ...
                            <li>
                              <code>EN</code> &#123;resources&#125; that cannot be
                              &#123;action&#125;
                            </li>
                          ...
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              ...
                              <li>
                                ...
                                Cancel(secondary) 왼쪽, Submit(primary) 오른쪽. <code>flex-1</code>
                                로 균등 너비.
                              </li>
                              <li>
                ...
                >
                  <VStack gap={8}>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={4}>
                          <VStack gap={2}>
                            ...
                            <p className="text-body-md text-[var(--color-text-muted)]">
                              하나의 리소스를 생성하기 위한 여러 설정 카드를{' '}
                              <strong>탭에 나누어 배치</strong>함으로써, 사용자가 순서에 구애받지
                              않고 탭을 자유롭게 이동하며 정보를 입력할 수 있게 하는 UX 패턴입니다.
                            </p>
                          </VStack>
                          <VStack gap={2}>
                            <h4 className="text-heading-h6 text-[var(--color-text-default)]">
                            ...
                            <p className="text-body-md text-[var(--color-text-muted)]">
                              Multi-tab create 페이지는 <strong>Two columns layout</strong>으로
                              구성됩니다. 왼쪽에는 Page title, Tab, Card가 배치되고 오른쪽에는
                              Summary card(Floating card)가 배치됩니다.
                            </p>
                          </VStack>
                          <VStack gap={2}>
                            <h4 className="text-heading-h6 text-[var(--color-text-default)]">
                            ...
                            <p className="text-body-md text-[var(--color-text-muted)]">
                              이 패턴은 사용자가 길고 복잡한 리소스 구성을 하는 경우(예: Kubernetes
                              배포) 생성에 사용을 권장합니다.
                            </p>
                            <ul className="list-disc pl-5 text-body-md text-[var(--color-text-muted)] space-y-1">
                              <li>
                                한 페이지에{' '}
                                <strong>필드 20개 또는 카드 10개 중 하나라도 초과</strong>하는 경우
                              </li>
                          ...
                          <tbody>
                            <tr className="border-b border-[var(--color-border-subtle)]">
                              ...
                              <td className="py-2.5 text-[var(--color-text-muted)]">
                                페이지 최상단에 페이지 목적을 명시합니다. (예: Create Deployment).
                                h2 heading을 사용합니다.
                              </td>
                            </tr>
                            <tr className="border-b border-[var(--color-border-subtle)]">
                              ...
                              <td className="py-2.5 text-[var(--color-text-muted)]">
                                하나의 생성 프로세스 내에서 주요 설정 그룹을 구분합니다 (예:
                                Deployment / Pod / Container). 각 탭은 독립적인 구성 카드 집합을
                                가지며, 사용자는 자유롭게 이동 가능합니다. 탭 간 이동 시 입력값은
                                유지됩니다.
                              </td>
                            </tr>
                            <tr className="border-b border-[var(--color-border-subtle)]">
                              ...
                              <td className="py-2.5 text-[var(--color-text-muted)]">
                                각 탭 내에서 관련 항목을 묶는 카드형 블록 단위입니다. 한 페이지에
                                여러 개의 카드를 배치할 수 있으며, 각 카드는 접힘/펼침이 가능합니다.
                                상단에는 명확한 제목(h3 heading)을 표시하고, 내부에는 여러 개의 Form
                                fields, 선택형 UI, 버튼 등이 포함됩니다.
                              </td>
                            </tr>
                            <tr>
                              <td className="py-2.5 pr-4 font-medium text-[var(--color-text-default)]">
                              ...
                              <td className="py-2.5 text-[var(--color-text-muted)]">
                                ...
                                <strong>Configuration</strong>: 생성 페이지 구성 탭 상태 표시 /
                                <strong> Quota</strong>: 자원 사용량 표시 /<strong> 버튼</strong>:
                                생성/취소 버튼은 이 패널 하단에 고정 배치. 클릭 시 입력값
                                검증(global validation)을 수행하고 오류 섹션으로 자동 스크롤.
                              </td>
                            </tr>
                          </tbody>
                        </table>
                    ...
                    <VStack gap={3}>
                      <Label>3. General Guidelines</Label>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-state-success)] border-opacity-30">
                          <h4 className="text-heading-h7 text-[var(--color-state-success)] mb-3">
                            Do
                          ...
                          <ul className="list-disc pl-4 text-body-sm text-[var(--color-text-muted)] space-y-1.5">
                            ...
                            <li>
                              각 탭은 <strong>단계(step)가 아니라 주제(category) 단위</strong>로
                              그룹화합니다.
                            </li>
                            ...
                            <li>
                              모든 필수 입력값에는{' '}
                              <span className="text-[var(--color-state-danger)]">*</span> 표시를
                              적용합니다.
                            </li>
                            <li>
                              탭 전환 시 Soft Validation을 수행하여 오류 있는 섹션을 미리
                              표시합니다.
                            </li>
                            <li>
                            ...
                            <li>
                              생성 버튼은 Summary 패널 하단에 고정 배치하며, 클릭 시 전체 탭에 대한
                              Global Validation을 수행합니다.
                            </li>
                            <li>
                              탭 전환, 섹션 확장 등의 인터랙션에는 자연스러운 전환
                              애니메이션(200~300ms)을 적용합니다.
                            </li>
                          </ul>
                        </div>
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-state-danger)] border-opacity-30">
                          ...
                          <ul className="list-disc pl-4 text-body-sm text-[var(--color-text-muted)] space-y-1.5">
                            ...
                            <li>
                              Add/Remove 액션 시 입력 필드의 위치나 순서를 갑작스럽게 변경하지
                              않습니다.
                            </li>
                            <li>
                              탭 전환 시 페이지 전체가 새로고침되거나 입력 상태가 손실되지 않도록
                              합니다.
                            </li>
                          </ul>
                        </div>
                    ...
                    <VStack gap={3}>
                      <Label>4. Accessibility Guidelines</Label>
                      <VStack gap={4}>
                        <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                          ...
                          <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            <li>
                              각 구성요소에 대해 대체 텍스트(alt text) 및 ARIA region 역할(role,
                              landmark)을 적절히 정의합니다.
                            </li>
                            <li>애플리케이션의 언어 환경에 맞추어 ARIA label을 작성합니다.</li>
                            <li>불필요한 마크업이나 중복된 역할(role)을 추가하지 않습니다.</li>
                            <li>
                              모든 콘텐츠는 키보드로 접근할 수 있어야 하며, 탐색 순서는 논리적이고
                              예측 가능해야 합니다.
                            </li>
                        ...
                        <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                          ...
                          <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            <li>
                              탭, 폼 입력 필드, 버튼 등 모든 상호작용 요소는 키보드로 접근 가능한
                              순서로 구성합니다.
                            </li>
                            <li>
                              Tab 키 및 방향키(Arrow 키)로 모든 입력 필드와 버튼을 탐색할 수 있어야
                              합니다.
                            </li>
                            <li>
                              각 탭 및 섹션 영역은 <code>ARIA role=&quot;region&quot;</code>을
                              활용해 스크린 리더에서 인식될 수 있도록 합니다.
                            </li>
                            <li>
                              폼 구성요소는 라벨(label)과 필드(input)가 programmatically 연결되어야
                              하며, <code>aria-describedby</code> 속성을 사용해 오류 메시지나
                              도움말을 제공합니다.
                            </li>
                            <li>
                              버튼과 토글 요소는 활성화 상태를 명확히 알리기 위해{' '}
                              <code>aria-pressed</code> 또는 <code>aria-disabled</code> 속성을
                              사용합니다.
                            </li>
                            <li>
                              Summary 패널의 진행 상태나 검증 결과는 시각적 정보 외에도 스크린
                              리더를 통한 대체 정보(예: &quot;검증 완료&quot;, &quot;Quota
                              초과&quot;)로 전달합니다.
                            </li>
                            <li>
                              모든 툴팁과 헬퍼 텍스트는 Hover 또는 Focus 상태에서 스크린 리더가 읽을
                              수 있도록 <code>aria-label</code> 또는 <code>aria-describedby</code>를
                              설정합니다.
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={3}>
                          <VStack gap={2}>
                            ...
                            <p className="text-body-md text-[var(--color-text-muted)]">
                              그래프의 데이터 조회 범위를 제어하는 버튼 그룹입니다. 최소한의
                              클릭으로 원하는 시간대의 데이터를 빠르게 탐색하는 것이 목표입니다.
                            </p>
                          </VStack>
                          <VStack gap={2}>
                            <h4 className="text-heading-h6 text-[var(--color-text-default)]">
                        ...
                        <VStack gap={4}>
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-md text-[var(--color-text-muted)] space-y-1">
                              ...
                              <li>
                                상세 확인/기록은 앱 내부 알림센터가 담당하며, 전역 알림 패널은
                                안읽은 알림 목록을 모아 보여주는 보조 뷰입니다.
                              </li>
                            </ul>
                          </VStack>
                          <VStack gap={2}>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-border-default)]">
                          ...
                          <ul className="list-disc pl-4 text-body-sm text-[var(--color-text-muted)] space-y-0.5">
                            ...
                            <li>
                              과거: <code className="text-body-sm">EN</code> Month(축약형) DD (예:
                              Dec 7) / <code className="text-body-sm">KO</code> MM월 DD일 (예: 12월
                              7일)
                            </li>
                          </ul>
                        </div>
                        ...
                        <VStack gap={4}>
                          <VStack gap={2}>
                            ...
                            <div className="grid grid-cols-3 gap-3">
                              <div className="p-3 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-border-default)]">
                                ...
                                <p className="text-body-sm text-[var(--color-text-muted)]">
                                  비동기 액션에서만 선택적으로 발생. 실시간으로 즉시 완료되지 않을
                                  때 요청되었음을 알림.
                                </p>
                              </div>
                              <div className="p-3 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-border-default)]">
                              ...
                              <div className="p-3 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-border-default)]">
                                ...
                                <p className="text-body-sm text-[var(--color-text-muted)]">
                                  사용자의 요청이 처리되지 못했거나 오류가 발생했음을 알림. (예:
                                  볼륨 연결 실패)
                                </p>
                              </div>
                            </div>
                          ...
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-md text-[var(--color-text-muted)] space-y-1">
                              ...
                              <li>
                                상세 정보 확장(View details) 시: 자동 닫힘 없음, 사용자 닫기 시
                                종료.
                              </li>
                            </ul>
                          </VStack>
                              ...
                              <table className="w-full text-body-sm border-collapse">
                                ...
                                <tbody>
                                  <tr className="border-b border-[var(--color-border-subtle)]">
                                    ...
                                    <td className="py-2 pr-3 text-[var(--color-state-success)]">
                                      O
                                    </td>
                                    <td className="py-2 text-[var(--color-text-muted)]">
                                      읽음으로 전환 (패널 목록에서 제거)
                                  ...
                                  <tr className="border-b border-[var(--color-border-subtle)]">
                                    ...
                                    <td className="py-2 pr-3 text-[var(--color-state-danger)]">
                                      X
                                    </td>
                                    <td className="py-2 text-[var(--color-text-muted)]">
                                      안읽음 유지
                    ...
                    <VStack gap={3}>
                      ...
                      <VStack gap={4}>
                        ...
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-border-default)]">
                          <VStack gap={2}>
                            ...
                            <ol className="list-decimal pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              ...
                              <li>
                                사용자는 토스트의 View details를 눌러 오류 코드/메시지를 인라인
                                확장해 원인을 확인한다.
                              </li>
                            ...
                            <div className="mt-2 p-2 bg-[var(--color-surface-subtle)] rounded-[var(--radius-sm)]">
                              <p className="text-body-sm text-[var(--color-text-subtle)]">
                                토스트: View details 확장 중 고정, 닫기 전 자동 종료 없음 / 전역
                                패널: 안읽음 유지 / 알림센터: 안읽음으로 추적 가능
                              </p>
                            </div>
                          </VStack>
                        </div>
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-border-default)]">
                          <VStack gap={2}>
                            <h4 className="text-heading-h6 text-[var(--color-text-default)]">
                              시나리오 3 — &quot;여러 알림이 쌓일 때, 패널에서 모아서 보고
                              정리&quot;
                            </h4>
                            <p className="text-body-sm text-[var(--color-text-muted)] mb-1">
                            ...
                            <ol className="list-decimal pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              ...
                              <li>
                                작업 도중 성공/실패 알림이 계속 도착하지만, 패널이 열려 있어
                                토스트는 뜨지 않는다.
                              </li>
                              <li>
                        ...
                        <VStack gap={4}>
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-md text-[var(--color-text-muted)] space-y-1">
                              <li>
                                전역 알림 패널은 모든 앱의{' '}
                                <strong>&apos;안읽은(unread)&apos;</strong> 알림을 한곳에서 모아
                                보여주는 데스크탑 레벨 보조 뷰입니다.
                              </li>
                              <li>
                                기록 저장소는 각 앱의 알림센터이며, 전역 패널은 안 읽음 상태의
                                알림을 미러링합니다.
                              </li>
                              <li>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-border-default)]">
                          ...
                          <ul className="list-disc pl-4 text-body-sm text-[var(--color-text-muted)] space-y-0.5">
                            ...
                            <li>
                              <strong>Show more</strong> — 알림 1개 이상일 때 노출, 클릭 시 전체
                              알림 열림
                            </li>
                            <li>
                        ...
                        <table className="w-full text-body-sm border-collapse">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td className="py-2.5 text-[var(--color-text-muted)]">
                                로우 수(아이템 개수)가 <strong>10,000건 초과</strong> 시 대용량
                                파일로 분류
                              </td>
                            </tr>
                          </tbody>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={4}>
                          ...
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                              <li>
                                <strong>Configuration</strong>: 각 섹션/탭의 입력 완료 상태를
                                아이콘과 라벨로 표시합니다.
                              </li>
                              <li>
                              ...
                              <li>
                                <strong>버튼 영역</strong>: Cancel(secondary)과 Create(primary)
                                버튼을 하단에 고정 배치합니다.
                              </li>
                            </ul>
                          </VStack>
                  ...
                  <VStack gap={8}>
                        ...
                        <VStack gap={4}>
                          ...
                          <VStack gap={2}>
                            ...
                            <ul className="list-disc pl-5 text-body-md text-[var(--color-text-muted)] space-y-1">
                              ...
                              <li>
                                View Log — kubectl get pod 명령의 출력 결과 표시 (명령줄 입력은
                                불가)
                              </li>
                            </ul>
                          </VStack>
                          ...
                          <tbody>
                            <tr className="border-b border-[var(--color-border-subtle)]">
                              ...
                              <td className="py-2.5 text-[var(--color-text-muted)]">
                                ...
                                <strong> Cluster Utility</strong>: Top Navigation Bar의 Kubectl
                                Shell 열기
                              </td>
                            </tr>
                            <tr className="border-b border-[var(--color-border-subtle)]">
                    ...
                    <VStack gap={3}>
                      ...
                      <VStack gap={4}>
                        <div className="p-4 bg-[var(--color-surface-default)] rounded-[var(--radius-md)] border border-[var(--color-border-default)]">
                          ...
                          <ol className="list-decimal pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            <li>
                              <strong>현재 연결 정보 표시</strong> — resourceName을 탭에 표시.
                              헤더의 세션 타이틀은 &apos;세션을 연 원래 리소스&apos;로 고정
                              (터널링/포트 포워딩으로 다른 리소스에 접속해도 첫 번째 리소스 이름
                              유지).
                            </li>
                            <li>
                    ...
                    <VStack gap={3}>
                      ...
                      <div className="p-3 bg-[var(--color-surface-subtle)] rounded-[var(--radius-md)]">
                        <p className="text-body-sm text-[var(--color-text-muted)]">
                          <strong>입력 정책:</strong> 키보드 중심 인터랙션. 마우스 선택 및 복사
                          허용.
                        </p>
                      </div>
                    </VStack>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={4}>
                          <VStack gap={2}>
                            ...
                            <p className="text-body-md text-[var(--color-text-muted)]">
                              PageShell이 전체 페이지를 래핑하며, Sidebar + TabBar + TopBar +
                              Content 영역으로 구성됩니다. 하단에는 Shell Panel(터미널)이 선택적으로
                              표시됩니다.
                            </p>
                          </VStack>
                          <VStack gap={2}>
                  ...
                  <VStack gap={8}>
                    ...
                    <VStack gap={3}>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={3}>
                          <p className="text-body-md text-[var(--color-text-muted)]">
                            Chart는 시스템 리소스 및 사용 현황을 <strong>직관적으로 파악</strong>할
                            수 있도록 시각화하는 컴포넌트입니다. 데스크탑 UI 환경에서{' '}
                          ...
                          <ul className="list-disc pl-5 text-body-md text-[var(--color-text-muted)] space-y-1">
                            ...
                            <li>
                              모든 Chart는{' '}
                              <strong>동일한 색상 규칙, 툴팁 정책, 단위 표기 규칙</strong>을
                              따릅니다.
                            </li>
                          </ul>
                        </VStack>
                          ...
                          <VStack gap={3}>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                ...
                                <p className="text-body-sm text-[var(--color-text-muted)]">
                                  1개의 카테고리 내에서 <strong>2개 이상의 데이터 구성 비율</strong>
                                  을 확인할 때 사용.
                                </p>
                              </div>
                              <div>
                    ...
                    <VStack gap={3}>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={2}>
                          ...
                          <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            <li>
                              <strong>시계열 데이터</strong>: CPU/Memory/Network 사용량 등 시간에
                              따른 변화를 시각화합니다.
                            </li>
                            <li>
                              <strong>Stacked</strong>: 여러 항목의 누적 합을 표시할 때 Stacked
                              모드를 사용합니다.
                            </li>
                            <li>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={2}>
                          ...
                          <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            ...
                            <li>
                              hover 시 해당 항목의 상세 값(이름, 수치, 비율)을 tooltip으로
                              표시합니다.
                            </li>
                          </ul>
                        </VStack>
                      ...
                      <div className="p-4 bg-[var(--color-surface-subtle)] rounded-[var(--radius-lg)]">
                        <VStack gap={2}>
                          ...
                          <ul className="list-disc pl-5 text-body-sm text-[var(--color-text-muted)] space-y-1">
                            ...
                            <li>
                              <strong>Status 모드</strong>: 사용률 기반 시 Safe/Warning/Danger
                              색상이 적용됩니다.
                            </li>
                            <li>
