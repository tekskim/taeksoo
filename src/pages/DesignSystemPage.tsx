    ...
    <VStack gap={8}>
      ...
      <VStack gap={3}>
        ...
        <div className="p-3 bg-[var(--color-surface-muted)] rounded-[var(--radius-md)] font-mono text-[length:var(--font-size-11)]">
          ...
          flexColumnPresets {'}'} <span className="text-[var(--color-state-info)]">from</span>{' '}
          <span className="text-[var(--color-state-success)]">'@/design-system'</span>;<br />
          <br />
          <span className="text-[var(--color-text-subtle)]">// Usage</span>
          <br />
          ...
          {'}'}, <span className="text-[var(--color-text-subtle)]">// 40px</span>
          <br />
          ...
          {'}'}, <span className="text-[var(--color-text-subtle)]">// 64px</span>
          <br />
          &nbsp;&nbsp;{'{'} key: <span className="text-[var(--color-state-success)]">'name'</span>,
          ...flexColumnPresets.<span className="text-[var(--color-action-primary)]">name</span>{' '}
          {'}'},{' '}
          <span className="text-[var(--color-text-subtle)]">// minWidth: 150px, flex: 1</span>
          <br />
          &nbsp;&nbsp;{'{'} key:{' '}
                  ...
                  <VStack gap={8}>
                    ...
                    <VStack gap={3}>
                      ...
                      <div className="text-[length:var(--font-size-11)] text-[var(--color-text-subtle)] p-3 bg-[var(--color-surface-muted)] rounded-[var(--radius-md)]">
                        ...
                        <code>status-colors: success/warning/error</code>
                      </div>
                    </VStack>
