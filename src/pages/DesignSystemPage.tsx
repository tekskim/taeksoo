...
export function DesignSystemPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-surface-subtle)]">
      ...
      {/* Main Content */}
      <main ref={mainRef} className="absolute top-0 bottom-0 right-0 left-[var(--layout-sidebar-width)] overflow-y-auto">
              ...
              <VStack gap={8}>
                ...
                <VStack gap={3}>
                  ...
                  <div className="flex gap-4">
                    ...
                    <Textarea defaultValue="Input value with multiple lines of text content" className="w-[var(--search-input-width)]" />
                  </div>
                </VStack>
