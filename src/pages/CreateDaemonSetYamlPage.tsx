...
export function CreateDaemonSetYamlPage() {
  ...
  // Update tab label
  useEffect(() => {
    updateActiveTabLabel('Create DaemonSet (YAML)');
  ...
  const handleCreate = useCallback(() => {
    // TODO: Implement actual daemonset creation via API
    console.log('Creating daemonset with YAML:', yamlContent);
    navigate('/container/daemonsets');
            ...
            <VStack gap={6} className="flex-1 min-h-0">
              ...
              <VStack gap={2} className="flex-shrink-0">
                ...
                <p className="text-[11px] leading-[16px] text-[var(--color-text-subtle)]">
                  Create a DaemonSet to run a copy of a pod on every selected node, ensuring consistent background services or node-level agents across the cluster.
                </p>
              </VStack>
...
export default CreateDaemonSetYamlPage;
