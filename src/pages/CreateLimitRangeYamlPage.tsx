...
export function CreateLimitRangeYamlPage() {
  ...
  // Update tab label
  useEffect(() => {
    updateActiveTabLabel('Create LimitRange (YAML)');
  ...
  const handleCancel = useCallback(() => {
    navigate('/container/limitRanges');
  }, [navigate]);

  // Handle create
  const handleCreate = useCallback(() => {
    // TODO: Implement actual limitRange creation via API
    console.log('Creating limitRange with YAML:', yamlContent);
    navigate('/container/limitRanges');
            ...
            <VStack gap={6} className="flex-1 min-h-0">
              ...
              <VStack gap={2} className="flex-shrink-0">
                ...
                <p className="text-[11px] leading-[16px] text-[var(--color-text-subtle)]">
                  LimitRanges define default resource requests and limits for Pods and containers within a Namespace, helping enforce fair resource usage and prevent workloads from consuming excessive CPU or memory.
                </p>
              </VStack>
...
export default CreateLimitRangeYamlPage;
