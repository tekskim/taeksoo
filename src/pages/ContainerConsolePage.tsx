...
function ConnectionStatusIndicator({ status }: { status: ConnectionStatus }) {
  const statusConfig = {
    connected: { color: 'bg-[var(--primitive-color-green500)]', label: 'Connected' },
    connecting: { color: 'bg-[var(--primitive-color-yellow500)]', label: 'Connecting' },
    disconnected: { color: 'bg-[var(--primitive-color-red500)]', label: 'Disconnected' },
  };
