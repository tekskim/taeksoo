        ...
        <VStack gap={6}>
          ...
          <VStack gap={2}>
            ...
            <HStack gap={2} align="center">
              <NumberInput value={minReady} onChange={onMinReadyChange} min={0} width="xs" />
              ...
              (() => {
                ...
                return (
                  <>
                    ...
                    {/* 6. Service Account Name Section */}
                    <SectionCard className="pb-4">
