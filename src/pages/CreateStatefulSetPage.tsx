          ...
          {strategy === 'rolling-update' && (
            <VStack gap={4}>
              ...
              <VStack gap={2} className="max-w-[calc(50%-8px)]">
                ...
                <p className="text-[11px] text-[var(--color-text-subtle)] leading-[16px]">
                  The maximum time allowed for a StatefulSet to progress before it is considered
                  failed.
                </p>
                <HStack gap={2}>
                  <NumberInput
...
export function CreateStatefulSetPage() {
  ...
  const [statefulsetSectionStatus, setStatefulsetSectionStatus] = useState<
    Record<StatefulSetSectionStep, SectionState>
  >({
    'basic-info': 'active',
          ...
          <div className="pt-4 px-8 pb-20 bg-[var(--color-surface-default)]">
            <VStack gap={6}>
              ...
              <VStack gap={2}>
                ...
                <p className="text-[11px] text-[var(--color-text-subtle)] leading-[16px]">
                  StatefulSets manage the deployment and scaling of stateful Pods, providing stable
