...
export function CreatePersistentVolumeClaimYamlPage() {
  ...
  const handleCancel = useCallback(() => {
    navigate('/container/persistentVolumeClaims');
  }, [navigate]);

  // Handle create
  const handleCreate = useCallback(() => {
    // TODO: Implement actual persistentVolumeClaim creation via API
    console.log('Creating persistentVolumeClaim with YAML:', yamlContent);
    navigate('/container/persistentVolumeClaims');
            ...
            <VStack gap={6} className="flex-1 min-h-0">
              ...
              <VStack gap={2} className="flex-shrink-0">
                ...
                <p className="text-[11px] leading-[16px] text-[var(--color-text-subtle)]">
                  Persistent Volume Claim is a user request for persistent storage that defines the required capacity and access properties, allowing Kubernetes to bind or dynamically provision a suitable PersistentVolume.
                </p>
              </VStack>
...
export default CreatePersistentVolumeClaimYamlPage;
