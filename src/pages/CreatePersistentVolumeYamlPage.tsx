...
export function CreatePersistentVolumeYamlPage() {
  ...
  // Update tab label
  useEffect(() => {
    updateActiveTabLabel('Create PersistentVolume (YAML)');
  ...
  const handleCancel = useCallback(() => {
    navigate('/container/persistentVolumes');
  }, [navigate]);

  // Handle create
  const handleCreate = useCallback(() => {
    // TODO: Implement actual persistentVolume creation via API
    console.log('Creating persistentVolume with YAML:', yamlContent);
    navigate('/container/persistentVolumes');
            ...
            <VStack gap={6} className="flex-1 min-h-0">
              ...
              <VStack gap={2} className="flex-shrink-0">
                ...
                <p className="text-[11px] leading-[16px] text-[var(--color-text-subtle)]">
                  Persistent Volume is a pre-provisioned and cluster-wide storage resource that provides reliable and reusable data space for applications or Persistent Volume Claims.
                </p>
              </VStack>
...
export default CreatePersistentVolumeYamlPage;
