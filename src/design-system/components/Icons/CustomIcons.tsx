...
/**
 * IconFileFigma - Figma "Icon/File"
 * My templates, Agent Template 메뉴용 아이콘 (문서 + 접힌 모서리 + 텍스트 라인)
 * Figma 원본 viewBox 유지 — stroke-width는 SVG 내부 좌표계 기준 1
 */
export const IconFileFigma = forwardRef<SVGSVGElement, CustomIconProps>(
  ({ size = 16, color = 'currentColor', className, style, ...props }, ref) => {
    return (
      <svg
        ref={ref}
      ...
      >
        <path
          d="M6.75 0.5H1.75C1.41848 0.5 1.10054 0.626428 0.866116 0.851472C0.631696 1.07652 0.5 1.38174 0.5 1.7V11.3C0.5 11.6183 0.631696 11.9235 0.866116 12.1485C1.10054 12.3736 1.41848 12.5 1.75 12.5H9.25C9.58152 12.5 9.89946 12.3736 10.1339 12.1485C10.3683 11.9235 10.5 11.6183 10.5 11.3V4.1M6.75 0.5L10.5 4.1M6.75 0.5V4.1H10.5M8 7.1H3M8 9.5H3M4.25 4.7H3"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
        />
...
IconFileFigma.displayName = 'IconFileFigma';
