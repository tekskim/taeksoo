 ...
 * Figma 디자인에 맞는 로봇 아이콘 (캘린더 형태, 사각형 안에 스마일리 페이스, 플러스 없음)
 */
  ...
  ({ size = 16, color = 'currentColor', stroke = 1, className, style, ...props }, ref) => {
    return (
      ...
      >
        {/* 캘린더 본체 (닫힌 경로) */}
        <path
          d="M13.5 8.5V4.51396C13.5 4.15739 13.3551 3.81543 13.0973 3.5633C12.8394 3.31116 12.4897 3.16952 12.125 3.16952H3.875C3.51033 3.16952 3.16059 3.31116 2.90273 3.5633C2.64487 3.81543 2.5 4.15739 2.5 4.51396V12.5806C2.5 12.9372 2.64487 13.2792 2.90273 13.5313C3.16059 13.7834 3.51033 13.9251 3.875 13.9251H12.125C12.4897 13.9251 12.8394 13.7834 13.0973 13.5313C13.3551 13.2792 13.5 12.9372 13.5 12.5806V8.5Z"
          stroke={color}
          strokeWidth={stroke}
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        {/* 미소 */}
        <path
          d="M5.9375 10.564C6.625 11.0123 7.3125 11.2362 8 11.2362C8.6875 11.2362 9.375 11.0123 10.0625 10.564"
          stroke={color}
          strokeWidth={stroke}
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        {/* 왼쪽 안테나 */}
        <path
          d="M5.9375 4.51396L5.25 1.82507"
          stroke={color}
          strokeWidth={stroke}
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        {/* 오른쪽 안테나 */}
        <path
          d="M10.0625 4.51396L10.75 1.82507"
          stroke={color}
          strokeWidth={stroke}
          strokeLinecap="round"
          strokeLinejoin="round"
...
/**
 * AddRobot - 16x16 프레임
 * 캘린더 형태, 사각형 안에 스마일리 페이스와 플러스가 있는 아이콘
 */
  ...
  ({ size = 16, color = 'currentColor', stroke = 1, className, style, ...props }, ref) => {
    return (
      ...
      >
        ...
        {/* 플러스 기호 (원과 십자가) */}
        <path
          d="M10.8 12.7H14.4M12.6 10.9V14.5"
          stroke={color}
          strokeWidth={stroke}
          strokeLinecap="round"
          strokeLinejoin="round"
