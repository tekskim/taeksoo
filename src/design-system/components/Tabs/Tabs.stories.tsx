...
export const Sizes: Story = {
  render: () => (
    <div className="flex flex-col gap-[var(--primitive-spacing-8)]">
      <div>
...
export const SettingsPage: Story = {
  render: () => (
    <div className="w-[600px] p-[var(--primitive-spacing-4)] bg-[var(--color-surface-default)] border border-[var(--color-border-default)] rounded-[var(--primitive-radius-lg)]">
