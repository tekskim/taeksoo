    ...
    >
      ...
      <div className="flex flex-col h-full min-h-0">
        ...
        >
          ...
          <h2 className="font-['Mona_Sans:Medium',sans-serif] text-[14px] leading-5 text-[var(--color-text-default)] shrink-0">
            {title}
          </h2>
                    ...
                    {isCollapsible ? (
                      ...
                      >
                        <div className="flex items-center gap-1">
                          ...
                          <span className="font-['Mona_Sans:Medium',sans-serif] text-[12px] text-[var(--color-text-default)]">
                            {section.tabTitle}
                          </span>
                        </div>
                        {showIcon && (
                    ...
                    {isCollapsible && isExpanded && section.items.length > 0 && (
                      <div className="flex flex-col gap-1 pl-4 w-full">
                        {section.items.map((item) => (
                          ...
                          >
                            <span className="font-['Mona_Sans:Regular',sans-serif] text-[11px] text-[var(--color-text-subtle)] group-hover:text-[var(--color-text-default)] transition-colors">
                              {item.title}
                            </span>
        ...
        {quota.length > 0 && (
          <div className="shrink-0 m-4 rounded-md" style={{
            ...
            <div className="flex flex-col items-start gap-3 w-full">
              <h3 className="font-['Mona_Sans:Medium',sans-serif] text-[12px] text-[var(--color-text-default)]">
                Quota
              </h3>
                ...
                {quota.map((item, index) => (
                  <div key={index} className="flex flex-col gap-1 w-full">
                    <div className="flex items-center justify-between">
                      <span className="font-['Mona_Sans:Regular',sans-serif] text-[12px] text-[var(--color-text-default)]">
                        {item.label}
                      </span>
                      <span className="font-['Mona_Sans:Regular',sans-serif] text-[12px] text-[var(--color-text-muted)]">
