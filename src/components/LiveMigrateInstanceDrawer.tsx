...
export interface LiveMigrateInstanceDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
/* ----------------------------------------
   LiveMigrateInstanceDrawer Component
   ---------------------------------------- */

export function LiveMigrateInstanceDrawer({
  isOpen,
  onClose,
  instance,
  onLiveMigrate,
}: LiveMigrateInstanceDrawerProps) {
...
export default LiveMigrateInstanceDrawer;
