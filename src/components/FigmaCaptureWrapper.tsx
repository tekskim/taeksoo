      ...
      <div className="flex flex-1 min-h-0">
        ...
        {sidebar && (
          <div
            ...
            data-figma-name="[TDS] Sidebar"
            aria-label="[TDS] Sidebar"
          >
            {sidebar}
          </div>
        )}
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-[var(--color-surface-default)]">
          {tabBar && (
            <div data-figma-name="[TDS] TabBar" aria-label="[TDS] TabBar">
              {tabBar}
            </div>
          )}
          {topBar && (
            <div data-figma-name="[TDS] TopBar" aria-label="[TDS] TopBar">
              {topBar}
            </div>
          )}
