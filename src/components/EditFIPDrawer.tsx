...
export interface EditFIPDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
/* ----------------------------------------
   EditFIPDrawer Component
   ---------------------------------------- */

export function EditFIPDrawer({ isOpen, onClose, floatingIP, onSubmit }: EditFIPDrawerProps) {
