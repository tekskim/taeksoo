...
export interface ManageExternalGatewayDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  router: RouterInfo;
...
/* ----------------------------------------
   ManageExternalGatewayDrawer Component
   ---------------------------------------- */

export function ManageExternalGatewayDrawer({
  isOpen,
  onClose,
  router,
  ...
  onSubmit,
}: ManageExternalGatewayDrawerProps) {
...
export default ManageExternalGatewayDrawer;
