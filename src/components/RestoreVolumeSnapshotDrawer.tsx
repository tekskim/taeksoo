...
export interface RestoreVolumeSnapshotDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  volume: VolumeInfo;
...
/* ----------------------------------------
   RestoreVolumeSnapshotDrawer Component
   ---------------------------------------- */

export function RestoreVolumeSnapshotDrawer({
  isOpen,
  onClose,
  volume,
  snapshots = defaultSnapshots,
  onRestore,
}: RestoreVolumeSnapshotDrawerProps) {
...
export default RestoreVolumeSnapshotDrawer;
