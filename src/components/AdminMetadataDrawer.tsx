...
export interface AdminMetadataDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
/* ----------------------------------------
   AdminMetadataDrawer Component
   ---------------------------------------- */

export function AdminMetadataDrawer({ isOpen, onClose, image, onSave }: AdminMetadataDrawerProps) {
...
export default AdminMetadataDrawer;
