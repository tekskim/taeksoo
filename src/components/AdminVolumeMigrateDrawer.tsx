...
export interface AdminVolumeMigrateDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
/* ----------------------------------------
   AdminVolumeMigrateDrawer Component
   ---------------------------------------- */

export function AdminVolumeMigrateDrawer({
  isOpen,
  onClose,
  volume,
  onMigrate,
}: AdminVolumeMigrateDrawerProps) {
...
export default AdminVolumeMigrateDrawer;
