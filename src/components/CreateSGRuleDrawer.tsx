...
export interface CreateSGRuleDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
/* ----------------------------------------
   CreateSGRuleDrawer Component
   ---------------------------------------- */

export function CreateSGRuleDrawer({
  isOpen,
  onClose,
  ruleQuota = { used: 2, total: 10 },
  securityGroups = [],
  onSubmit,
}: CreateSGRuleDrawerProps) {
...
export default CreateSGRuleDrawer;
