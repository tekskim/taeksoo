...
export interface AdminInstanceMigrateDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
/* ----------------------------------------
   AdminInstanceMigrateDrawer Component
   ---------------------------------------- */

export function AdminInstanceMigrateDrawer({
  isOpen,
  onClose,
  instance,
  onMigrate,
}: AdminInstanceMigrateDrawerProps) {
...
export default AdminInstanceMigrateDrawer;
