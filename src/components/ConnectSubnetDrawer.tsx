...
const MOCK_NETWORKS: NetworkItem[] = [
  { id: '45ghj567', name: 'net-01', status: 'active', size: 'Yes', access: 'Private', subnetCidr: '10.0.0.0/24' },
  { id: '45ghj568', name: 'net-02', status: 'active', size: 'Yes', access: 'Private', subnetCidr: '10.0.0.0/24' },
  { id: '45ghj569', name: 'net-03', status: 'active', size: 'Yes', access: 'Private', subnetCidr: '10.0.0.0/24' },
  { id: '45ghj570', name: 'net-04', status: 'active', size: 'Yes', access: 'Private', subnetCidr: '10.0.0.0/24' },
  { id: '45ghj571', name: 'net-05', status: 'active', size: 'Yes', access: 'Private', subnetCidr: '10.0.0.0/24' },
  { id: '45ghj572', name: 'net-06', status: 'active', size: 'Yes', access: 'Private', subnetCidr: '10.0.0.0/24' },
];
    ...
    >
      <VStack gap={6} className="h-full">
          ...
          <p className="text-[12px] text-[var(--color-text-subtle)] leading-4">
            Connect an existing subnet to this router to enable routing between networks. 
            Once connected, instances within the subnet can communicate with other subnets 
            or access external networks (if an external gateway is configured).
          </p>
          ...
          <VStack gap={3} className="w-full pb-5">
            ...
            <div className="w-full flex flex-col gap-1">
              ...
              <div className="flex items-center bg-[var(--color-surface-subtle)] border border-[var(--color-border-default)] rounded-md">
                ...
                >
                  <span className="text-[11px] font-medium text-[var(--color-text-default)]">Access</span>
              ...
              {paginatedNetworks.map((network) => (
                <div
                  ...
                  className={`flex items-center bg-white border border-[var(--color-border-default)] rounded-md cursor-pointer hover:bg-[var(--color-surface-subtle)] ${
                    selectedNetworkId === network.id ? 'ring-2 ring-[var(--color-action-primary)]' : ''
                  }`}
                  ...
                  <div className="flex-1 px-3 py-2">
                    <VStack gap={0.5}>
                      <HStack gap={1.5} align="center">
                        ...
                        <IconExternalLink size={12} className="text-[var(--color-action-primary)]" stroke={1.5} />
                      </HStack>
