...
export interface AttachInstanceToVolumeDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
/* ----------------------------------------
   AttachInstanceToVolumeDrawer Component
   ---------------------------------------- */

export function AttachInstanceToVolumeDrawer({
  isOpen,
  onClose,
  volume,
  instances = defaultInstances,
  onAttach,
}: AttachInstanceToVolumeDrawerProps) {
...
export default AttachInstanceToVolumeDrawer;
