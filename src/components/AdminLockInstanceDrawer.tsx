...
export interface AdminLockInstanceDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
/* ----------------------------------------
   AdminLockInstanceDrawer Component
   ---------------------------------------- */

export function AdminLockInstanceDrawer({
  isOpen,
  onClose,
  adminUsername = 'thaki.kim',
  initialLocked = true,
  onSubmit,
}: AdminLockInstanceDrawerProps) {
...
export default AdminLockInstanceDrawer;
