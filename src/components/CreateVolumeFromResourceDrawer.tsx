...
export interface CreateVolumeFromResourceDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
/* ----------------------------------------
   CreateVolumeFromResourceDrawer Component
   ---------------------------------------- */

export function CreateVolumeFromResourceDrawer({
  isOpen,
  onClose,
  volume,
  minCapacity = 50,
  ...
  onSubmit,
}: CreateVolumeFromResourceDrawerProps) {
...
export default CreateVolumeFromResourceDrawer;
