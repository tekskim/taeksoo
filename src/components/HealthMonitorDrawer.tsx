...
export interface HealthMonitorDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  pool: PoolInfo;
  onSubmit?: (data: {
...
/* ----------------------------------------
   HealthMonitorDrawer Component
   ---------------------------------------- */

export function HealthMonitorDrawer({ isOpen, onClose, pool, onSubmit }: HealthMonitorDrawerProps) {
...
export default HealthMonitorDrawer;
