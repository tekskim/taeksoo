...
export interface RedeployStatefulSetModalProps {
  isOpen: boolean;
  onClose: () => void;
...
/* ----------------------------------------
   RedeployStatefulSetModal Component
   ---------------------------------------- */

export function RedeployStatefulSetModal({
  isOpen,
  onClose,
  statefulSet,
  onConfirm,
  isLoading = false,
}: RedeployStatefulSetModalProps) {
  const handleConfirm = () => {
    onConfirm?.();
  };
...
export default RedeployStatefulSetModal;
