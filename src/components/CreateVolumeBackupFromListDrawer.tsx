...
export interface CreateVolumeBackupFromListDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  volumes?: VolumeItem[];
  ...
  return (
    <VStack gap={2} className="w-full">
      ...
      <div className="w-full h-1 bg-[var(--color-border-subtle)] rounded-lg relative overflow-hidden">
        ...
        <div
          className="absolute left-0 top-0 h-full bg-[#a7f3d0] rounded-lg z-[1]"
...
/* ----------------------------------------
   CreateVolumeBackupFromListDrawer Component
   ---------------------------------------- */

export function CreateVolumeBackupFromListDrawer({
  isOpen,
  onClose,
  ...
  onSubmit,
}: CreateVolumeBackupFromListDrawerProps) {
...
export default CreateVolumeBackupFromListDrawer;
