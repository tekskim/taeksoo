                  ...
                  return (
                    <Table.Td
                      ...
                      className={cn(
                        ...
                        expanded && tableStyles.expandedMainRowCell,
                        expanded && tableStyles.expandedMainRowCellFirst
                      )}
                  ...
                  return (
                    <td
                      ...
                      className={cn(
                        ...
                        expanded && tableStyles.expandedMainRowCell,
                        expanded && isFirstDataColumn && tableStyles.expandedMainRowCellFirst,
                        expanded && isLastColumn && tableStyles.expandedMainRowCellLast
                      )}
                      style={
                        column.width
                          ? {
            ...
            {expanded && (
              <tr className={cn(tableStyles.tr, tableStyles.expandedRow)}>
                <td
                  ...
                  className={cn(tableStyles.td, tableStyles.expandedContentConnected)}
                >
