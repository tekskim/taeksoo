...
const TABLER_CATEGORIES: Record<string, string[]> = {
  ...
  'Data & Analytics': ['ChartIcon', 'DashboardIcon', 'ActivityIcon', 'SpeedIcon'],
  'AI & MLOps': [
    'BrainIcon',
    'RobotIcon',
    'RobotFaceIcon',
  ...
  'Schedule & Time': ['CalendarIcon', 'CalendarEventIcon', 'ScheduleIcon', 'HourglassHighIcon'],
  'UI & Layout': [
    'MoreIcon',
    'CloseSmallIcon',
    'DrawerCloseIcon',
  ...
  Toast: ['ToastSuccessIcon', 'ToastErrorIcon'],
  IAM: [
    'IamUsersIcon',
    'IamUsersGroupIcon',
  ...
  AppBar: ['AppBarDocumentIcon', 'AppBarSettingsIcon', 'AppBarUserIcon'],
};
