...
export const summaryCardStyles =
  'flex items-start gap-1 bg-surface-subtle border border-border rounded-base8 px-4 py-4 pr-1 min-h-[160px]';

export const summaryContentStyles = 'flex flex-col gap-4 w-full min-w-0';

export const summaryTitleStyles =
  'm-0 text-text text-16 font-semibold leading-6';

export const summaryGroupStyles = 'flex flex-col gap-2 w-full';

export const summaryGroupHeaderStyles =
...
export const summaryGroupTitleStyles =
  'm-0 text-text text-14 font-medium leading-20';
...
export const summaryItemLabelStyles =
  'm-0 text-text text-12 font-normal leading-20';

export const summaryStatusIconStyles = 'shrink-0';

export const quotaCardStyles =
  'flex flex-col gap-3 bg-surface border border-border rounded-base8 p-4';

export const quotaTitleStyles = 'm-0 text-text text-16 font-semibold leading-6';

export const quotaListStyles = 'flex flex-col gap-3 w-full';

export const quotaItemStyles = 'flex flex-col gap-1.5 w-full';

export const quotaHeaderStyles =
  'flex items-center justify-between text-text w-full';

export const quotaLabelStyles = 'm-0 text-14 font-medium leading-20';
...
export const quotaBarTrackStyles =
  'absolute inset-0 rounded-full bg-border-muted';
