export const infoContainerStyles = {
  ...
  label:
    'font-sans text-11 font-medium leading-16 text-text-muted whitespace-nowrap',
  values: 'flex flex-col gap-2',
  valuesScroll:
    'max-h-[calc(var(--primitive-space-4)*3+var(--primitive-space-1)*2)] overflow-y-auto pr-1',
  value:
    'font-sans text-12 font-normal leading-16 text-text whitespace-normal break-words',
