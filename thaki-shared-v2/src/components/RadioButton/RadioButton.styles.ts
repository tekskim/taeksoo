...
export const radioInputVariants = cva('control-input radio-input rounded-full text-sm shrink-0 self-center', {
  variants: {
    size: {
      xs: 'size-3 radio-sm',
...
export const radioLabelStyles =
  'cursor-pointer text-12 font-normal leading-16 text-text block';
