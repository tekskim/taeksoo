...
export const tdClassnames =
  "px-3 py-sm text-xs leading-4 text-text align-middle bg-inherit";
...
// ── Empty ──────────────────────────────────────────
export const emptyTextClassnames =
  "h-[300px] flex items-center justify-center text-text-muted";
