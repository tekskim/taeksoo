  ...
  if (slug === 'discovery') {
    return {
      ...
      rows: makeRows(COUNT, (i) => ({
        ...
        frontierNet: i % 10 === 0 ? 'Invalid' : i % 4 === 0 ? 'Missing' : 'OK',
    ...
    return {
      ...
      rows: makeRows(COUNT, (i) => {
        ...
        return {
          ...
          frontierNet: i % 11 === 0 ? 'Invalid' : i % 7 === 0 ? 'Missing' : 'OK',
          mgmtIp: randIp(i),
          observedHealth: i % 9 === 0 ? 'Not Running' : 'Running',
          provisionStatus: i % 13 === 0 ? 'Provisioning' : i % 5 === 0 ? 'Registered' : 'Done',
          role: rolePool[(i - 1) % rolePool.length]!,
          purpose: i % 3 === 0 ? 'K8s worker' : i % 3 === 1 ? 'Hypervisor' : 'Ceph Storage',
        };
      }),
    };
  }
    ...
    const tabComputeHosts = {
      ...
      columns: [
        ...
        },
        {
          ...
          minWidth: columnMinWidths.serviceStatus,
          kind: 'badge' as const,
          badgeTones: { Enabled: 'success' as BadgeTone, Disabled: 'neutral' as BadgeTone },
        },
        {
          key: 'lastUpdated',
          label: 'Last updated',
