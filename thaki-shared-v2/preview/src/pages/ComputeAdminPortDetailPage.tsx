...
export function ComputeAdminPortDetailPage() {
    ...
    { label: 'ID', value: port.id, showCopyButton: true, copyText: port.id },
    {
      ...
      value:
        port.tenant === '-' ? (
          ...
          <Link to={`/compute-admin/tenants/${port.tenant}`} className={linkClass}>
            {port.tenant}
          </Link>
        ),
    },
              ...
              <SectionCard>
                ...
                <SectionCard.Content>
                  ...
                  <SectionCard.DataRow label="Subnet">
                    <Link to={`/compute-admin/networks/${port.subnet.id}`} className={linkClass}>
                      {port.subnet.name}
                      <IconExternalLink size={12} className="text-primary shrink-0" />
                    </Link>
                  </SectionCard.DataRow>
