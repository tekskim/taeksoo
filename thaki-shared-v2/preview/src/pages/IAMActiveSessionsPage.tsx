...
const mockSessions: ActiveSession[] = [
  { id: 'sess-001', user: 'thaki-kim', started: 'Sep 12, 2025 15:43:35', lastAccess: 'Sep 12, 2025 16:00:12', ipAddress: '192.168.1.100', device: 'Chrome / Windows' },
  { id: 'sess-002', user: 'alex.johnson', started: 'Sep 12, 2025 14:22:18', lastAccess: 'Sep 12, 2025 15:45:33', ipAddress: '192.168.1.101', device: 'Firefox / macOS' },
  { id: 'sess-003', user: 'sara.connor', started: 'Sep 12, 2025 10:15:42', lastAccess: 'Sep 12, 2025 14:30:27', ipAddress: '10.0.0.50', device: 'Safari / iOS' },
  { id: 'sess-004', user: 'john.doe', started: 'Sep 12, 2025 09:30:15', lastAccess: 'Sep 12, 2025 12:18:44', ipAddress: '172.16.0.25', device: 'Edge / Windows' },
  { id: 'sess-005', user: 'jane.smith', started: 'Sep 12, 2025 08:45:22', lastAccess: 'Sep 12, 2025 15:52:08', ipAddress: '192.168.2.50', device: 'Chrome / macOS' },
  { id: 'sess-006', user: 'mike.wilson', started: 'Sep 11, 2025 22:10:33', lastAccess: 'Sep 12, 2025 08:25:15', ipAddress: '10.0.1.100', device: 'Firefox / Linux' },
  { id: 'sess-007', user: 'emily.chen', started: 'Sep 11, 2025 18:30:45', lastAccess: 'Sep 12, 2025 10:15:22', ipAddress: '192.168.3.75', device: 'Chrome / Android' },
  { id: 'sess-008', user: 'david.lee', started: 'Sep 11, 2025 14:22:18', lastAccess: 'Sep 12, 2025 09:42:33', ipAddress: '172.16.1.50', device: 'Safari / macOS' },
  { id: 'sess-009', user: 'lisa.park', started: 'Sep 11, 2025 10:15:42', lastAccess: 'Sep 11, 2025 22:30:15', ipAddress: '10.0.2.25', device: 'Edge / macOS' },
  { id: 'sess-010', user: 'chris.taylor', started: 'Sep 11, 2025 08:45:22', lastAccess: 'Sep 11, 2025 18:15:44', ipAddress: '192.168.4.100', device: 'Chrome / Linux' },
];
        ...
        {paginatedSessions.map((session) => (
          <Table.Tr key={session.id} rowData={session}>
            <Table.Td rowData={session} column={columns[0]}>
              <Link to={`/iam/users/${session.user}`} className="text-primary font-medium hover:underline">{session.user}</Link>
            </Table.Td>
            <Table.Td rowData={session} column={columns[1]}>{session.started}</Table.Td>
            <Table.Td rowData={session} column={columns[2]}>{session.lastAccess}</Table.Td>
            <Table.Td rowData={session} column={columns[3]}>{session.ipAddress}</Table.Td>
            <Table.Td rowData={session} column={columns[4]}>{session.device}</Table.Td>
            <Table.Td rowData={session} column={columns[5]} preventClickPropagation>
              ...
              >
                <ContextMenu.Item action={() => {}} danger>Terminate this session</ContextMenu.Item>
                <ContextMenu.Item action={() => {}} danger>Terminate all sessions of this user</ContextMenu.Item>
              </ContextMenu.Root>
            </Table.Td>
          </Table.Tr>
        ))}
