...
function ModalPreview({ title, description, children }: ModalPreviewProps) {
  return (
    <div className="bg-surface border border-border rounded-2xl shadow-sm p-4 flex flex-col gap-4 w-[344px]">
      <div className="flex flex-col gap-2">
        <h2 className="text-16 leading-24 font-semibold text-text">{title}</h2>
        {description && <p className="text-12 leading-18 text-text-subtle">{description}</p>}
      </div>
      {children}
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      >
        ...
        <span className="text-14 leading-20 font-semibold text-text">{title}</span>
      </button>
    ...
    <div className="max-w-7xl mx-auto px-8 py-8">
      <div className="flex flex-col gap-10">
        <div className="flex items-center gap-4 flex-wrap">
          <Button variant="secondary" appearance="ghost" size="md" onClick={() => navigate('/')}>
            <IconArrowLeft size={14} />
            Back
          </Button>
          <h1 className="text-16 leading-24 font-semibold text-text m-0">Modal Components</h1>
        </div>
        <p className="text-14 leading-20 text-text-subtle m-0">
        ...
        <CategorySection title="Compute">
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">
                  Snapshot name{' '}
                </span>
                <span className="text-12 leading-18 text-text">2cdfafc1</span>
              </div>

              {/* Warning Alert Box */}
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
            ...
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
                Cancel{' '}
              </Button>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">sg-01</span>
              </div>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5 max-h-[96px] overflow-y-auto modal-scroll">
                <span className="text-11 leading-16 font-medium text-text-subtle">
                  Security groups(10)
                </span>
                <ul className="text-12 leading-18 text-text list-disc pl-4 space-y-0.5">
                  <li>sg-01</li>
                  <li>sg-02</li>
                  <li>sg-03</li>
                  <li>sg-04</li>
          ...
          >
            <div className="flex flex-col gap-2">
              {/* Rule Info Box */}
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Rule </span>
                <span className="text-12 leading-18 text-text">Ingress TCP 80 from 0.0.0.0/0 </span>
              </div>
            </div>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5 max-h-[96px] overflow-y-auto modal-scroll">
                <span className="text-11 leading-16 font-medium text-text-subtle">Rules(10)</span>
                <ul className="text-12 leading-18 text-text list-disc pl-4 space-y-0.5">
          ...
          <ModalPreview title="Detach volume" description="This action detaches the volume.">
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">vol57</span>
              </div>
          ...
          <ModalPreview title="Restore backup" description="This action restores the backup.">
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">vol-01 (Available)</span>
              </div>
            </div>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">123.45.67.8 </span>
              </div>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">web-lb-01(10.0.0.10)</span>
              </div>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">web-lb-01 </span>
              </div>
        ...
        <CategorySection title="IAM">
          ...
          >
            <div className="flex flex-col gap-2">
              {/* User Info Box */}
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">User </span>
                <span className="text-12 leading-18 text-text">DISPLAY NAME </span>
              </div>
          ...
          >
            <div className="flex flex-col gap-2">
              {/* Username Info Box */}
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Username </span>
                <div className="flex items-center gap-1.5 min-h-[26px]">
                  <span className="text-12 leading-18 text-text">john.doe </span>
                  <button
                    className="shrink-0 p-0.5 rounded hover:bg-surface transition-colors"
                  ...
                  >
                    {usernameCopied ? (
                      ...
                      <IconCopy size={12} className="text-text" />
                    )}
                  </button>
                </div>
              </div>
              ...
              {/* Password Info Box */}
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Password </span>
                <div className="flex items-center gap-1.5 min-h-[26px]">
                  <span className="text-12 leading-18 text-text">TempP@ss123!</span>
                  <button
                    className="shrink-0 p-0.5 rounded hover:bg-surface transition-colors"
                    aria-label="Copy to clipboard"
                    onClick={() => {
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              {/* User Group Info Box */}
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">User group </span>
                <span className="text-12 leading-18 text-text">USERGROUP NAME </span>
              </div>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              {/* Role Info Box */}
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Role </span>
                <span className="text-12 leading-18 text-text">ROLENAME</span>
              </div>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">User </span>
                <span className="text-12 leading-18 text-text">DISPLAYNAME </span>
              </div>
          ...
          <ModalPreview title="Terminate session" description="This action terminates the session.">
            <div className="flex flex-col gap-2">
              {/* Session Info Box */}
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Session </span>
                <span className="text-12 leading-18 text-text">DISPLAYNAME (Browser/device)</span>
              </div>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              {/* Policy Info Box */}
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Policy </span>
                <span className="text-12 leading-18 text-text">POLICYNAME </span>
              </div>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">VERSION</span>
              </div>
          ...
          >
            <div className="flex flex-col gap-2">
              {/* Changes Info Box */}
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Changes </span>
                <ul className="text-12 leading-18 text-text list-disc pl-4 space-y-0.5">
          ...
          >
            <div className="flex flex-col gap-2">
              {/* Domain Info Box */}
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">domain </span>
                <span className="text-12 leading-18 text-text">DOMAINNAME </span>
              </div>
          ...
          >
            <div className="flex flex-col gap-2 items-center">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5 w-full">
                <span className="text-11 leading-16 font-medium text-text-subtle">
                  Current domain{' '}
                </span>
                <span className="text-12 leading-18 text-text">Domain A</span>
              </div>

              {/* Chevron Down Icon */}
              <IconChevronDown size={16} className="text-text" stroke={1.5} />

              {/* Target Domain Info Box */}
              <div className="bg-[#eff6ff] rounded-md px-4 py-3 flex flex-col gap-1.5 w-full">
                <span className="text-11 leading-16 font-medium text-text-subtle">
                  Target domain{' '}
                </span>
                <span className="text-12 leading-18 text-text">Domain B</span>
              </div>
            </div>
        ...
        <CategorySection title="Storage">
          ...
          <ModalPreview title="Delete bucket">
            ...
            <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
              <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
              <div className="text-11 leading-16 text-text">
        ...
        <CategorySection title="Container">
          ...
          >
            <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
              <span className="text-11 leading-16 font-medium text-text-subtle">Cluster name</span>
              <span className="text-12 leading-18 text-text">production-cluster</span>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
                Cancel
          ...
          >
            <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
              ...
              <span className="text-12 leading-18 text-text">default</span>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
                Cancel
          ...
          >
            <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
              <span className="text-11 leading-16 font-medium text-text-subtle">Pod name</span>
          ...
          >
            <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
              <span className="text-11 leading-16 font-medium text-text-subtle">Job name</span>
              <span className="text-12 leading-18 text-text">backup-job-20240115</span>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
                Cancel
          ...
          >
            <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
              <span className="text-11 leading-16 font-medium text-text-subtle">CronJob name</span>
              <span className="text-12 leading-18 text-text">daily-backup</span>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
                Cancel
          ...
          >
            <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
              ...
              <span className="text-12 leading-18 text-text">nginx-deployment</span>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
                Cancel
          ...
          >
            <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
              ...
              <span className="text-12 leading-18 text-text">mysql-statefulset</span>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
                Cancel
          ...
          >
            <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
              ...
              <span className="text-12 leading-18 text-text">fluentd-daemonset</span>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
                Cancel
        ...
        <CategorySection title="Compute Admin">
          ...
          <ModalPreview title="Stop instance" description="This action stops the instance.">
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Instance </span>
                <span className="text-12 leading-18 text-text">web-server-01 </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <ul className="text-12 leading-18 text-text list-disc list-inside">
                  <li>web-server-01</li>
                  <li>web-server-02</li>
                  <li>api-server-01</li>
                  <li>db-server-01</li>
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">web-server-template-01 </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Image </span>
                <span className="text-12 leading-18 text-text">ubuntu-22.04-server </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Snapshot </span>
                <span className="text-12 leading-18 text-text">snapshot-2024-01-15 </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Volume </span>
                <span className="text-12 leading-18 text-text">volume-data-01 </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">ssd-performance </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Backup </span>
                <span className="text-12 leading-18 text-text">backup-2024-01-15 </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">ssd-encrypted </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Extra spec </span>
                <span className="text-12 leading-18 text-text">volume_backend_name=lvm </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">QoS Spec </span>
                <span className="text-12 leading-18 text-text">high-performance </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5 max-h-[96px] overflow-y-auto modal-scroll">
                <span className="text-11 leading-16 font-medium text-text-subtle">QoS Specs </span>
                <ul className="text-12 leading-18 text-text list-disc list-inside">
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Extra spec </span>
                <span className="text-12 leading-18 text-text">minIOPS=1000 </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Network </span>
                <span className="text-12 leading-18 text-text">internal-network-01 </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Subnet </span>
                <span className="text-12 leading-18 text-text">subnet-192-168-1-0 </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Port </span>
                <span className="text-12 leading-18 text-text">port-abc12345 </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5 max-h-[96px] overflow-y-auto modal-scroll">
                <span className="text-11 leading-16 font-medium text-text-subtle">Ports </span>
                <ul className="text-12 leading-18 text-text list-disc list-inside">
                  <li>port-abc12345</li>
                  <li>port-def67890</li>
                  <li>port-ghi11121</li>
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Router </span>
                <span className="text-12 leading-18 text-text">main-router-01 </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Fixed IP </span>
                <span className="text-12 leading-18 text-text">192.168.1.100 </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">IP address </span>
                <span className="text-12 leading-18 text-text">10.0.0.50 </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">web-servers-sg </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Firewall </span>
                <span className="text-12 leading-18 text-text">perimeter-firewall-01 </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">203.0.113.50 </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Listener </span>
                <span className="text-12 leading-18 text-text">http-listener-443 </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Pool </span>
                <span className="text-12 leading-18 text-text">web-servers-pool </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Member </span>
                <span className="text-12 leading-18 text-text">192.168.1.10:8080 </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Rule </span>
                <span className="text-12 leading-18 text-text">Ingress/TCP/443 </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">L7 Policy </span>
                <span className="text-12 leading-18 text-text">redirect-to-https </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">http-health-check </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">web-policy-01 </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                ...
                <span className="text-12 leading-18 text-text">allow-https-443 </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Tenant </span>
                <span className="text-12 leading-18 text-text">project-alpha </span>
              </div>
              <div className="bg-danger-light rounded-md p-3 flex gap-2 items-start">
                <IconAlertCircle size={14} className="text-danger shrink-0 mt-0.5" stroke={1.5} />
                <p className="text-11 leading-16 text-text">
          ...
          >
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5 max-h-[96px] overflow-y-auto modal-scroll">
                <span className="text-11 leading-16 font-medium text-text-subtle">Tenants </span>
                <ul className="text-12 leading-18 text-text list-disc list-inside">
                  <li>project-alpha</li>
                  <li>project-beta</li>
                  <li>project-gamma</li>
          ...
          <ModalPreview title="Delete metadata" description="This action removes the metadata.">
            <div className="flex flex-col gap-2">
              <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
                <span className="text-11 leading-16 font-medium text-text-subtle">Metadata </span>
                <span className="text-12 leading-18 text-text">environment=production </span>
              </div>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
        ...
        <CategorySection title="Cloud Builder">
          ...
          >
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-2">
                <span className="text-13 leading-18 font-medium text-text">
                  Reason <span className="text-danger">*</span>
                </span>
                <textarea
                  className="w-full min-h-[80px] px-3 py-2 text-12 leading-18 text-text bg-surface border border-border rounded-sm resize-y outline-none focus:border-focus focus:ring-1 focus:ring-focus"
        ...
        <CategorySection title="AI Agent">
          ...
          >
            <div className="bg-surface-subtle rounded-md px-4 py-3 flex flex-col gap-1.5">
              <span className="text-11 leading-16 font-medium text-text-subtle">Agent name</span>
              <span className="text-12 leading-18 text-text">my-research-agent</span>
            </div>
            <div className="flex gap-2 w-full">
              <Button appearance="outline" variant="secondary" className="flex-1">
                Cancel
