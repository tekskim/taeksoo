      ...
      <SectionCard.Content showDividers={false}>
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-row gap-2 items-center max-w-[var(--slider-row-max-width)]">
              <NumberInput
                value={minReady}
...
export function ContainerCreateDeploymentPage() {
  ...
  const formTabs = [
    { id: 'deployment', label: 'Deployment', closable: false },
    { id: 'pod', label: 'Pod', closable: false },
  ...
  return (
    <CreateLayout
      header={
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <h1 className="text-heading-h4 text-text">Create deployment</h1>
            <p className="text-body-md text-[var(--color-text-subtle)]">
