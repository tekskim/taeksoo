...
const DEFAULT_YAML = `apiVersion: batch/v1
kind: Job
metadata:
  name: my-job
  namespace: default
...
export function ContainerEditJobYamlPage() {
  ...
  return (
    <div className="flex flex-col gap-6 flex-1 min-h-0">
      <div className="flex flex-col gap-2 flex-shrink-0">
        <Title title={`Edit job YAML${id ? ` — ${id}` : ''}`} size="large" />
        <p className="text-body-md text-text-subtle">Edit the YAML configuration of this job.</p>
      </div>
