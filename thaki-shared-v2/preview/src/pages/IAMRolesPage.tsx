      ...
      >
        {paginatedRoles.map((role) => (
          <Table.Tr key={role.id} rowData={role}>
            ...
            <Table.Td rowData={role} column={columns[1]}>
              {role.description}
            </Table.Td>
            <Table.Td rowData={role} column={columns[2]}>
              {role.type}
            </Table.Td>
            <Table.Td rowData={role} column={columns[3]}>
              {role.policies}
            </Table.Td>
            ...
            <Table.Td rowData={role} column={columns[5]} preventClickPropagation>
              ...
              >
                ...
                <ContextMenu.Item action={() => console.log('Duplicate', role.id)}>
                  Duplicate
                </ContextMenu.Item>
                <ContextMenu.Item
                  action={() => {
                ...
                <ContextMenu.Item
                  action={() => console.log('Delete', role.id)}
                  danger={role.type !== 'Built-in'}
                  disabled={role.type === 'Built-in'}
                >
                  Delete
                </ContextMenu.Item>
