...
export function ContainerCreateJobYamlPage() {
  ...
  return (
    <div className="flex flex-col gap-6 flex-1 min-h-0">
      <div className="flex flex-col gap-2 flex-shrink-0">
        <h1 className="text-heading-h5 text-text">Create job</h1>
        <p className="text-body-md text-text-subtle">
          Create a Job to run pods until a specified task completes successfully, ensuring reliable
          execution for short-lived or one-time workloads.
        </p>
      </div>
      ...
      <div className="flex-shrink-0 h-[61px] flex items-center justify-between border-t border-border-strong">
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            appearance="outline"
            size="md"
            onClick={() => navigate('/container/jobs')}
          >
            Cancel
          </Button>
          <Button
