                  ...
                  <SectionCard.DataRow
                    ...
                    value={
                      volume.attachedTo && volume.attachedToId ? (
                        <Link
                          to={`/compute-admin/instances/${volume.attachedToId}`}
                          className={linkClass}
                        >
                          {volume.attachedTo}
                        </Link>
              ...
              <SectionCard>
                ...
                <SectionCard.Content>
                  <SectionCard.DataRow
                    ...
                    value={
                      <Link to="/compute-admin/volume-snapshots/snap-001" className={linkClass}>
                        snapshot
                      </Link>
                    }
                  />
                  <SectionCard.DataRow
                    label="Image"
                    value={
                      <Link to="/compute-admin/images/img-001" className={linkClass}>
                        image
                      </Link>
                    }
                  />
                ...
                {paginatedBackups.map((row) => (
                  <Table.Tr key={row.id} rowData={row}>
                    ...
                    <Table.Td rowData={row} column={backupColumns[1]}>
                      <div className="flex flex-col gap-0.5 min-w-0">
                        <Link to={`/compute-admin/volume-backups/${row.id}`} className={linkClass}>
                          {row.name}
                        </Link>
                        <span className="text-11 text-text-muted">ID : {row.id}</span>
                      </div>
