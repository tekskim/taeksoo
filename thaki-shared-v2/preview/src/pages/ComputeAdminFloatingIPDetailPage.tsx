...
export function ComputeAdminFloatingIPDetailPage() {
    ...
    { label: 'ID', value: floatingIP.id, showCopyButton: true, copyText: floatingIP.id },
    {
      ...
      value:
        floatingIP.tenant === '-' ? (
          ...
          <Link to={`/compute-admin/tenants/${floatingIP.tenant}`} className={linkClass}>
            {floatingIP.tenant}
          </Link>
        ),
    },
                ...
                <SectionCard.Content>
                  <SectionCard.DataRow label="Tenant">
                    {floatingIP.tenant === '-' ? (
                      ...
                      <Link
                        to={`/compute-admin/tenants/${floatingIP.tenant}`}
                        className={linkClass}
                      >
                        {floatingIP.tenant}
                      </Link>
