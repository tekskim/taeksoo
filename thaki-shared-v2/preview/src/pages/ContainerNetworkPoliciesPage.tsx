...
export function ContainerNetworkPoliciesPage() {
  ...
  const paginatedData = useMemo(
    () => networkPoliciesData.slice((currentPage - 1) * rowsPerPage, currentPage * rowsPerPage),
  ...
  return (
    <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2 min-h-7 w-full flex-wrap">
          <div className="flex items-center gap-1">
            <input
              ...
              aria-label="Search network policy by attributes"
            />
      ...
      <Pagination
        totalCount={networkPoliciesData.length}
        size={rowsPerPage}
