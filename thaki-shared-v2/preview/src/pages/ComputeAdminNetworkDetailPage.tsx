...
export function ComputeAdminNetworkDetailPage() {
    ...
    { label: 'ID', value: network.id, showCopyButton: true, copyText: network.id },
    {
      ...
      value:
        network.tenant === '-' ? (
          ...
          <Link to={`/compute-admin/tenants/${network.tenant}`} className={tenantLinkClass}>
            {network.tenant}
          </Link>
        ),
    },
                ...
                <SectionCard.Content>
                  <SectionCard.DataRow label="Tenant">
                    {network.tenant === '-' ? (
                      ...
                      <Link
                        to={`/compute-admin/tenants/${network.tenant}`}
