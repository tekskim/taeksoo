...
export function ContainerEditStorageClassYamlPage() {
  ...
  return (
    <div className="flex flex-col gap-6 flex-1 min-h-0">
      <div className="flex flex-col gap-2 flex-shrink-0">
        <Title title={`Edit storage class YAML${id ? ` — ${id}` : ''}`} size="large" />
        <p className="text-body-md text-[var(--color-text-subtle)]">
          Edit the YAML configuration of this storage class.
        </p>
      </div>
