...
export function ContainerEditCronJobYamlPage() {
  ...
  return (
    <div className="flex flex-col gap-6 flex-1 min-h-0">
      <div className="flex flex-col gap-2 flex-shrink-0">
        <Title title={`Edit cronjob YAML${id ? ` — ${id}` : ''}`} size="large" />
        <p className="text-body-md text-text-subtle">
          Edit the YAML configuration of this cronjob.
        </p>
      </div>
      ...
      <div className="flex-shrink-0 h-[61px] flex items-center justify-between border-t border-border-strong">
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            appearance="outline"
            size="md"
            onClick={() => navigate('/container/cronjobs')}
          >
            Cancel
          </Button>
          <Button
