...
type DeploymentSummaryStep = 'basic-info' | 'labels-annotations' | 'scaling';

const DEPLOYMENT_SUMMARY_ORDER: DeploymentSummaryStep[] = [
  'basic-info',
  'labels-annotations',
  'scaling',
];

const DEPLOYMENT_SUMMARY_LABELS: Record<DeploymentSummaryStep, string> = {
  ...
  return (
    <SectionCard className="pb-4">
      ...
      <SectionCard.Content showDividers={false}>
        <div className="flex flex-col gap-6">
          {/* Strategy Selection */}
          <div className="mt-[var(--primitive-spacing-3)]">
            <FormField label="Update policy">
              <div className="flex flex-col gap-[var(--radio-group-item-gap)] items-start">
                <Radio
          ...
          {/* Max Unavailable */}
          <FormField label="Max Unavailable">
          ...
          {/* Minimum Ready */}
          <FormField label="Minimum ready" helperText="0-300 seconds">
          ...
          <FormField label="Revision History Limit" helperText="0-100 revisions">
            <div className="flex flex-row gap-2 items-center">
              <NumberInput
...
export function ContainerCreateDaemonSetPage() {
  ...
  const floatingSummaryItems = useMemo(() => {
    if (activeTab === 'daemonset') {
      return DEPLOYMENT_SUMMARY_ORDER.map((key) => {
        let state: WizardSectionState = 'pre';
        if (key === 'basic-info') state = name.trim() ? 'done' : 'active';
        else state = 'done';
        return { label: DEPLOYMENT_SUMMARY_LABELS[key], state };
      });
    }
    if (activeTab === 'pod') {
  ...
  return (
    <CreateLayout
      header={
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <h1 className="text-heading-h4 text-text">Create daemonset</h1>
            <p className="text-body-md text-[var(--color-text-subtle)]">
      ...
      <div className="flex flex-col gap-4 w-full">
        ...
        {activeTab === 'pod' && (
          <>
            ...
            <SectionCard className="pb-4">
              <SectionCard.Header title="Labels & Annotations" />
              <SectionCard.Content showDividers={false} gap={4}>
                <div className="flex flex-col gap-6">
                  {/* Labels */}
                  <div className="flex flex-col gap-2">
                    <div className="flex flex-col gap-1">
