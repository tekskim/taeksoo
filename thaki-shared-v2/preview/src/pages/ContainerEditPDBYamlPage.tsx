...
const DEFAULT_YAML = `apiVersion: policy/v1
...
export function ContainerEditPDBYamlPage() {
  ...
  return (
    <div className="flex flex-col gap-6 flex-1 min-h-0">
      <div className="flex flex-col gap-2 flex-shrink-0">
        <Title title={`Edit pod disruption budget YAML${id ? ` — ${id}` : ''}`} size="large" />
        <p className="text-body-md text-text-subtle">
          Edit the YAML configuration of this pod disruption budget.
        </p>
      </div>
