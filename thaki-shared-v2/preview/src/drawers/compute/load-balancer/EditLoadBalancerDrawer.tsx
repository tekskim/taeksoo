...
export interface EditLoadBalancerDrawerProps {
  ...
  initialData?: { name: string; description: string; adminUp: boolean };
}

export function EditLoadBalancerDrawer({
  isOpen,
  onClose,
  loadBalancerId = 'lb-00000000',
  initialData,
  ...
  }, [isOpen, initialData?.name, initialData?.description, initialData?.adminUp]);
    ...
    >
      <div className="flex flex-col gap-6 pb-6">
        <div className="flex flex-col gap-3">
          <InfoContainer label="Load balancer ID" values={[loadBalancerId]} />
        </div>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-12 text-text-muted">
              When disabled, the load balancer stops accepting new connections.
            </span>
          </div>
