...
export function LiveMigrateInstanceDrawer({
  ...
  const [blockMigration, setBlockMigration] = useState(false);
      ...
      <div className="flex flex-col gap-6 h-full">
        ...
        <div className="flex flex-col gap-3 w-full pb-5">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-12 text-text-muted">Select a destination host for live migration.</p>
          </div>
        ...
        <div className="flex flex-col gap-3 pb-2">
          <div className="flex flex-col gap-1">
            <span className="text-12 font-medium text-text">Block migration</span>
            <span className="text-12 text-text-muted">
              When enabled, further migrations are blocked until cleared.
            </span>
          </div>
          <div className="flex items-center gap-2">
            <Toggle
              checked={blockMigration}
              onChange={(e) => setBlockMigration(e.target.checked)}
            />
            <span className="text-12 text-text">{blockMigration ? 'Blocked' : 'Allowed'}</span>
          </div>
        </div>
      </div>
    </Overlay.Template>
