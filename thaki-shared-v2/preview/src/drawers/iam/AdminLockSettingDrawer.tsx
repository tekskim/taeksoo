...
export function AdminLockSettingDrawer({
  ...
  return (
    <Overlay.Template
      ...
      size="sm"
      title="Lock setting"
      description="Lock or unlock the system administrator account. Locked accounts cannot sign in."
      isGlobal
      appeared={appeared}
      ...
      <div className="flex flex-col gap-6 pb-6">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            <span className="text-12 font-medium text-text">Lock account</span>
            <span className="text-12 text-text-muted">
              When locked, this account cannot sign in until unlocked.
            </span>
          </div>
