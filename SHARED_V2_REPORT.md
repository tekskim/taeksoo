...
TDS에 8가지 동적 폼 패턴(Key-Value, Multi-Column Ports, Key-Operator-Value 등)이 문서화되어 있으며, 컴포넌트화하여 적용하면 Create 페이지 전반이 개선될 예정입니다.
...
현재 인라인 반복 구현되어 있으며, 컴포넌트화 후 적용 예정입니다.
